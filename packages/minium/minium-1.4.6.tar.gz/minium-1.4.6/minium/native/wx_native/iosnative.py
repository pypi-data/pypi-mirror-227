...
class WXIOSNative(BaseNative):
    ...
    def allow_authorize(self, answer=True, title=None):
        ...
        return self._handle_auth(modal_type, answer)
    ...
    def allow_get_user_info(self, answer=True):
        ...
        :return:
        """
        self._allow_authorize(answer, "获取你的昵称")
    ...
    def allow_get_location(self, answer=True):
        ...
        :return:
        """
        self._allow_authorize(answer, "获取你的位置信息")
    ...
    def allow_record(self, answer=True):
        ...
        :return:
        """
        self._allow_authorize(answer, "使用你的麦克风")
    ...
    def allow_write_photos_album(self, answer=True):
        ...
        :return:
        """
        self._allow_authorize(answer, "保存图片或视频到你的相册")
    ...
    def allow_camera(self, answer=True):
        ...
        :return:
        """
        self._allow_authorize(answer, "使用你的摄像头")
    ...
    def allow_get_user_phone(self, answer=True):
        ...
        # 新版本获取手机号使用仿原生半屏弹窗模式
        if self.app.session(class_name="StaticText", text=WORDING.COMMON.GET_PHONE_NUMBER.value).wait_exists(2):
            if not answer:
            ...
            return self.app.session(xpath='//StaticText[contains("微信绑定号码|上次提供", @name)]').click_if_exists(0.5)
        return False
    ...
    def _handle_auth(self, modal_type: NativeModal, answer):
        ...
        if modal_type is NativeModal.NONE:
            ...
            return self.allow_get_user_phone(answer)
