...
class Client:
  ...
  async def __init__(self, proxy=None):
  ...
  async def get_models(self):
    ...
    async def download_thread(path):
  ...
  async def get_default_params(self, model_id):
  ...
  async def stream_request(self, method, *args, **kwargs):
  ...
  async def chat(self, model_id, messages, params={}):
...
async def extract_links(data: list) -> list:
    """
...
async def upload_image(image: bytes, filename="Photo.jpg"):
    """
...
async def extract_bard_cookie(cookies: bool = False) -> dict:
    """
...
async def max_token(text: str, n: int):
    """
...
async def max_sentence(text: str, n: int):
    """
...
class Ask_Internet:
    ...
    async def _get_token(self, token, token_from_browser):
        """
    ...
    async def export_conversation(self, bard_answer, title: str = ""):
        """
    ...
    async def ask_about_image(self, input_text: str, image: bytes, lang: str = None) -> dict:
        """
...
class Chat_Internet(Ask_Internet):
    ...
    async def _init_session(self, token):
    ...
    async def display_chat_history(self) -> None:
        """
    ...
    async def _is_valid_input(self, user_input: str) -> bool:
        """
    ...
    async def _display_response(self, response: dict) -> None:
        """
    ...
    async def _add_to_chat_history(self, user_input: str, chatbot_response: str) -> None:
        """
...
async def ask(prompt : str, api_key : str, internet : bool = False):
...
async def ask_image(prompt : str, reference_image : str, api_key : str):
    if api_key=="vanshshah1029384756":
        net=Ask_Internet("aAgDyPFygA0nhJGaIYy1wDaixFjkw0BMXJeZCvwiFWmyfSaF2pUFWjw6GQk_QdrO8QWOKA.")
