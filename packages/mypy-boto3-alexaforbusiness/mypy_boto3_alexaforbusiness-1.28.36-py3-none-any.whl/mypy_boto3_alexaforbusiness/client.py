...
class AlexaForBusinessClient(BaseClient):
    ...
    def create_contact(
        ...
        *,
        ...
        DisplayName: DictOrStrTypeDef = ...,
        LastName: DictOrStrTypeDef = ...,
        PhoneNumber: str = ...,
    ...
    def update_device(
        self, *, DeviceArn: str = ..., DeviceName: DictOrStrTypeDef = ...
    ) -> Dict[str, Any]:
        """
    ...
    def update_gateway_group(
        self, *, GatewayGroupArn: str, Name: DictOrStrTypeDef = ..., Description: str = ...
    ) -> Dict[str, Any]:
        """
