...
# 0.1.0
def list2str(list_:list=[], sep:str=""):
    '''\
...
# 0.1.0
def str2list(str_:str="", sep:str=" "):
    '''\
    str2list([str], [sep]) -> a list
    Return a list -> list
    '''

    return list(str_.split(sep))

# 0.8.0
def str2l(str_:str="", sep:str=" "):
    '''\
    s2l([str], [sep]) -> a list
    Return a list -> list
    '''

    return str2list(str_, sep)

# 0.13.3
def tuple2str(tuple_:list=[], sep:str=""):
    '''\
    tuple2str([tuple], [sep]) -> a string

    Return a string -> str
    '''

    return sep.join(map(str, tuple_))

# 0.13.3
def t2str(tuple_:list=[], sep:str=""):
    '''\
    t2s([tuple], [sep]) -> a string
...
# 0.1.0
def str2tuple(str_:str="", sep:str=" "):
    '''\
    str2tuple([str], [sep]) -> a tuple
    Return a tuple -> tuple
    '''

    return tuple(str_.split(sep))

# 0.8.0
def str2t(str_:str="", sep:str=" "):
    '''\
    s2t([str], [sep]) -> a tuple
    Return a tuple -> tuple
    '''

    return str2tuple(str_, sep)

# 0.13.1
def list2set(list_:list=[]):
    '''\
    list2set([list_]) -> a set
    Return a set -> Set
    '''

    output = set()
    for i in list_: output.add(i)
    return sorted(output)

# 0.13.1
def l2set(list_:list=[]):
    '''\
    l2set([list_]) -> a set
    Return a set -> Set
    '''
...
# 0.13.3
def tuple2set(list_:tuple=[]):
    '''\
    tuple2set([tuple]) -> a set
    Return a set -> Set
    '''
...
def str2set(str_:str='', sep=' '):
    ...
    output = set()
    str_ = str2list(str_, sep)
    for i in str_: output.add(i)
    return sorted(output)

# 0.13.2
def list_format(list_:list=[], format_=str):
    output = []
    for i in list_: output.append(format_(i))
    return output
...
def t(*values:object, hac_syntax_:bool=True, sep:str='', start:str='', end:str=''):
    ...
    output = text(l2str(values), hac_syntax_=hac_syntax_, sep=sep, start=start, end=end)
