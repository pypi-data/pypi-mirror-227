...
class Config(pydantic.BaseSettings):
    ...
    logging_level: str = pydantic.Field("INFO", env="NC_LOGGING_LEVEL")

    # -- DATABASE --

    postgres_host: str = pydantic.Field(..., env="NC_POSTGRES_HOST")
    postgres_user: str = pydantic.Field(..., env="NC_POSTGRES_USER")
    postgres_database: str = pydantic.Field(..., env="NC_POSTGRES_DATABASE")
    postgres_password: str = pydantic.Field(..., env="NC_POSTGRES_PASSWORD")
    postgres_port: int = pydantic.Field(5432, env="NC_POSTGRES_PORT")

    postgres_pool_min_size: int = pydantic.Field(1, env="NC_POSTGRES_POOL_MIN_SIZE")
    postgres_pool_max_size: int = pydantic.Field(1, env="NC_POSTGRES_POOL_MAX_SIZE")
...
class ApiConfig(Config):
    ...
    raw_api_prefix: str = pydantic.Field("", env="NC_API_PREFIX")
    ...
    keycloak_host: str = pydantic.Field(..., env="NC_KEYCLOAK_HOST")
    keycloak_realm: str = pydantic.Field(..., env="NC_KEYCLOAK_REALM")
    keycloak_client_id: str = pydantic.Field(..., env="NC_KEYCLOAK_CLIENT_ID")
    keycloak_client_secret: str = pydantic.Field(..., env="NC_KEYCLOAK_CLIENT_SECRET")

    # -- ACCESS SECRET --
    access_key_id: str = pydantic.Field("access_key_id", env="NC_ACCESS_KEY_ID")
    secret_access_key: str = pydantic.Field("secret_access_key", env="NC_SECRET_ACCESS_KEY")
    partition: str = pydantic.Field("ksa", env="NC_PARTITION")
