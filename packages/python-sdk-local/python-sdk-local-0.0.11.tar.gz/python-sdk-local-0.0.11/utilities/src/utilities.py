...
def check_debug_mode(class_name):
    ...
    CHECK_DEBUG_MODE_METHOD_NAME = "check_debug_mode"
    logger.start(CHECK_DEBUG_MODE_METHOD_NAME, object={'class_name': class_name})
    ...
    logger.end(CHECK_DEBUG_MODE_METHOD_NAME, object={'debug': debug})
    return debug
