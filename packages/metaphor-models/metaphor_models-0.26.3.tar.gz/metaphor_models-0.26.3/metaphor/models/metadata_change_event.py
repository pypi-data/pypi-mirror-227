...
class Pipeline:
    ...
    def from_dict(obj: Any) -> 'Pipeline':
        ...
        return Pipeline(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, pipeline_created_at, deleted_at, display_name, entity_type, fivetran, force_shown, pipeline_id, is_complete, is_deleted, is_production, last_ingested_at, last_modified_at, logical_id, spark, pipeline_versioned_id)
