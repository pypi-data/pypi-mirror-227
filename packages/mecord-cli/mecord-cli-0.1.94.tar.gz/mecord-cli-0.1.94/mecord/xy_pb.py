...
NORMAL_PRODUCT_TOKEN = "NzN8OGZmZmQ0N2UyNWY1NTY5ZWFhYWNjMzA5OGRiNDcxOTZ8YThmOWM3Nzg2NTM3YzVmMzMzNzY0MTI1NWM4MmZlNzU="
...
def _aigc_post(request, function):
    ...
    if store.is_product():
        ...
        token = store.token()
        if token == OFFICIAL_PRODUCT_TOKEN:
            token = NORMAL_PRODUCT_TOKEN
