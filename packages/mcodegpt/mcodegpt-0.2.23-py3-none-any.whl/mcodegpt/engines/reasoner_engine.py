...
from mcodegpt.ontex.extractor import (
    Answer,
    Axiom,
    Explanation,
    GPTReasonMethodType,
...
from mcodegpt.prompts.reasoning import DEFAULT_REASONING_PROMPT
from mcodegpt.utils.parse_utils import split_on_one_of
...
class ReasonerEngine(KnowledgeEngine):
    ...
    >>> from mcodegpt.ontex.extractor import OntologyExtractor, Task
