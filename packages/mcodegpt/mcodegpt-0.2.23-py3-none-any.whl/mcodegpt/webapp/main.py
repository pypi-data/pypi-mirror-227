...
from mcodegpt.engines.knowledge_engine import DATAMODELS
from mcodegpt.engines.spires_engine import SPIRESEngine
from mcodegpt.io.html_exporter import HTMLExporter
from mcodegpt.utils.gene_set_utils import GeneSet
...
def start():
    ...
    uvicorn.run("mcodegpt.webapp.main:app", host="127.0.0.1", port=8000, reload=True)
