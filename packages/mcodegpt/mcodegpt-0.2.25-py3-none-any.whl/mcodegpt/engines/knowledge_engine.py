...
from mcodegpt import DEFAULT_MODEL
from mcodegpt.clients import OpenAIClient
from mcodegpt.templates.core import ExtractionResult, NamedEntity
...
class KnowledgeEngine(ABC):
    ...
    def _get_template_class(self, template: TEMPLATE_NAME) -> ClassDefinition:
        ...
        if class_name is None:
            ...
            class_name = roots[0]
        mod = importlib.import_module(f"mcodegpt.templates.{module_name}")
