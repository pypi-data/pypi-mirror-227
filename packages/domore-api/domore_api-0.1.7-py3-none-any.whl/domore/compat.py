...
from domore.loader import load_project_meta, convert_relative_project_root_dir
from domore.parser import parse_data
from domore.utils import sort_dict_by_custom_order
...
def _generate_conftest_for_summary(args: List):
    ...
    conftest_content = '''# NOTICE: Generated By DoMore.
import json
import os
import time
...
from domore.utils import get_platform, ExtendJSONEncoder
