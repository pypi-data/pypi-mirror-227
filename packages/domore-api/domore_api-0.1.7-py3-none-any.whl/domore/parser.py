...
from domore import loader, utils, exceptions
from domore.models import VariablesMapping, FunctionsMapping
...
def get_mapping_function(
    ...
    if function_name in functions_mapping:
        ...
        from domore.ext import uploader

        return getattr(uploader, function_name)

    try:
        # check if DoMore builtin functions
