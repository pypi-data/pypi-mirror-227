...
from domore.models import RequestData, ResponseData
from domore.models import SessionData, ReqRespData
from domore.utils import lower_dict_keys, omit_long_data
...
class HttpSession(requests.Session):
    ...
    to be able to log in and out of websites). Each request is logged so that DoMore can
    display statistics.
