...
with open(f"src/{cfg['lib_name']}/__init__.py", "r") as f:
    lines = f.readlines()

with open(f"src/{cfg['lib_name']}/__init__.py", "w") as f:
    version = cfg["version"]
...
setuptools.setup(
    ...
    extras_require={
        "redis": ["redis"],
        "kafka": ["confluent-kafka==2.2.0"],
        "snowflake": ["snowflake-connector-python"],
        "all": ["redis", "confluent-kafka==2.2.0", "snowflake-connector-python"],
    },
