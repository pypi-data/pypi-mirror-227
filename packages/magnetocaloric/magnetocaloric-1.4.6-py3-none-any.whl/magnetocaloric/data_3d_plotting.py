...
def mce_3d(path, g_name, sheet_index, T_row, H_col, dpi):
    ...
    if (g_name == 'MH_show'):        
        ...
        ax1.set_xlabel('T', fontname="monospace")
        ax1.set_ylabel('H', fontname="monospace")
        ax1.set_zlabel('M', fontname="monospace")
        ...
        ax2.set_xlabel('T', fontname="monospace")
        ax2.set_ylabel('H', fontname="monospace")
        ax2.set_zlabel('∆Sm', fontname="monospace")
        ...
        ax3.set_xlabel('T', fontname="monospace")
        ax3.set_ylabel('H', fontname="monospace")
        ax3.set_zlabel('dM/dH', fontname="monospace")
        ...
        ax4.set_xlabel('T', fontname="monospace")
        ax4.set_ylabel('H', fontname="monospace")
        ax4.set_zlabel('dM/dT', fontname="monospace")
