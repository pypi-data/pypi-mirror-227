...
class Client(object):
    ...
    def get_layer_series(self, catalog_id: str, layer_series_id: str) -> LayerSeries:
        # TODO: Fetch MapLayerSeries from map_operator_service once implemented
        return LayerSeries(self.catalog(catalog_id), MapLayerSeries(id=layer_series_id))
