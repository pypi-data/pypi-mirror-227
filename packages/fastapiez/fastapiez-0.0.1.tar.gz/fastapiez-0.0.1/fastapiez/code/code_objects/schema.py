...
class QuerySchema(BaseModel):
    attribute: Annotated[str | None, Query()] = Field(defualt=None,desc="Attribute name for the querry", max_length=100)
    value: Annotated[str | None, Query()] = Field(defualt=None, desc="Attribute value for the querry", max_length=1000)
    sort: Annotated[str | None, Query()] = Field(defualt=None, desc="Attribute name for the sorting", max_length=100)
    skip: int = Field(defualt=0, desc="Skip how many objects", ge=0)
    limit: int = Field(defualt=0, desc="Limit how many objects", le=1000)
"""
