...
class LCBenchSurrogate(AbstractHPOData):
    ...
    def __init__(self, dataset_id: str, target_metrics: list[str], init_local_config: bool = True):
        self._init_local_config = init_local_config
        self._validate()
