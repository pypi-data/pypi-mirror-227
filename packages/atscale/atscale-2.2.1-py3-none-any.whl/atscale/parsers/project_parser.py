...
def _get_multi_key_query_names_from_features(project_dict: dict, cube_id: str, feature_list: List[str]) -> Dict[str,List[str]]:
    ...
    feature_key_list = _get_feature_keys(project_dict = project_dict, cube_id = cube_id, 
            join_features = feature_list)
    cols_to_map_list_of_list = [feature_key_list[x]['key_cols'] for x in feature_key_list.keys()]
