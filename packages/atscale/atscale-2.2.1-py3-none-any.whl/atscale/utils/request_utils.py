...
def get_rest_request(url, data: str = '', headers: dict = None, raises: bool = True):
...
def post_rest_request(url, data: str = '', headers: dict = None, raises: bool = True):
...
def put_rest_request(url, data: str = '', headers: dict = None, raises: bool = True):
...
def delete_rest_request(url, data: str = '', headers: dict = None, raises: bool = True):
...
def parse_rest_query_response(response) -> pd.DataFrame:
    ...
    """
    content = str(response.text) # using text instead of content so we can process special characters
