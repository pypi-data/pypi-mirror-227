...
class DataModel:
    ...
    def submit_atscale_query(
        ...
        validation_utils.validate_required_params_not_none(
            local_vars=locals(),
            inspection=inspect.getfullargspec(self.submit_atscale_query),
        )
    ...
    def create_rolling_features(
        ...
        model_utils._check_features(
            ...
            list(self.get_features(feature_type=FeatureType.NUMERIC, use_published=False).keys()),
            errmsg=f"Feature with name '{numeric_feature_name}' not found. Make sure it is a numeric feature",
        )
    ...
    def create_lag_feature(
        ...
        model_utils._check_features(
            ...
            check_list=data_model_helpers._get_unpublished_features(
