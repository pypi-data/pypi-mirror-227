...
def determine_time_levels(dbconn: SQLConnection, table_name: str, column: str, start_level: TimeLevels = TimeLevels.Year, end_level: TimeLevels = TimeLevels.Second):
    ...
    levels_to_iterate = [level for level in TimeLevels if level.index >= start_level.index and 
                            level.index <= end_level.index]
    last_distinct = None  
