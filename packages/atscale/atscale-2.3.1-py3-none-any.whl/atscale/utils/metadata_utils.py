...
def _get_hierarchies(data_model, filter_by: Dict[Hierarchy, List[str]] = None) -> dict:
    ...
    hierarchy_dict = get_dmv_data(
        model=data_model,
        fields=[Hierarchy.dimension, Hierarchy.description, Hierarchy.folder, Hierarchy.caption, Hierarchy.type, Hierarchy.secondary_attribute],
        filter_by=filter_by
        )
    hierarchies = {}
