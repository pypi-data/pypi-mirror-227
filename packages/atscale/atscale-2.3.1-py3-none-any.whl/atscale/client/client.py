...
class Client:
    ...
    def autogen_semantic_model(self, dbconn: SQLConnection, warehouse_id: str, project_name: str, table_name: str, 
                               dataframe: DataFrame = None, generate_date_table: bool = True, publish: bool = True) -> Project:
        ...
        columns = self.atconn.get_table_columns(
            warehouse_id=warehouse_id, table_name=atscale_table_name, database=database, schema=schema, expected_columns=expected_columns)
        ...
        model_utils._create_semantic_model(atconn=self.atconn, dbconn=dbconn, table_name=atscale_table_name, 
                                           project_dict=project_dict, cube_id=model_dict.get('id'), dataset_id=dataset_id, columns=columns, 
    ...
    def unpublish_project(self, published_project_id: str) -> bool:
