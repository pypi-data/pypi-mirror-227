...
def create_measure(project_dict: dict, data_model_id: str, dataset_id: str, column_name: str, measure_name:str = None):
    ...
    attribute_dict = templates.create_attribute_dict_for_measure(attribute_id=attribute_id, name=measure_name)
