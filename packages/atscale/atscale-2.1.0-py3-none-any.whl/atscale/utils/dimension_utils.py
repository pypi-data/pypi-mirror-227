...
def generate_calculated_columns_for_date_column(atconn: Connection, data_set_project: dict, column_name: str, time_levels: list) -> dict:
    ...
    """
    platform = [warehouse['platformType'] for warehouse in atconn.get_connected_warehouses() 
                if warehouse['warehouse_id'] == data_set_project['physical']['connection']['id']][0]
...
def create_categorical_dimension_for_column(project_dict: dict, data_model_id: str, dataset_id: str, column_name: str, name: str = None, description: str = None,
                                            caption: str = None, folder: str = None, visible: bool = True):
