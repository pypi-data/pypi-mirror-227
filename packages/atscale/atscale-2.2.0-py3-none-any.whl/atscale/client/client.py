...
class Client:
    ...
    def autogen_semantic_model(self, dbconn: SQLConnection, warehouse_id: str, project_name: str, table_name: str, dataframe: DataFrame=None, publish=True) -> Project:
        ...
        model_utils._create_semantic_model(atconn=self.atconn, dbconn=dbconn, table_name=atscale_table_name, project_dict=project_dict, cube_id=model_dict.get('id'), dataset_id=dataset_id, columns=columns)
