...
def _endpoint_login_screen(atconn, suffix: str = ''):
...
def _endpoint_list_projects(atconn, suffix: str = ''):
...
def _endpoint_create_empty_project(atconn, suffix: str = ''):
