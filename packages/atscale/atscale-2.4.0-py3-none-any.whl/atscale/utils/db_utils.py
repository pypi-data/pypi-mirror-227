...
def get_atscale_tablename(
    ...
    atscale_name: str = _convert_name_to_alias(
        name=table_name, aliases=atscale_tables, warning_message="Table name: {} appears as {}"
    )
...
def _convert_name_to_alias(
    name: str, aliases: Union[List[str], Dict[str, Any], Set[str]], warning_message: str = None
) -> Optional[str]:
