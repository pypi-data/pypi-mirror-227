...
def get_hierarchy_levels(data_model: DataModel, hierarchy_name: str) -> List[str]:
...
def get_all_numeric_feature_names(data_model: DataModel, folder: str = None) -> List[str]:
...
def get_all_categorical_feature_names(data_model: DataModel, folder: str = None) -> List[str]:
...
def get_folders(data_model: DataModel) -> List[str]:
