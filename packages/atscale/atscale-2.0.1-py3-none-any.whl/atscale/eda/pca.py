...
from atscale.utils.metadata_utils import get_all_numeric_feature_names, get_all_categorical_feature_names
...
def pca(dbconn:SQLConnection, data_model:DataModel, pc_num:int, numeric_features:List[str], categorical_features:List[str]) -> Tuple[DataFrame, DataFrame]:
    ...
    all_numeric_features = get_all_numeric_feature_names(data_model)
    all_categorical_features = get_all_categorical_feature_names(data_model)
