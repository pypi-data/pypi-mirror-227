...
class Client:
    ...
    def select_project(self, unpublished_project_id: str = None, name_contains: str = None) -> Project:
    ...
    def autogen_semantic_model(self, dbconn: SQLConnection, warehouse_id: str, project_name: str, table_name: str, dataframe: DataFrame, publish=True) -> Project:
        """ Writes a pandas dataframe to the associated database. Once written auto-generates a project and semantic layer based on
        ...
        Args:
            ...
            table_name (str): name of the new table in the source database
            dataframe (DataFrame): the pandas dataframe to build our semantic model from
        ...
        model_utils.create_semantic_layer(atconn=self.atconn, dbconn=dbconn, table_name=atscale_table_name, project_dict=project_dict, data_model_id=model_dict.get('id'), dataset_id=dataset_id, columns=columns)
    ...
    def get_published_projects(self, draft_project_id: str) -> List[Dict[str, str]]:
        ...
        specific_published_projects_list = project_utils.project_parser.parse_published_projects_for_project(
    ...
    def unpublish_project(self, published_project_id: str) -> str:
