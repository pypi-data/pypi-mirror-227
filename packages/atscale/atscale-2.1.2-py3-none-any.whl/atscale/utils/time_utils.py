...
def determine_time_levels(dbconn: SQLConnection, table_name: str, column: str, start_level: TimeLevels = TimeLevels.Year):
    # TODO
    ...
    levels_to_iterate = [level for level in TimeLevels if level.index >= start_level.index]
    last_distinct = None  
    ...
    if not bottom:
        bottom = [l for l in TimeLevels][-1]
