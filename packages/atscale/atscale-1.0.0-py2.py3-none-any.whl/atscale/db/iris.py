...
class Iris(Database):
    ...
    def __init__(self, atscale_connection_id, username, host, namespace, driver, schema, password=None, port=1972):
    ...
    def _add_table_internal(self, table_name: str, dataframe: pandas.DataFrame, chunksize: int = 250,
                           if_exists: str = 'fail'):
