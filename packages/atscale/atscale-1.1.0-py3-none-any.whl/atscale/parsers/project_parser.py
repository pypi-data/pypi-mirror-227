...
def parse_engineid_for_project(project_dict: dict):
...
def get_perspectives(project_dict: dict) -> list:
    ...
    """
    perspectives = project_dict.get('perspectives')
    if perspectives is None:
        return []
    perspective = perspectives.get('perspective')
...
def get_datasets(project_dict: dict) -> list:
    ...
    if project_dict is None:
        return None
    ds_dict = project_dict.get('datasets')
    if ds_dict is None:
        return None
    if 'data-set' not in ds_dict:
        return []
    return ds_dict['data-set']
