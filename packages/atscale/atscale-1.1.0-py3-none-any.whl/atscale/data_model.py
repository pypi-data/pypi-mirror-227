    ...
    def get_features(self, feature_list: List[str] = None, folder_list: List[str] = None,
        ...
        if feature_type is FeatureType.ALL or feature_type is FeatureType.CATEGORICAL:
            ...
            to_df_level_list = [[
                ...
                '',
                hier_dict[dimension_dict[dimension][Level.hierarchy.name]][Hierarchy.folder.name],
                'Categorical'
...
#D
    def list_datasets(self) -> List[str]:
        """Gets the name of all datasets currently accessible by the DataModel and returns as a list.
...
#D
    def dataset_exists(self, dataset_name: str) -> bool:
        ...
        allCubeDatasets = self.list_datasets()
        matchFoundList = [
