...
from atscale.utils.enums import FeatureFormattingType, Hierarchy, Level, Measure, MDXAggs, Aggs, TimeSteps, RequestType
...
def create_calculated_column(data_model: DataModel, dataset_name: str, column_name: str, expression: str, publish: bool = True):
    ...
    data = {
        ...
        'expression': expression,
        'database': database}
    response = atconn._submit_request(request_type=RequestType.POST, url=url, data=data, content_type='x-www-form-urlencoded')
...
def _create_calculated_feature_local(project_json: dict, cube_id: str, name, expression, description=None, caption=None,
    ...
    calculated_members.append(new_calculated_measure)
...
def create_percentage(data_model: DataModel, numeric_feature_name: str, hierarchy_name: str, level_name: str, new_feature_name: str,
    ...
    create_percentages(data_model=data_model, numeric_feature_name= numeric_feature_name, hierarchy_name= hierarchy_name,
                        level_names=[level_name], new_feature_names=[new_feature_name], description= description, 
