...
from atscale.base.enums import Aggs, MappedColumnKeyTerminator, MappedColumnFieldTerminator, MappedColumnDataTypes
...
def create_attribute_dict_for_measure(attribute_id: str, name: str, caption: str = None, folder: str = None, aggregation_method: Aggs = Aggs.SUM):
    if caption is None:
        caption = name
    if folder is None:
        folder = ''
    return {
        ...
        "properties": {
            ...
            "type": {
                "measure": {
                    "default-aggregation": aggregation_method.value
                }
            }
        }
    }
...
def create_map_column_dict(columns: List[dict], field_terminator: MappedColumnFieldTerminator, key_terminator: MappedColumnKeyTerminator,
