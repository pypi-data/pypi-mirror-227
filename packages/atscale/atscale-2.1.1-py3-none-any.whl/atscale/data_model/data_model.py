        ...
        for column in dataframe.columns:
            ...
            if dataframe[column].dtype.kind in 'iufc':
                measure_utils.create_measure(
                    project_dict=project_dict, data_model_id=self.id, dataset_id=dataset_id, column_name=name,
                    measure_name=feature_name_prefix+'_feature_importance_'+column, folder=folder)
            else:
                dimension_utils.create_categorical_dimension_for_column(
                    project_dict=project_dict, data_model_id=self.id, dataset_id=dataset_id, column_name=name,
                    name=feature_name_prefix+'_feature_name', folder=folder)
