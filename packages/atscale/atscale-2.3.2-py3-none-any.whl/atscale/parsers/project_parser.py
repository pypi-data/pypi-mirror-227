...
def get_dataset(project_dict: dict,
                dataset_id: str = None,
                dataset_name: str = None) -> dict:
    dset_list = get_datasets(project_dict=project_dict)
    return dictionary_parser._find_by_id_or_name(item_list=dset_list,
                                                 item_id=dataset_id,
...
def find_dataset_with_table(datasets: list,
                            table_name: str,
                            database: str = None,
                            schema: str = None,
                            ) -> str:
        ...
        for feature in join_features:
            ...
            for dataset in datasets:
                ...
                if found_dataset:
                    ...
                    if not physical:
                        physical = get_dataset(project_dict=project_dict,
                                               dataset_id=dataset.get('id')).get('physical')
