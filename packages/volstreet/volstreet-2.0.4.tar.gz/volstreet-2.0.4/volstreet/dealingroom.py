        ...
        def position_monitor(info_dict):
            ...
            def process_ctb(
                ...
                if method == "breakeven":
                    ...
                    if total_price - (hedge_total_ltp + self.base) < 0:
                        return False  # Ensuring we absorb the cost of strike difference and the hedge cost
...
def place_option_order_and_notify(
    ...
    **kwargs,
    ...
    placed_successfully = check_and_notify_order_placement_statuses(
    ...
    if return_avg_price:
        if call_order_ids and put_order_ids:  # Strangle/Straddle/SyntheticFuture
            ...
            if (
                not placed_successfully
            ):  # Order not successfully executed. Most likely open.
