...
:rtypes: dict|list|str
        ...
        #
        print("parserHTML get_data", self.data)
        return self.data
    #
    ...
    def to_markdown(self, html_content="", inplace=False, *args, **kwargs):
        """
Convert to markdown
...
"""
        print("PARSERHTML.to_mardkown>   kwargs=", kwargs, " // args=", list(args))
    ...
    def clean_html(self, content="", inplace=False):
        """
    ...
    def convert_html_to_markdown(html_content, inplace=False, *args, **kwargs):
        if kwargs.get("data", False):
            ...
            kwargs = {key: value for key, value in kwargs.items() if key != 'data'}
        #
        print("PARSERHTML.convert_html_to_mardkown>   kwargs=", kwargs, " // args=", list(args))
