...
def _convert_html_to_markdown(data, recurs=False, **kwargs)->str:
...
:param bool kwargs[DiscordMarkdownConverter]: see DiscordMarkdownConverter.DiscordDefaultOptions and MarkdownConverter.DefaultOptions
    ...
    if kwargs :
        print("HTML2MD (1) KWARGS", kwargs)
        additionnal_kwargs=set(kwargs.keys())-set(['discordwrap','discordwrap_width'])
