...
cdef class ElementaryLikelihoodComputer():
    ...
    def __init__(self, 
        ...
        if not mode.size == columnNumber:
            raise ValueError("Size of mode does not match "
                             "dimension 1 of observations ({})".format(columnNumber))
        ...
        self.mode = mode.astype(np.int32, order='C', copy=False)
        ...
        cdef:
            ...
            int* modeData = <int*> self.mode.data,
