...
# %% auto 0
__all__ = ['FakePolicy', 'NewsvendorData', 'LinearModel', 'MLP', 'SGDBase', 'LREMsgdAgent', 'MLPsgdAgent']
...
class SGDBase(Agent):
    ...
    def __init__(self, input_size, hidden_size=64, output_size=1, learning_rate=0.01):
...
class LREMsgdAgent(SGDBase):
    def __init__(self, input_size, output_size=1):
        self.model_type="Linear"
        super().__init__(input_size=input_size, output_size=output_size)

    def fit(self, X, y, cu, co, batch_size=64, learning_rate=0.01, num_iterations=10000, device="cpu", add_intercept=False):
        if add_intercept:
            X = np.hstack((np.ones((X.shape[0], 1)), X))
        super().fit(X, y, cu, co, batch_size, learning_rate, num_iterations, device)
...
class MLPsgdAgent(SGDBase):
    def __init__(self,
        ...
        super().__init__(input_size=input_size, hidden_size=hidden_size, output_size=output_size, learning_rate=learning_rate)
