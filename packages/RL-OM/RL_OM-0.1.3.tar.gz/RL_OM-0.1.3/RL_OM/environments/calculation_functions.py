...
def nv_calculations(self, action):
    ...
    cost[remaining_demand > 0] = self.overage_cost * remaining_demand[remaining_demand > 0]
    cost[remaining_demand < 0] = self.underage_cost * np.abs(remaining_demand[remaining_demand < 0])
