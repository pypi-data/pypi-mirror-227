...
# %% auto 0
__all__ = ['experiment_stepwise', 'experiment_stepwise_no_log', 'test', 'experiment_wandb']
...
def test(agent, mdp_train, mdp_test, core_test, core_train, logger, n_episodes_test, n):
        ...
        if agent.train_directly:
            if agent.train_mode == "direct":
                ...
                for i in trange(n_epochs):
                    if i==0:
                        J, R = test(agent, mdp_train, mdp_test, core_test, core_train, logger, n_episodes_test, i)
                    else:
                        wandb.log({"test/J": J, "test/R": R, "test/entropy": E})
