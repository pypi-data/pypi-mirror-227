...
class GoSlideLocal:
    ...
    async def _request(self, hostname, password, reqtype, uri, apiversion=1, data=None):
    ...
    async def slide_info(self, hostname):
        ...
        result = await self._request(
            ...
            "POST",
            "/rpc/Slide.GetInfo",
            apiversion=self._slidesApiVersion[hostname],
        )
