...
from macrometa_source_mysql.stream_utils import get_key_properties
...
def sync_query(cursor, catalog_entry, config, state, select_sql, columns, stream_version, params):
