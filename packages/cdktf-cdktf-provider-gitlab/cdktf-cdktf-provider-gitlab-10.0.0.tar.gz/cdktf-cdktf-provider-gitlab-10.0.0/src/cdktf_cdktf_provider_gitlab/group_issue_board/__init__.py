...
class GroupIssueBoard(
    ...
    def __init__(
        ...
        *,
        ...
        :param group: The ID or URL-encoded path of the group owned by the authenticated user. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.3.0/docs/resources/group_issue_board#group GroupIssueBoard#group}
        :param name: The name of the board. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.3.0/docs/resources/group_issue_board#name GroupIssueBoard#name}
        :param lists: lists block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.3.0/docs/resources/group_issue_board#lists GroupIssueBoard#lists}
        :param milestone_id: The milestone the board should be scoped to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.3.0/docs/resources/group_issue_board#milestone_id GroupIssueBoard#milestone_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
...
class GroupIssueBoardLists:
    def __init__(self, *, label_id: typing.Optional[jsii.Number] = None) -> None:
        '''
        :param label_id: The ID of the label the list should be scoped to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.3.0/docs/resources/group_issue_board#label_id GroupIssueBoard#label_id}
        '''
        if __debug__:
