...
class ProjectJobTokenScope(
    ...
    def __init__(
        ...
        *,
        ...
        :param project: The ID or full path of the project. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.3.0/docs/resources/project_job_token_scope#project ProjectJobTokenScope#project}
        :param target_project_id: The ID of the project that is in the CI/CD job token inbound allowlist. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.3.0/docs/resources/project_job_token_scope#target_project_id ProjectJobTokenScope#target_project_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
