...
class TzcldTerritoryTraining(Model):
    ...
    class Meta(Model.Meta):
        ...
        serializer_fields = ['@id', 'training_course', 'training_promotoion', 'training_person', 'community_identity']
        nested_fields = ['community_identity']
...
class TzcldSharedNote(Model):
    ...
    class Meta(Model.Meta):
        ...
        serializer_fields = ['@id', 'user', 'longdesc', 'community', 'visible', 'conversations']
...
def create_followed_point_answers(sender, instance, created, **kwargs):
    if created:
        communities = Community.objects.all()
        for community in communities:
            # Create TzcldCommunityFollowedPointAsnwer
            evaluation_point_answer = TzcldCommunityFollowedPointAnswer.objects.create(
                community=community,
