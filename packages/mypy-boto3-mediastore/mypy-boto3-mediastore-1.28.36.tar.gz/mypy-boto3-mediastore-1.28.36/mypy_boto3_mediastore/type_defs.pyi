...
ContainerTypeDef = TypedDict(
    "ContainerTypeDef",
    {
        "Endpoint": NotRequired[Dict[str, Any]],
...
CorsRuleTypeDef = TypedDict(
    "CorsRuleTypeDef",
    {
        "AllowedOrigins": List[Dict[str, Any]],
        "AllowedHeaders": List[Dict[str, Any]],
        "AllowedMethods": NotRequired[List[MethodNameType]],
        "MaxAgeSeconds": NotRequired[int],
        "ExposeHeaders": NotRequired[List[Dict[str, Any]]],
    },
)
...
PutLifecyclePolicyInputRequestTypeDef = TypedDict(
    ...
    {
        "ContainerName": str,
        "LifecyclePolicy": DictOrStrTypeDef,
    },
)
