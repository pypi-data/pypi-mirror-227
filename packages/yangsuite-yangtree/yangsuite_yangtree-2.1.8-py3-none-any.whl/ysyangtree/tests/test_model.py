...
class TestYangSetModel(TestCase):
    ...
    def test_get_tree_no_support(self):
        """Get tree without retrieving supported tree."""
        trees = get_trees(
            self.owner,
            self.setname,
        ...
        self.assertEqual(trees[0]['tree']['text'], 'openconfig-if-ethernet')

    def test_get_multiple_tree_no_support(self):
        """Get multiple trees without retrieving supported tree."""
        trees = get_trees(
            self.owner,
            self.setname,
            ['openconfig-interfaces', 'openconfig-if-ethernet'],
