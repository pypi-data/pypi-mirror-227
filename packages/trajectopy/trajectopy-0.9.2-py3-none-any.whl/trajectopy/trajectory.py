...
class Trajectory:
    ...
    def apply_alignment(self, alignment_result: AlignmentResult, inplace: bool = True) -> "Trajectory":
        ...
        trafo_x = transformed_x_from(
            ...
            speed_y=speed_y,
            speed_z=speed_z,
            sim_trans_x=alignment_result.position_parameters.helmert.trans_x.value,
            sim_rot_x=alignment_result.position_parameters.helmert.rot_x.value,
            sim_rot_y=alignment_result.position_parameters.helmert.rot_y.value,
            sim_rot_z=alignment_result.position_parameters.helmert.rot_z.value,
            sim_scale=alignment_result.position_parameters.helmert.scale.value,
        ...
        trafo_y = transformed_y_from(
            ...
            speed_y=speed_y,
            speed_z=speed_z,
            sim_trans_y=alignment_result.position_parameters.helmert.trans_y.value,
            sim_rot_x=alignment_result.position_parameters.helmert.rot_x.value,
            sim_rot_y=alignment_result.position_parameters.helmert.rot_y.value,
            sim_rot_z=alignment_result.position_parameters.helmert.rot_z.value,
            sim_scale=alignment_result.position_parameters.helmert.scale.value,
        ...
        trafo_z = transformed_z_from(
            ...
            speed_y=speed_y,
            speed_z=speed_z,
            sim_trans_z=alignment_result.position_parameters.helmert.trans_z.value,
            sim_rot_x=alignment_result.position_parameters.helmert.rot_x.value,
            sim_rot_y=alignment_result.position_parameters.helmert.rot_y.value,
            sim_scale=alignment_result.position_parameters.helmert.scale.value,
            time_shift=alignment_result.position_parameters.time_shift.value,
