...
from trajectopy.gui.models.entries import AbsoluteDeviationEntry, AlignmentEntry
...
class PlotManager(QObject):
    ...
    def plot_selected_deviations(self, request: PlotRequest) -> None:
        ...
        plot_tabs = PlotTabs(parent=self.parent())
        plot_tabs.show_single_deviations(devs=deviations, plot_settings=self.plot_settings)
