...
from trajectopy.settings.comparison_settings import ComparisonSettings, ComparisonType, MatchingSettings
...
class TestSettings(unittest.TestCase):
    ...
    def test_comparison_type_settings(self) -> None:
        self.settings_io_test(ComparisonType)
