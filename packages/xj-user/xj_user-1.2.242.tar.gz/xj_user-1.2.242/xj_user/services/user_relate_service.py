...
class UserRelateToUserService():
    ...
    def group_tree_user(*args, params: dict = None, **kwargs):
        """
          ...
          :param params: 参数
        """
        with_user_id_list, err = force_transform_type(variable=params.get("with_user_id_list"), var_type="int")
        relate_key, err = force_transform_type(variable=params.get("relate_key"), var_type="str", default="invite")
        relate_type = db.table("user_relate_to_user").where_in("with_user_id", with_user_id_list).where('relate_key',
                                                                                                     relate_key).get()
