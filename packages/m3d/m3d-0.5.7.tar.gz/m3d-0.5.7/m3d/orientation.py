...
class Orientation:
    ...
    @staticmethod
    def from_quaternion(w: NumberType, x: NumberType, y: NumberType, z: NumberType) -> Orientation:
        # adapted from
        # https://github.com/matthew-brett/transforms3d/blob/master/transforms3d/quaternions.py
        Nq = w * w + x * x + y * y + z * z
        if Nq < float_eps:
    ...
    @staticmethod
    def from_axis_angle(axis: Vector, angle: float, is_normalized: bool = False) -> Orientation:
        # adapted from
        # https://github.com/matthew-brett/transforms3d/blob/master/transforms3d/quaternions.py
    ...
    @staticmethod
    def from_xy(x_vec: Vector, y_vec: Vector) -> Orientation:
        """
    ...
    @staticmethod
    def from_yz(y_vec: Vector, z_vec: Vector) -> Orientation:
        """
    ...
    @staticmethod
    def from_xz(x_vec: Vector, z_vec: Vector, ref: str = 'x') -> Orientation:
        """
        Generate a new Orientation from two vectors using x as reference
        """
        if not isinstance(x_vec, Vector):
    ...
    def to_axis_angle(self, unit_thresh: float = 1e-4) -> Tuple[Vector, float]:
        # adapted from
        # https://github.com/matthew-brett/transforms3d/blob/master/transforms3d/quaternions.py
    ...
    def to_rotation_vector(self, unit_thresh: float = 1e-5) -> Vector:
        v, a = self.to_axis_angle(unit_thresh)
        return v * a

    @staticmethod
    def from_rotation_vector(v: Vector) -> Orientation:
