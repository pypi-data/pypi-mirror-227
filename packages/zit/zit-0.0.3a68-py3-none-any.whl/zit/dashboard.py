...
def check_and_install_node_nvm():
    ...
    if further_check:
        ...
        try:
            nvm_version = run_subprocess(f"{load_nvm} && nvm --version", cwd=None, shell=True, return_stdout=True)
        ...
        try:
            node_version = run_subprocess(f"{load_nvm} && node --version", cwd=None, shell=True, return_stdout=True)
        ...
        try:
            ...
            run_subprocess(
                f"{load_nvm} && nvm install 18.4.0 && nvm use 18.4.0",
                cwd=None,
                shell=True,
            )
...
def check_and_install_npm():
    try:
        ...
        try:
            npm_version = run_subprocess(f"{load_nvm} && npm --version", cwd=None, shell=True, return_stdout=True)
...
def check_and_install_pnpm():
    try:
        ...
        try:
            pnpm_version = run_subprocess(f"{load_nvm} && pnpm --version", cwd=None, shell=True, return_stdout=True)
