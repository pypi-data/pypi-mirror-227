...
class BaseKafkaConsumer:
    def __init__(
        ...
        self.lst_subscribe_topic = lst_subscribe_topic if lst_subscribe_topic else [topic_name]
        ...
        try:
            c.subscribe(self.lst_subscribe_topic)
            print("consumer {} is started".format(self.lst_subscribe_topic))
            ...
            print("something unexpected happened: {}: {}".format(self.lst_subscribe_topic, e))
        except KafkaException as e:
            print("KafkaException: {}: {}".format(self.lst_subscribe_topic, e))
        finally:
    ...
    def process(self, data, key=None):
        ...
        try:
            ...
            print("consumer::run - topic: {} ERR: {}".format(self.lst_subscribe_topic, e))
