...
class ApiRouter(BaseRouter):
    ...
    _TRACKED_PACKAGES = ["boulder-opal", "fire-opal", "qctrl-client", "qctrl-commons"]
    ...
    def _request_minimum_number_of_machines(self, machine_count: int) -> int:
        """Requests the mininum number of machines that are to be provisioned."""
    ...
    def _get_number_of_machines_online(self) -> int:
        """Returns the number of machines that are online."""
        _query = gql.gql(
            """
