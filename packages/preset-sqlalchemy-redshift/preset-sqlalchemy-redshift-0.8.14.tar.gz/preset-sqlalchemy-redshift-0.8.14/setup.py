...
setup(
    ...
    version='0.8.14',
    description='Fork of Amazon Redshift Dialect for sqlalchemy with custom dialect suffix',
    ...
    license="MIT",
    url='https://github.com/preset-io/preset-sqlalchemy-redshift',
    ...
    entry_points={
        'sqlalchemy.dialects': [
            'redshift.spectrum = sqlalchemy_redshift.dialect:RedshiftDialect_psycopg2',
