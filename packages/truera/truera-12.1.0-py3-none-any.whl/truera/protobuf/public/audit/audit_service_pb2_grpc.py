...
class AuditServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateUserActivityReport = channel.unary_unary(
        ...
        self.CreateUsageReport = channel.unary_unary(
        ...
        self.CreateUserActivityUberReport = channel.unary_unary(
...
def add_AuditServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CreateUserActivityReport': grpc.unary_unary_rpc_method_handler(
            ...
            'CreateUsageReport': grpc.unary_unary_rpc_method_handler(
            ...
            'CreateUserActivityUberReport': grpc.unary_unary_rpc_method_handler(
...
class AuditService(object):
    ...
    def CreateUserActivityReport(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/truera.audit.AuditService/CreateUserActivityReport',
    ...
    def CreateUsageReport(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/truera.audit.AuditService/CreateUsageReport',
    ...
    def CreateUserActivityUberReport(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/truera.audit.AuditService/CreateUserActivityUberReport',
