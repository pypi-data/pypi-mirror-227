...
class NLPColumnSpec(BaseColumnSpec):
    ...
    Args:
        ...
        feature_influence_col_name: Name of feature influences column
        tokens_col_name: Name of tokens column
        embeddings_col_name: Name of embeddings column
    '''
    text_col_name: str = None
    prediction_col_name: str = None
    label_col_name: str = None
    feature_influence_col_name: str = None
    ...
    def _column_info_mapping(self) -> Dict[str, Union[tuple, str]]:
        ...
        return dict(
            ...
            feature_influences=self.feature_influence_col_name,
    ...
    def for_explainer(
        ...
        **kwargs
        ...
        Args:
            embeddings_col_name (str, optional): If provided, represents the name of the embeddings column in add_data DataFrame. Defaults to None.
            select_columns (list[str], optional): A filtered list of column names to return. If not provided, returns all default NLPExplainer columns. Defaults to None.

        Returns:
            NLPColumnSpec: A NLPColumnSpec object with default column names for NLPExplainer.explain() outputs.
        """
        defaults = dict(
            ...
            feature_influence_col_name="influences",
        ...
        if embeddings_col_name:
            kwargs['embeddings_col_name'] = embeddings_col_name
