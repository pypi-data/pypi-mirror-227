...
class BaseStructureDecoder:
    ...
    def decode_json(self, input_data : Dict[str, str]) -> Structure :
        """ 
    ...
    def decode_json_from_file(self, file_path : str) -> Structure:
        """ 
...
class StdStructureDecoder(BaseStructureDecoder):
    ...
    def decode_json(self, input_data: Dict[str, str]) -> Structure:
        return Structure.from_dict(input_dict=input_data)
