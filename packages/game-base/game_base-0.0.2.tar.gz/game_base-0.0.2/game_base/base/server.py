...
class Server(object):
    @staticmethod
    def init(name, api=None, port=None, handles=None, redis_keys=None, subject=None, sub_handle=None):
        ...
        if None is not port:
            ...
            init_logger()
            socketio = SocketIO(app, cors_allowed_origins="*", async_mode="gevent", ping_interval=3,
                                max_http_buffer_size=1024, logger=True)
