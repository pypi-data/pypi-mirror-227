...
from game_base.base.protocol.base import SEAT_DOWN_NO_SEAT, SEAT_DOWN, UNKNOWN_ERROR, SEAT_DOWN_ALREADY, SELF_INFO, \
    EXECUTE_ACTION_SCORE_NOT_ENOUGH
from game_base.base.protocol.base import ReqSeatDown, RecUpdateGameUsers
...
def execute(sid, room_no, session_id, ip, data):
    ...
    try:
        ...
        if None is not seat:
            ...
            if None is currency or currency.currency < _room.in_score:
                send_to_gateway(SEAT_DOWN, None, account_session.account, EXECUTE_ACTION_SCORE_NOT_ENOUGH)
                return
