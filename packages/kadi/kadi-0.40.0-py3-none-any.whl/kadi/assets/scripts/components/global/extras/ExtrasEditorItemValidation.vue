...
<template>
  <div class="card">
    <div class="m-2">
      ...
      <div class="form-row align-items-center my-1" v-if="['str', 'int', 'float'].includes(type)">
        <div class="col-md-2 text-muted">
          <small>{{ $t('Options') }}</small>
        </div>
        <div class="col-md-10">
          <vue-draggable handle=".sort-handle" :list="options" :force-fallback="true" @end="endDrag">
            <div class="form-row my-1" v-for="(option, index) in options" :key="option.id">
      ...
      <div class="form-row align-items-center my-1" v-if="['int', 'float'].includes(type)">
        <div class="col-md-2 text-muted">
          <small>{{ $t('Range') }}</small>
        </div>
        <div class="col-md-10">
