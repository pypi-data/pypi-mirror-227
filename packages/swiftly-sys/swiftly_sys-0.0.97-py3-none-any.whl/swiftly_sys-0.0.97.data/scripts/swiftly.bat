...
:: Assuming you have an init function defined elsewhere in your script
:makealive
:: Your makealive function code here
goto :eof

:: Other functions like activate_python, activate_node, etc. can be defined similarly
