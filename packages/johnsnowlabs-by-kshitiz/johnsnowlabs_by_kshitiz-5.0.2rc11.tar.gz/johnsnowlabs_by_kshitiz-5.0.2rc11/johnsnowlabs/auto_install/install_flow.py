...
def install_to_emr(
    ...
    jsl_aws_access_key: Optional[str] = None,
    jsl_aws_key_id: Optional[str] = None,
    local_license_number: int = 0,
    remote_license_number: int = 0,
    nlp: bool = True,
    spark_nlp: bool = True,
    ...
    jsl_aws_access_key: The AWS secret access key to use for JSL
    jsl_aws_key_id: The AWS key id to use for JSL
    ...
    secrets: JslSecrets = JslSecrets.build_or_try_find_secrets(
        ...
        fin_license=license,
        leg_license=license,
        aws_access_key=jsl_aws_access_key,
        aws_key_id=jsl_aws_key_id,
