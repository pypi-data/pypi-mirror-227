...
def get_info():
    ...
    with open(os.path.join(CURRENT_DIR, "sklabs/__init__.py")) as f:
...
setup(
    ...
    download_url="https://pypi.python.org/pypi/scikit-labs",
    project_urls={
        "Bug Tracker": "https://github.com/abess-team/scikit-labs/issues",
        # "Documentation": "https://abess.readthedocs.io",
        "Source Code": "https://github.com/abess-team/scikit-labs",
    },
    classifiers=[
    ...
    python_requires='>=3.6',
    ext_modules=[CMakeExtension("sklabs.pybind_cabess")],
