...
class abessLogistic : public Algorithm<Eigen::VectorXd, Eigen::VectorXd, double, T4> {
   public:
    ...
    abessLogistic(int algorithm_type, int model_type, int max_iter = 30, int primary_model_fit_max_iter = 10,
                  ...
                  Eigen::VectorXi always_select = Eigen::VectorXi::Zero(0), int splicing_type = 0, int important_search = 0)
        : Algorithm<Eigen::VectorXd, Eigen::VectorXd, double, T4>::Algorithm(
              algorithm_type, model_type, max_iter, primary_model_fit_max_iter, primary_model_fit_epsilon, exchange_num,
              always_select, splicing_type, important_search){};
