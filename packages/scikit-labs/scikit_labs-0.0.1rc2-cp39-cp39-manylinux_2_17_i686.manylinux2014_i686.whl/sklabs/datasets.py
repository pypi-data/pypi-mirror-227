...
class make_glm_data:
    ...
    Parameters
    ----------
    n: int, optional, default=350
        The number of observations.
    p: int, optional, default=500
    ...
    family: {gaussian, binomial, poisson, gamma, cox}, default="gaussian"
    ...
    corr_type: {exp, const}, optional, default="exp"
    ...
    * Ordinal Regression
    ...
    def __init__(self, n=350, p=500, k=6, family="gaussian", rho=0.95,
                 corr_type="exp", sigma=1, coef_=None,
                 censoring=True, c=1, scal=10, snr=5, class_num=3):
        self.n = n
        self.p = p
        self.k = k
        self.family = family
        ...
        if family == "gaussian":
            ...
            if snr is None:
                ...
                # Type II:
                npower = ((Tbeta.T @ R @ Tbeta).flatten()) / snr
