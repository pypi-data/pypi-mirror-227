...
class CMItemList:
   def __init__(self):
      ...
      self.itemproperties = {}
   def __str__(self):
      return self.itemorder,self.itemproperties
   def __len__(self):
   ...
   def addContextMenuItem(self, obj:object, index:int=-1):
      if as3.formatTypeToName(obj) == "ContextMenuItem":
...
class ContextMenu:
   ...
   def addItemAt(self, item:object, index:int=-1):
      if as3.formatTypeToName(item) == "ContextMenuItem":
