...
class Results(cdxg.TestCase):
    ...
    def resultsvalidations(self, testcase, getresults, test_types, var_types, input_types, exresults, case, results,
                           xlcreate, tepoint, tpload, tparams, comments, roles, timeelapsed, sprints, httpcodes, incidentids):
        if input_types == 'Data':
            print('***********************************************************************************************')
            ...
            if 'Expected results given is not Matched' in str(getresults):
                get_results(xlcreate, roles, testcase, tepoint, tpload, tparams, exresults, getresults,
                            ...
                            comments=comments, sprints=sprints, incidentids=incidentids)
                    ...
                    if var_types != 'ST4':
                        ...
                        if getresults == 'Match Found':
                            get_results(xlcreate, roles, testcase, tepoint, tpload, tparams, exresults, getresults,
                                        ...
                                        sprints=sprints, incidentids=incidentids)
    ...
    def compareresults(self, roles, testcase, var_types, getresults, expresults, case, xlcreate, tepoint, tpload,
                       comments, timeelapsed, tparams, sprints, httpcodes, incidentids, eql='YES'):
                            ...
                            if type(getresults) == list:
                                ...
                                if 'Invalid' in list(set(xrnt)):
                                    ...
                                    get_results(xlcreate, roles, testcase, tepoint, tpload, tparams, expresults,
                                                ...
                                                elapsed_secs=timeelapsed, sprints=sprints, incidentids=incidentids)
                                    log.success('CASE[' + str(case) + '] ' + str(testcase) + ': PASSED')
