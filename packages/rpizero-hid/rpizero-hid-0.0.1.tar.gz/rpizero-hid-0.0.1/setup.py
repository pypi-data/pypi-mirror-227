...
setup(
    name="rpizero-hid",  # How you named your package folder
    packages=['rpizero-hid', 'rpizero-hid.hid'],  # Chose the same as "name"
    ...
    url="https://github.com/Pant3x/rpizero-hid",  # Provide either the link to your github or to your website
    download_url="",
    keywords=[
        "rpi",
        "zero",
