        ...
        for index_r, column_name in enumerate(pd_data_frame.columns):
            if column_name == "ModelA Inference":
                ...
                if isinstance(element, str):
                    element_value = {'confidence':ast.literal_eval(element)}
...
test_session = TestSession(project_name="LivenessDetection",run_name= "run-25-aug-classification-v1")

# # #create test_ds object of Dataset instance
test_ds = Dataset(test_session=test_session, name="spoof-dataset")
