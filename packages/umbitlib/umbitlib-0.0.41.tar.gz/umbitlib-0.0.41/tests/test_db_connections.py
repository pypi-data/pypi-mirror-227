...
from src.umbitlib.db_connections import Oracle, Postgres
...
#############################
class TestSecurityIo(unittest.TestCase):
    ...
    def test_invalid_service_name(self):
        ...
        with self.assertRaises(ValueError):
            db_connections.SecurityIo(invalid_service_name)
