...
qubits = ['Q0102', 'Q0204']
points = 21
freq = [_s.query(f'gate.Measure.{q}.params.frequency') + np.linspace(-0.5, 0.5, points)*1e6 for q in qubits]
...
qubits = ['Q0102','Q0204']
points = 101
freq = [_s.query(f'gate.rfUnitary.{q}.params.frequency') + np.linspace(-50, 50, 101)*1e6 for q in qubits]
...
dts = [np.linspace(0, duration_times*_s.query(f'gate.rfUnitary.{q}.params.duration')[1][-1], points) for q in qubits]
