...
class OptimizeStateResponseAllOfStatus(BaseModel):
    num_pending_trials: Optional[StrictInt] = Field(None, alias="numPendingTrials")
    num_running_trials: Optional[StrictInt] = Field(None, alias="numRunningTrials")
    num_completed_trials: Optional[StrictInt] = Field(None, alias="numCompletedTrials")
    num_failed_trials: Optional[StrictInt] = Field(None, alias="numFailedTrials")
    num_ready_workers: Optional[StrictInt] = Field(None, alias="numReadyWorkers")
    num_busy_workers: Optional[StrictInt] = Field(None, alias="numBusyWorkers")
    num_pending_workers: Optional[StrictInt] = Field(None, alias="numPendingWorkers")
    ...
    def status_validate_enum(cls, v):
        ...
        if v not in ('ready', 'running', 'completed'):
            raise ValueError("must validate the enum values ('ready', 'running', 'completed')")
        return v
