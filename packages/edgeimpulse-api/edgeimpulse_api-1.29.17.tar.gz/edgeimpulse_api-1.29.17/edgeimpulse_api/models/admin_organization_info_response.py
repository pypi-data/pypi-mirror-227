...
class AdminOrganizationInfoResponse(BaseModel):
    ...
    __properties = ["success", "error", "organization", "datasets", "defaultComputeLimits", "entitlementLimits", "experiments", "readme", "whitelabelId", "cliLists", "billable", "totalJobsComputeTime", "jobsComputeTimeCurrentYear", "jobsComputeTimeCurrentYearSince", "totalStorage"]
