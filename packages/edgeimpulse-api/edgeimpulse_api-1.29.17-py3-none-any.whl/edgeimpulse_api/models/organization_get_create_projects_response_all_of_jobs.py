...
from edgeimpulse_api.models.organization_get_create_projects_response_all_of_created_by_user import OrganizationGetCreateProjectsResponseAllOfCreatedByUser
...
class OrganizationGetCreateProjectsResponseAllOfJobs(BaseModel):
    ...
    created_by_user: Optional[OrganizationGetCreateProjectsResponseAllOfCreatedByUser] = Field(None, alias="createdByUser")
    ...
    def from_dict(cls, obj: dict) -> OrganizationGetCreateProjectsResponseAllOfJobs:
        ...
        _obj = OrganizationGetCreateProjectsResponseAllOfJobs.construct(**{
            ...
            "created_by_user": OrganizationGetCreateProjectsResponseAllOfCreatedByUser.from_dict(obj.get("createdByUser")) if obj.get("createdByUser") is not None else None
        })
        return _obj
