...
from edgeimpulse_api.models.organization_create_project_created_by_user import OrganizationCreateProjectCreatedByUser
...
class OrganizationCreateProject(BaseModel):
    ...
    created_by_user: Optional[OrganizationCreateProjectCreatedByUser] = Field(None, alias="createdByUser")
    ...
    def from_dict(cls, obj: dict) -> OrganizationCreateProject:
        ...
        _obj = OrganizationCreateProject.construct(**{
            ...
            "created_by_user": OrganizationCreateProjectCreatedByUser.from_dict(obj.get("createdByUser")) if obj.get("createdByUser") is not None else None
        })
        return _obj
