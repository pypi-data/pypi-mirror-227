...
class OrganizationsApi(object):
    ...
    @validate_arguments
    def get_organization_metrics(self, organization_id : Annotated[StrictInt, Field(..., description="Organization ID")], exclude_edge_impulse_users : Annotated[Optional[StrictBool], Field(description="Whether to exclude Edge Impulse users when counting enterprise entitlements usage")] = None, **kwargs) -> OrganizationMetricsResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._get_organization_metrics_with_http_info(organization_id, exclude_edge_impulse_users, **kwargs)  # noqa: E501

    @validate_arguments
    def _get_organization_metrics_with_http_info(self, organization_id : Annotated[StrictInt, Field(..., description="Organization ID")], exclude_edge_impulse_users : Annotated[Optional[StrictBool], Field(description="Whether to exclude Edge Impulse users when counting enterprise entitlements usage")] = None, **kwargs):  # noqa: E501
        """Organization metrics 
