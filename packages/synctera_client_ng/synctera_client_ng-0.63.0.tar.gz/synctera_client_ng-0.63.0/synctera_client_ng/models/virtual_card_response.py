...
class VirtualCardResponse(BaseModel):
    ...
    __properties = ["card_status", "memo", "status_reason", "account_id", "card_product_id", "creation_time", "customer_id", "emboss_name", "expiration_month", "expiration_time", "expiration_year", "id", "is_pin_set", "last_four", "last_modified_time", "metadata", "reissue_reason", "reissued_from_id", "reissued_to_id", "type", "form", "bin", "card_brand"]
