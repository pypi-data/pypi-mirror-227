...
class ExternalAccountLanguage(str, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalAccountLanguage:
        """Create an instance of ExternalAccountLanguage from a JSON string"""
        return ExternalAccountLanguage(json.loads(json_str))
