...
class SpendControlResponse(BaseModel):
    ...
    __properties = ["number_of_related_accounts", "action_case", "action_decline", "amount_limit", "creation_time", "direction", "id", "is_active", "last_modified_time", "merchant_category_codes", "name", "payment_types", "time_range"]
