...
class LicenseList(BaseModel):
    ...
    __properties = ["licenses", "next_page_token"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LicenseList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LicenseList:
        """Create an instance of LicenseList from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return LicenseList.parse_obj(obj)

        _obj = LicenseList.parse_obj({
