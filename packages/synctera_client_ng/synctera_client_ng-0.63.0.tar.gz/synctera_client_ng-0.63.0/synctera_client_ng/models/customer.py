...
class Customer(BaseModel):
    ...
    __properties = ["ban_status", "creation_time", "email", "has_accounts", "id", "kyc_exempt", "kyc_last_run", "kyc_status", "last_updated_time", "legal_address", "metadata", "middle_name", "note", "phone_number", "related_customers", "shipping_address", "ssn", "ssn_source", "tenant", "dob", "first_name", "last_name", "status"]
