...
class CardProductResponse(BaseModel):
    ...
    three_ds_policy: ThreeDsPolicy = Field(...)
    txn_enhancer: Optional[TxnEnhancer] = None
    form: StrictStr = Field(..., description="PHYSICAL or VIRTUAL.")
    __properties = ["active", "card_program_id", "color", "creation_time", "digital_wallet_tokenization", "end_date", "id", "image", "image_mode", "issue_without_kyc", "last_modified_time", "name", "orientation", "package_id", "physical_card_format", "return_address", "start_date", "three_ds_policy", "txn_enhancer", "form"]
