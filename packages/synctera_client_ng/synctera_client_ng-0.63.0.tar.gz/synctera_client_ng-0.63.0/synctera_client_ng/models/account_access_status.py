...
class AccountAccessStatus(str, Enum):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountAccessStatus:
        """Create an instance of AccountAccessStatus from a JSON string"""
        return AccountAccessStatus(json.loads(json_str))
