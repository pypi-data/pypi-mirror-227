...
class PatchPayerPayeeRelationshipAllOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchPayerPayeeRelationshipAllOf:
        """Create an instance of PatchPayerPayeeRelationshipAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchPayerPayeeRelationshipAllOf:
        """Create an instance of PatchPayerPayeeRelationshipAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchPayerPayeeRelationshipAllOf.parse_obj(obj)

        _obj = PatchPayerPayeeRelationshipAllOf.parse_obj({
