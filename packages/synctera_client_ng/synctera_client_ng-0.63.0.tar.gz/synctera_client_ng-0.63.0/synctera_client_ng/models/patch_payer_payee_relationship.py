...
class PatchPayerPayeeRelationship(BaseModel):
    """
    > 🚧 Alpha > The PAYER_PAYEE relationship is Alpha. We may make breaking changes to this schema. PAYER_PAYEE denotes the relationship between specified person or business as a payer or payee to a person or business 
    """
    additional_data: Optional[PayerPayeeAdditionalData] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchPayerPayeeRelationship:
        """Create an instance of PatchPayerPayeeRelationship from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchPayerPayeeRelationship:
        """Create an instance of PatchPayerPayeeRelationship from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchPayerPayeeRelationship.parse_obj(obj)

        _obj = PatchPayerPayeeRelationship.parse_obj({
