...
class PostLicense(BaseModel):
    ...
    license_number: Optional[constr(strict=True, min_length=1)] = Field(None, description="The entity's license number")
    ...
    __properties = ["business_id", "customer_id", "license_number", "license_type", "tenant"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostLicense:
        """Create an instance of PostLicense from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostLicense:
        """Create an instance of PostLicense from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PostLicense.parse_obj(obj)

        _obj = PostLicense.parse_obj({
