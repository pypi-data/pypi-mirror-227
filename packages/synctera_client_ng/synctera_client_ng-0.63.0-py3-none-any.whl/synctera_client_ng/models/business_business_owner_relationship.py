...
class BusinessBusinessOwnerRelationship(BaseModel):
    ...
    """
    additional_data: AdditionalOwnerData = Field(...)
    ...
    __properties = ["additional_data", "creation_time", "from_business_id", "id", "last_updated_time", "metadata", "relationship_type", "tenant", "to_business_id"]
