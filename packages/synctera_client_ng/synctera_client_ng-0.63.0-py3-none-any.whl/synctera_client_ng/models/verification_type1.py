...
class VerificationType1(str, Enum):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VerificationType1:
        """Create an instance of VerificationType1 from a JSON string"""
        return VerificationType1(json.loads(json_str))
