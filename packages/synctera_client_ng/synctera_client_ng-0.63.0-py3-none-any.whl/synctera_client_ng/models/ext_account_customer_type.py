...
class ExtAccountCustomerType(str, Enum):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExtAccountCustomerType:
        """Create an instance of ExtAccountCustomerType from a JSON string"""
        return ExtAccountCustomerType(json.loads(json_str))
