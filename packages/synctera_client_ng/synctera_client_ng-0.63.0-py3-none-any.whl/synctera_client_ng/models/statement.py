...
class Statement(BaseModel):
    ...
    transactions: Optional[conlist(Transaction)] = Field(None, description="This attribute is deprecated and will be removed in a future API version. Use `GET /v0/statements/{statement_id}/transactions` instead. ")
    ...
    __properties = ["savings_summary", "account_id", "due_date", "end_date", "id", "issue_date", "start_date", "account_summary", "authorized_signer", "closing_balance", "customer_service_details", "disclosure", "joint_account_holders", "opening_balance", "primary_account_holder_business", "primary_account_holder_personal", "transactions", "transactions_omitted"]
