...
class InternalTransferResponse(BaseModel):
    ...
    __properties = ["id", "status", "amount", "capture_mode", "currency", "expires_at", "final_customer_id", "memo", "metadata", "originating_account_alias", "originating_account_customer_id", "originating_account_id", "receiving_account_alias", "receiving_account_customer_id", "receiving_account_id", "tenant", "type"]

    @validator('status')
    def status_validate_enum(cls, v):
        if v not in ('CANCELED', 'COMPLETE', 'EXPIRED', 'PENDING'):
            raise ValueError("must be one of enum values ('CANCELED', 'COMPLETE', 'EXPIRED', 'PENDING')")
        return v
