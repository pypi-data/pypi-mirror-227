...
class SpendControlsApi(object):
    ...
    def list_spend_controls(self, amount_limit_gte : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results with an amount limit greater than or equal to this")] = None, id : Annotated[Optional[conlist(StrictStr)], Field(description="return results with these comma-separated IDs")] = None, amount_limit_lte : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results with an amount limit less than or equal to this")] = None, num_related_accounts_gte : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results that are associated with at least this many accounts")] = None, num_related_accounts : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results that are associated with this many accounts")] = None, num_related_accounts_lte : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results that are associated with at most this many accounts")] = None, sort_by : Annotated[Optional[conlist(StrictStr)], Field(description="Specifies the sort order for returned Spend Controls. ")] = None, payment_type : Optional[PaymentType] = None, name : Annotated[Optional[StrictStr], Field(description="return results that match this name")] = None, direction : Optional[SpendControlDirection] = None, is_active : Annotated[Optional[StrictBool], Field(description="return results that match this active status")] = None, account_id : Annotated[Optional[StrictStr], Field(description="return results matching this account ID")] = None, amount_limit : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results matching this amount limit")] = None, **kwargs) -> SpendControlResponseList:  # noqa: E501
        ...
        >>> thread = api.list_spend_controls(amount_limit_gte, id, amount_limit_lte, num_related_accounts_gte, num_related_accounts, num_related_accounts_lte, sort_by, payment_type, name, direction, is_active, account_id, amount_limit, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_spend_controls_with_http_info(amount_limit_gte, id, amount_limit_lte, num_related_accounts_gte, num_related_accounts, num_related_accounts_lte, sort_by, payment_type, name, direction, is_active, account_id, amount_limit, **kwargs)  # noqa: E501

    @validate_arguments
    def list_spend_controls_with_http_info(self, amount_limit_gte : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results with an amount limit greater than or equal to this")] = None, id : Annotated[Optional[conlist(StrictStr)], Field(description="return results with these comma-separated IDs")] = None, amount_limit_lte : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results with an amount limit less than or equal to this")] = None, num_related_accounts_gte : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results that are associated with at least this many accounts")] = None, num_related_accounts : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results that are associated with this many accounts")] = None, num_related_accounts_lte : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results that are associated with at most this many accounts")] = None, sort_by : Annotated[Optional[conlist(StrictStr)], Field(description="Specifies the sort order for returned Spend Controls. ")] = None, payment_type : Optional[PaymentType] = None, name : Annotated[Optional[StrictStr], Field(description="return results that match this name")] = None, direction : Optional[SpendControlDirection] = None, is_active : Annotated[Optional[StrictBool], Field(description="return results that match this active status")] = None, account_id : Annotated[Optional[StrictStr], Field(description="return results matching this account ID")] = None, amount_limit : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results matching this amount limit")] = None, **kwargs):  # noqa: E501
        """List Spend Controls  # noqa: E501
        ...
        >>> thread = api.list_spend_controls_with_http_info(amount_limit_gte, id, amount_limit_lte, num_related_accounts_gte, num_related_accounts, num_related_accounts_lte, sort_by, payment_type, name, direction, is_active, account_id, amount_limit, async_req=True)
        >>> result = thread.get()
