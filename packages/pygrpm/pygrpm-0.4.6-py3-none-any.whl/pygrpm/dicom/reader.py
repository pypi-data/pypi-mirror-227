...
class DicomReader:
    ...
    def yield_dicoms(self) -> Generator[pydicom.FileDataset]:
        """
    ...
    def build_studies(self) -> list[DicomStudy]:
        ...
        for dcm in self.dicoms:
            ...
            if len(study.series) == 0 or dcm.SeriesInstanceUID not in study.series_UID:
                ...
                series = self.get_series(study, dcm.SeriesInstanceUID)
    ...
    def get_study(self, study_UID: str) -> Union[DicomStudy, None]:
        """
    ...
    @staticmethod
    def get_series(study: DicomStudy, series_UID: str) -> Union[DicomSeries, None]:
        """
        Helper method to obtain a DicomSeries class from its DicomStudy
        @param study: The reference DicomStudy dataclass
