...
class SRBuilder:
    ...
    def _adapt_sr_to_existing_study(self):
        ...
        # Study layer
        self.dicom_sr.StudyDate = dicom_to_refer.StudyDate
        self.dicom_sr.StudyTime = dicom_to_refer.StudyTime
        self.dicom_sr.AccessionNumber = dicom_to_refer.AccessionNumber

        if 'InstitutionName' in dicom_to_refer:
            self.dicom_sr.InstitutionName = dicom_to_refer.InstitutionName

        if 'InstitutionalDepartmentalName' in dicom_to_refer:
            self.dicom_sr.InstitutionalDepartmentalName = \
                dicom_to_refer.InstitutionalDepartmentalName

        self.dicom_sr.ReferringPhysicianName = dicom_to_refer.ReferringPhysicianName
        self.dicom_sr.StudyInstanceUID = dicom_to_refer.StudyInstanceUID
        self.dicom_sr.StudyID = dicom_to_refer.StudyID

        if 'StudyDescription' in dicom_to_refer:
