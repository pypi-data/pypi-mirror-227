...
Usage::
    ...
    ```python
    from mypy_boto3_sts.type_defs import DictOrStrTypeDef

    data: DictOrStrTypeDef = ...
    ```
"""
import sys
...
PolicyDescriptorTypeTypeDef = TypedDict(
    "PolicyDescriptorTypeTypeDef",
    {
        "arn": NotRequired[DictOrStrTypeDef],
    },
)
...
ProvidedContextTypeDef = TypedDict(
    "ProvidedContextTypeDef",
    {
        "ProviderArn": NotRequired[DictOrStrTypeDef],
...
AssumeRoleWithSAMLRequestRequestTypeDef = TypedDict(
    "AssumeRoleWithSAMLRequestRequestTypeDef",
    {
        "RoleArn": DictOrStrTypeDef,
        "PrincipalArn": DictOrStrTypeDef,
        "SAMLAssertion": str,
        "PolicyArns": NotRequired[Sequence[PolicyDescriptorTypeTypeDef]],
        "Policy": NotRequired[DictOrStrTypeDef],
        "DurationSeconds": NotRequired[int],
    },
)
