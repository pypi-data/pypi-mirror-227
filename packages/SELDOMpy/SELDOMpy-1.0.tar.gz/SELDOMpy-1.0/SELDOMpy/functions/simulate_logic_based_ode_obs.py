...
def simulate_logic_based_ode_obs(model, exps, ivpsol):
    ...
    print("Simulating the network model...")
    ...
    # so those of the same type of all the experiments are joined in the same list that will then be covered in sim_logic_ode.c
    n_observables = []
    t_s = []
    t_con = []
    index_observables = []
