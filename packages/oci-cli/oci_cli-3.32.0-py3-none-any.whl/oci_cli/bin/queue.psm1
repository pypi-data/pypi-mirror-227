...
function GetOciCommandsToLongParams_queue() {
    $ociCommandsToLongParams = @{
        ...
        'queue messages get-messages' = 'from-json help limit queue-id timeout-in-seconds visibility-in-seconds'
        'queue messages get-stats' = 'from-json help queue-id'
        ...
        'queue queue-admin queue create' = 'compartment-id custom-key defined-tags display-name dlq-delivery-count freeform-tags from-json help max-wait-seconds retention-in-seconds timeout-in-seconds visibility-in-seconds wait-for-state wait-interval-seconds'
        ...
        'queue queue-admin queue purge' = 'from-json help if-match max-wait-seconds purge-type queue-id wait-for-state wait-interval-seconds'
        'queue queue-admin queue update' = 'custom-key defined-tags display-name dlq-delivery-count force freeform-tags from-json help if-match max-wait-seconds queue-id timeout-in-seconds visibility-in-seconds wait-for-state wait-interval-seconds'
