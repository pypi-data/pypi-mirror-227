...
def process_api_args_apply_file(
    *, args: Namespace, extension: str, file_dir: str, filename: str
    ...
    """
    if args.gen == "class_names" and not (args.function or args.clss):
        raise NotImplementedError("Error, will not apply class_names")
    if args.gen == "docstring" and not (args.function or args.clss):
        apply_file_docstring_json_to_py(
            extension=extension,
            file_dir=file_dir,
            filename=filename,
    ...
    elif args.gen == "func_names" and not (args.function or args.clss):
        raise NotImplementedError("Error, will not apply func_names")
    if args.gen == "json" and not (args.function or args.clss):
        raise NotImplementedError(
            "Error, the thing that is applied, is a json, so will not apply a "
            + "json to a json."
        )
    if args.gen == "src_code" and not (args.function or args.clss):
        apply_file_json_to_py(
            extension=extension,
            file_dir=file_dir,
            filename=filename,
    ...
    elif args.gen == "test_code" and not (args.function or args.clss):
        apply_test_code_json_for_file_to_py(
            extension=extension,
            file_dir=file_dir,
            filename=filename,
    ...
    elif args.gen == "test_names" and not (args.function or args.clss):
...
def process_api_args_apply_function(
    *,
    ...
    if args.gen == "class_names" and args.function is not None:
        raise NotImplementedError(
            "Error, will not apply class_names for function."
        )
    if args.gen == "docstring" and args.function is not None:
        apply_function_docstring_json_to_py(
            extension=extension,
            file_dir=file_dir,
            filename=filename,
    ...
    elif args.gen == "func_names" and args.function is not None:
        raise NotImplementedError(
            "Error, will not apply func_names for function"
        )
    if args.gen == "json" and args.function is not None:
        raise NotImplementedError(
            "Error, the thing that is applied, is a json, so will not apply a "
            + "json to a json."
        )
    if args.gen == "src_code" and args.function is not None:
        apply_function_json_to_py(
            extension=extension,
            file_dir=file_dir,
            filename=filename,
    ...
    elif args.gen == "test_code" and args.function is not None:
        apply_test_code_json_for_function_to_py(
            extension=extension,
            file_dir=file_dir,
            filename=filename,
    ...
    elif args.gen == "test_names" and args.function is not None:
        raise NotImplementedError(
...
def process_api_args_apply_class(
    *,
    ...
    if args.gen == "class_names" and args.clss is not None:
        raise NotImplementedError(
            "Error, will not apply class_names for class."
        )
    if args.gen == "docstring" and args.clss is not None:
    ...
    elif args.gen == "func_names" and args.clss is not None:
        raise NotImplementedError("Error, will not apply func_names for class")
    if args.gen == "json" and args.clss is not None:
        raise NotImplementedError(
            "Error, the thing that is applied, is a json, so will not apply a "
            + "json to a json."
        )
    if args.gen == "src_code" and args.clss is not None:
        apply_class_json_to_py(
            class_name=class_name,
            extension=extension,
            file_dir=file_dir,
    ...
    elif args.gen == "test_code" and args.clss is not None:
        apply_test_code_json_for_class_to_py(
            class_name=class_name,
            extension=extension,
            file_dir=file_dir,
    ...
    elif args.gen == "test_names" and args.clss is not None:
        raise NotImplementedError(
