...
def card_component(data=None, styles=None, typeExpand=None, showAdd=None, addHeroComponent=None, showHero=None, showChartSwitch=None, saveEdits=None, EditDashboard=None, on_change=None, key=None):
...
if not _RELEASE:
    ...
    def on_Change():
        st.session_state["Test"] = "Changes have been made"

    
    num_clicks = card_component(data=data, showAdd=True, addHeroComponent=True, showHero=True, showChartSwitch=False, saveEdits=False, EditDashboard=True, key="foo_")
