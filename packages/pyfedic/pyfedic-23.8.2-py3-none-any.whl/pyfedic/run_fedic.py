...
from .tictoc import tictoc, summary
from .dic import DIC
...
def run_fedic():
    ...
    exec(open(fname).read(), dict(params=params))

    if 'result_path' not in params.params():
        params.result_path = fname.with_name('output_' + fname.stem)
