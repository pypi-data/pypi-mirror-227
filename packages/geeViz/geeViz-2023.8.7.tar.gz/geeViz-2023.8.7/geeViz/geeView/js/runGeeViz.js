...
try{
	Map2.addSerializedTimeLapse({"result": "0", "values": {"0": {"functionInvocationValue": {"functionName": "ImageCollection.load", "arguments": {"id": {"constantValue": "JRC/GSW1_0/YearlyHistory"}}}}}},{"min": 1, "max": 3, "palette": ["ffffff", "99d9ea", "0000ff"], "classLegendDict": {"1 Not Water": "ffffff", "2 Seasonal Water": "99d9ea", "3 Permanent Water": "0000ff"}},'JRC Surface Water Time Lapse',false);
}catch(err){
