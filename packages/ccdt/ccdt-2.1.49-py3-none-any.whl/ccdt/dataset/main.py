...
def parser_args():
    ...
    parser.add_argument('--json-file', type=str,
                        help="图像文件约定目录规则,00.images")
    parser.add_argument('--image-file', type=str,
                        help="json文件约定目录规则，01.labelme")
    parser.add_argument('--helmet-true', type=str,
                        help="分类目录规则,helmet")
    parser.add_argument('--helmet-false', type=str,
                        help="分类目录规则，no_select")
