...
class TestWebSocketEventActiveListeningMode(unittest.TestCase):
    """WebSocketEventActiveListeningMode unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test WebSocketEventActiveListeningMode
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # model = mozart_api.models.web_socket_event_active_listening_mode.WebSocketEventActiveListeningMode()  # noqa: E501
        if include_optional:
            return WebSocketEventActiveListeningMode(
                event_data=mozart_api.models.listening_mode_props.ListeningModeProps(
                    client_ctx="0",
    ...
    def testWebSocketEventActiveListeningMode(self):
        """Test WebSocketEventActiveListeningMode"""
