...
def get_topic_similarity_params():
    config = load_config()
    return config["topic-similarity"]["params"]

def get_topic_model_path():
    config = load_config()
    return config["topic-similarity"]["model-path"]

def get_similarities_path():
    config = load_config()
    return config["topic-similarity"]["similarity-path"]