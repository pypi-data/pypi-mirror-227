...
class AsyncTradingDataAPI(AsyncClient):

    async def __init__(self, api_key='-1', api_secret_key='-1', passphrase='-1', use_server_time=False, flag='1', domain='https://www.okx.com', debug=True):
    ...
    async def get_taker_block_volume(self, ccy, period=''):
        params = {'ccy': ccy, 'period': period}
