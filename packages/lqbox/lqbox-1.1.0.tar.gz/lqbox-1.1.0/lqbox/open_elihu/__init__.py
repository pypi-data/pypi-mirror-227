...
class OpenElihuBox(BaseBox):
    ...
    def request_open_api(self, api_path, body):
    ...
    def call_check_task_detail(self, task_id: int) -> dict:
        """获取某个任务的状态"""
    ...
    def call_get_accounts_without_long_session(self, account_id_list: List[int], platform_code: str) -> List[int]:
