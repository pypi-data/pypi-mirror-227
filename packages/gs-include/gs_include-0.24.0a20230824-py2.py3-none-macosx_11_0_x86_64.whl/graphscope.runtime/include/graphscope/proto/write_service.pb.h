...
PROTOBUF_NAMESPACE_OPEN
template <>
::gs::rpc::groot::BatchWriteRequest* Arena::CreateMaybeMessage<::gs::rpc::groot::BatchWriteRequest>(Arena*);
template <>
::gs::rpc::groot::BatchWriteResponse* Arena::CreateMaybeMessage<::gs::rpc::groot::BatchWriteResponse>(Arena*);
template <>
::gs::rpc::groot::DataRecordPb* Arena::CreateMaybeMessage<::gs::rpc::groot::DataRecordPb>(Arena*);
template <>
::gs::rpc::groot::DataRecordPb_PropertiesEntry_DoNotUse* Arena::CreateMaybeMessage<::gs::rpc::groot::DataRecordPb_PropertiesEntry_DoNotUse>(Arena*);
template <>
::gs::rpc::groot::EdgeRecordKeyPb* Arena::CreateMaybeMessage<::gs::rpc::groot::EdgeRecordKeyPb>(Arena*);
template <>
::gs::rpc::groot::GetClientIdRequest* Arena::CreateMaybeMessage<::gs::rpc::groot::GetClientIdRequest>(Arena*);
template <>
::gs::rpc::groot::GetClientIdResponse* Arena::CreateMaybeMessage<::gs::rpc::groot::GetClientIdResponse>(Arena*);
template <>
::gs::rpc::groot::RemoteFlushRequest* Arena::CreateMaybeMessage<::gs::rpc::groot::RemoteFlushRequest>(Arena*);
template <>
::gs::rpc::groot::RemoteFlushResponse* Arena::CreateMaybeMessage<::gs::rpc::groot::RemoteFlushResponse>(Arena*);
template <>
::gs::rpc::groot::VertexRecordKeyPb* Arena::CreateMaybeMessage<::gs::rpc::groot::VertexRecordKeyPb>(Arena*);
template <>
::gs::rpc::groot::VertexRecordKeyPb_PkPropertiesEntry_DoNotUse* Arena::CreateMaybeMessage<::gs::rpc::groot::VertexRecordKeyPb_PkPropertiesEntry_DoNotUse>(Arena*);
template <>
::gs::rpc::groot::WriteRequestPb* Arena::CreateMaybeMessage<::gs::rpc::groot::WriteRequestPb>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class BatchWriteRequest final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::gs::rpc::groot::WriteRequestPb>& _internal_write_requests() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::gs::rpc::groot::WriteRequestPb>* _internal_mutable_write_requests();
  public:
