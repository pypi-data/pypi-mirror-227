...
PROTOBUF_NAMESPACE_OPEN
template <>
::gs::rpc::groot::AddEdgeKindRequest* Arena::CreateMaybeMessage<::gs::rpc::groot::AddEdgeKindRequest>(Arena*);
template <>
::gs::rpc::groot::BatchSubmitRequest* Arena::CreateMaybeMessage<::gs::rpc::groot::BatchSubmitRequest>(Arena*);
template <>
::gs::rpc::groot::BatchSubmitRequest_DDLRequest* Arena::CreateMaybeMessage<::gs::rpc::groot::BatchSubmitRequest_DDLRequest>(Arena*);
template <>
::gs::rpc::groot::BatchSubmitResponse* Arena::CreateMaybeMessage<::gs::rpc::groot::BatchSubmitResponse>(Arena*);
template <>
::gs::rpc::groot::CreateEdgeTypeRequest* Arena::CreateMaybeMessage<::gs::rpc::groot::CreateEdgeTypeRequest>(Arena*);
template <>
::gs::rpc::groot::CreateVertexTypeRequest* Arena::CreateMaybeMessage<::gs::rpc::groot::CreateVertexTypeRequest>(Arena*);
template <>
::gs::rpc::groot::DropEdgeTypeRequest* Arena::CreateMaybeMessage<::gs::rpc::groot::DropEdgeTypeRequest>(Arena*);
template <>
::gs::rpc::groot::DropVertexTypeRequest* Arena::CreateMaybeMessage<::gs::rpc::groot::DropVertexTypeRequest>(Arena*);
template <>
::gs::rpc::groot::GetGraphDefRequest* Arena::CreateMaybeMessage<::gs::rpc::groot::GetGraphDefRequest>(Arena*);
template <>
::gs::rpc::groot::GetGraphDefResponse* Arena::CreateMaybeMessage<::gs::rpc::groot::GetGraphDefResponse>(Arena*);
template <>
::gs::rpc::groot::RemoveEdgeKindRequest* Arena::CreateMaybeMessage<::gs::rpc::groot::RemoveEdgeKindRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class BatchSubmitRequest final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::gs::rpc::groot::BatchSubmitRequest_DDLRequest>& _internal_value() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::gs::rpc::groot::BatchSubmitRequest_DDLRequest>* _internal_mutable_value();
  public:
