...
def get_scan_browser():
    wi_mg,browse_bridge,browse_script_name=create_window_manager(script_name="browse_script",global_var=globals())
    ...
    if os.path.isdir(directory):
        window_mgr.update_values(key='-DIR-',args={"value":directory})
        window_mgr.update_values(key='-FILES-',args={"values":scan_directory(directory, js_bridge["scan_mode"])})
    ...
    window = window_mgr.get_new_window('File/Folder Scanner',args={"layout":layout,"event_function":"scan_window"})
