...
def detect_outliers(
    ...
    This function identifies outliers combining two methods, dbscan and csap.
    ...
    Args:
        ...
        reg_smooth: Smoothing factor.
            The smoothing parameter determines the weighted sum of terms in the regression, which is limited by
        ...
        min_samples: Minimum samples.
            ...
            Defines the minimum number of data points required to form a distinct cluster. Rules for selecting
        ...
        eps: Distance threshold.
            ...
            k-distances where the graph has the greatest slope). This is not a maximum bound on the distances of
            points within a cluster.
            Defaults to None, eps value has to be > 0.0.
        time_window: Time window.
            Length of the time period to compute the rolling mean. The rolling mean and the data point value are the two features considered when calculating the distance to the furthest neighbor.
...
def remove_outliers(
    ...
    This function identifies and removes outliers by combining two methods, dbscan and csap.

    - **dbscan**: Density-based clustering algorithm used to identify clusters of varying shape and size within a data
      set. Does not require a pre-determined set number of clusters. Able to identify outliers as noise, instead of
      classifying them into a cluster. Flexible when it comes to the size and shape of clusters, which makes it more
      useful for noise, and real-life data. It is flexible regarding the size and shape of clusters, making it more useful for noise, real life data.
    ...
    Args:
        ...
        min_samples: Minimum samples.
            Minimum number of data points required to form a distinct cluster. Defaults to 4.
            Defines the minimum number of data points required to form a distinct cluster. Rules for
           selecting the value of the minimum samples:
...
def _get_outlier_indices(
    ...
    This function identifies the indices of outliers in the given time series combining two methods, dbscan and csap.
