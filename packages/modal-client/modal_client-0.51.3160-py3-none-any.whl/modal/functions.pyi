...
class _Function(modal.object._Provider):
    ...
    @staticmethod
    def from_parametrized(base_function: _Function, *args: typing.Iterable[typing.Any], **kwargs: typing.Dict[str, typing.Any]) -> _Function:
        ...
    ...
    def remote(self, *args, **kwargs) -> typing.Awaitable[typing.Any]:
        ...
...
class Function(modal.object.Provider):
    ...
    @staticmethod
    def from_parametrized(base_function: Function, *args: typing.Iterable[typing.Any], **kwargs: typing.Dict[str, typing.Any]) -> Function:
        ...
...
class _FunctionCallHandle(modal.object._Handle):
    ...

class _FunctionCall(modal.object._Provider):
...
class FunctionCall(modal.object.Provider):
    def __init__(self):
        ...
