...
class ValidationSuccessResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["pandas_column_description", b"pandas_column_description", "sample", b"sample", "spark_column_description", b"spark_column_description"]) -> None: ...
