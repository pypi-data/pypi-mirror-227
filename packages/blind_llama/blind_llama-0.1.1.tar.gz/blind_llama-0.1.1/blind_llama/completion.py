...
class Client():
    ...
    def __init__(
        ...
        ca_cert = self.verify_server_certificate(blind_llama.security_config["expected_pcrs"]["pcr0"])
    ...
    def verify_build_response(self, build_response: bytes, verbose: bool = False, ca_cert = "", expected_pcr = ""):
