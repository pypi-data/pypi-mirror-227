...
class Cloud9Environment(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: -
        :param id: -
        :param connection_type: The type of connection method to use. Default: - SSM
        ...
        :param image_id: The identifier for the Amazon Machine Image (AMI) that's used to create the EC2 instance. Default: - AMZN_LINUX_2
    ...
    def repositories(
        self,
    ) -> typing.List[_aws_cdk_aws_cloud9_ceddda9d.CfnEnvironmentEC2.RepositoryProperty]:
        return typing.cast(typing.List[_aws_cdk_aws_cloud9_ceddda9d.CfnEnvironmentEC2.RepositoryProperty], jsii.get(self, "repositories"))
    ...
    def steps(self) -> typing.List[typing.Mapping[typing.Any, typing.Any]]:
        return typing.cast(typing.List[typing.Mapping[typing.Any, typing.Any]], jsii.get(self, "steps"))

    @steps.setter
    def steps(self, value: typing.List[typing.Mapping[typing.Any, typing.Any]]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__52e3fccb4284219641c2405ac8b1f8837dafb5e27451de4f5f35086599d6b283)
...
def _typecheckingstub__52e3fccb4284219641c2405ac8b1f8837dafb5e27451de4f5f35086599d6b283(
    value: typing.List[typing.Mapping[typing.Any, typing.Any]],
) -> None:
    """Type checking stubs"""
    pass
