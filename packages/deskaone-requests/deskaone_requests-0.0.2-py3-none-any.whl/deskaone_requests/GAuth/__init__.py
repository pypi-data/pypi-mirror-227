...
class GAuth:
    ...
    def _perform_auth_request(self, data: Union[Dict[str, int], Dict[str, str], Dict[str, bytes]], proxies: Optional[MutableMapping[str, str]] = None) -> Dict[str, str]:
    ...
    def Login(
        ...
        data: Union[Dict[str, int], Dict[str, str], Dict[str, bytes]] = {
