...
def torch_data(train_dataloader=None, val_dataloader=None, test_dataloader=None, dataset_name="", label_index=1,
  ...
  if save_new_data_flag == 1:   
      ...
      if len(train_dataloader) > 0:
        config_dict.update({'train_dataloader': newest_data_folder + '/train_dataloader.pkl'})
      if len(val_dataloader) > 0:
        config_dict.update({'val_dataloader': newest_data_folder + '/val_dataloader.pkl'})
      if len(test_dataloader) > 0:
        config_dict.update({'test_dataloader': newest_data_folder + '/test_dataloader.pkl'})
