...
class Game():
    ...
    def get_my_heros(self, player_id):
        ...
        if heros:
            ...
            raise Warning(colored('Heros not found', 'red'))
    ...
    def get_hero_by_name(self, name):
        if check_string(name):
            ...
            if hero:
                ...
                raise Warning(colored('Hero not found', 'red'))
        else:
            raise Warning(
                colored('Invalid values, value must be string', 'yellow'))
    ...
    def get_hero_by_id(self, hero_id, hero_order):
        if check_number(hero_id) and check_number(hero_order):
            ...
            if hero_order < 0 or hero_order > 2:
                raise Warning(
                    colored('Hero order needs to be between 0 to 2', 'red'))
    ...
    def get_map_battle_sa(self, map_id_or_name):
        if not isinstance(map_id_or_name, bool) and isinstance(map_id_or_name, int) or isinstance(map_id_or_name, str):
            ...
            if sa:
                ...
                raise Warning(colored('Map not found', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number', 'yellow'))
    ...
    def get_guild(self, guild_id_or_name):
        if not isinstance(guild_id_or_name, bool) and isinstance(guild_id_or_name, int) or isinstance(guild_id_or_name, str):
            ...
            if guild:
                ...
                raise Warning(colored('Guild not found', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number', 'yellow'))
    ...
    def get_guild_members(self, guild_id_or_name):
        if not isinstance(guild_id_or_name, bool) and isinstance(guild_id_or_name, int) or isinstance(guild_id_or_name, str):
            ...
            if members:
                ...
                raise Warning(colored('Members not found', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number', 'yellow'))
    ...
    def get_switchs_by_id(self, hero_id, hero_order):
        if check_number(hero_id) and check_number(hero_order):
            ...
            if switch:
                ...
                raise Warning(colored('Switchs not found', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number', 'yellow'))
    ...
    def get_switch_by_id(self, hero_id, hero_order, switch_number):
        if check_number(hero_id) and check_number(hero_order) and check_number(switch_number):
            ...
            if switch:
                ...
                raise Warning(colored('Switch not found', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number', 'yellow'))
    ...
    def get_skills_by_id(self, hero_id, hero_order):
        if check_number(hero_id) and check_number(hero_order):
            ...
            if skill:
                ...
                raise Warning(colored('Skills not found', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number', 'yellow'))
    ...
    def get_skill_by_id(self, hero_id, hero_order, skill_index):
        if check_number(hero_id) and check_number(hero_order) and check_number(skill_index):
            ...
            if skill:
                ...
                raise Warning(colored('Skill not found', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number', 'yellow'))
    ...
    def get_friends_by_id(self, hero_id, hero_order):
        if check_number(hero_id) and check_number(hero_order):
            ...
            if friends:
                ...
                raise Warning(colored('Friends not found', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number', 'yellow'))
    ...
    def get_mix_log_by_id(self, hero_id, hero_order):
        if check_number(hero_id) and check_number(hero_order):
            ...
            if mix:
                ...
                raise Warning(colored('MixLog not found', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number', 'yellow'))
    ...
    def get_mix_skill_by_id(self, hero_id, hero_order):
        if check_number(hero_id) and check_number(hero_order):
            ...
            if mix_skill:
                ...
                raise Warning(colored('MixSkill not found', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number ', 'yellow'))
    ...
    def get_quest_log_by_id(self, hero_id, hero_order):
        if check_number(hero_id) and check_number(hero_order):
            ...
            if quest:
                ...
                raise Warning(colored('Quests not found', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number ', 'yellow'))
    ...
    def get_quest_log_by_id(self, hero_id, hero_order, quest_id):
        if check_number(hero_id) and check_number(hero_order) and check_number(quest_id):
            ...
            if quest:
                ...
                raise Warning(colored('Quest not found', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number', 'yellow'))
    ...
    def get_store_by_id(self, hero_id):
        if check_number(hero_id):
            ...
            if store:
                ...
                raise Warning(colored('Store not found', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number', 'yellow'))
    ...
    def get_item_by_id(self, item_id):
        if check_number(item_id):
            ...
            if item:
                ...
                raise Warning(colored('Item not found', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number', 'yellow'))
    ...
    def get_hench_by_id(self, hench_id):
        if check_number(hench_id):
            ...
            if len(hench) > 0:
                ...
                raise Warning(colored('Hench not found', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number', 'yellow'))
    ...
    def get_items_for_hero_by_id(self, hero_id, hero_order):
        if check_number(hero_id) and check_number(hero_order):
            ...
            if items:
                ...
                raise Warning(colored('Items not found', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number', 'yellow'))
    ...
    def get_henchs_for_hero_by_id(self, hero_id, hero_order):
        if check_number(hero_id) and check_number(hero_order):
            ...
            if hench:
                ...
                raise Warning(colored('Henchs not found', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number', 'yellow'))
    ...
    def get_store_henchs_for_player(self, player_id):
        if check_number(player_id):
            ...
            if hench:
                ...
                raise Warning(colored('Henchs not found in store', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number', 'yellow'))
...
# Ranking
    ...
    def set_hero_class_by_id(self, hero_id, hero_order, new_class_id):
        if check_number(hero_id) and check_number(hero_order) and check_number(new_class_id):
            ...
            if new_class_id < 0 or new_class_id > 3:
                raise Warning(
                    colored(f'Invalid new class, use 0 for Ditt, 1 for Jin, 2 for Penril or 3 for Phoy', 'yellow'))
            hero = self.get_hero_by_id(hero_id, hero_order)
            if hero.login == 0:
                if hero.hero_type == new_class_id:
                    raise Warning(
                        colored(f'New class cannot be the same as the current one', 'yellow'))
                hero.hero_type = new_class_id
                self.engine.commit()
                return True
            else:
                raise Warning(
                    colored(f'Change in hero is only possible when not logged in', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number', 'yellow'))
    ...
    def set_hero_name_by_id(self, hero_id, hero_order, new_name):
        ...
        if check:
            ...
            raise Warning(
                colored(f'New Name already exists', 'yellow'))
        if hero.login == 0:
            hero.name = new_name
            self.engine.commit()
            return True
    ...
    def set_hero_gp_by_id(self, hero_id, hero_order, new_gp):
        if check_number(new_gp):
            ...
            if new_gp > 4200000000:
                raise Warning(
                    colored('New Value must be less than 4.2kkk', 'yellow'))
            hero = self.get_hero_by_id(hero_id, hero_order)
            if hero.login == 0:
                hero.gold = new_gp
                self.engine.commit()
    ...
    def set_hero_status_by_id(self, hero_id, hero_order, str_dex_aim_luck, new_status):
        if check_string(str_dex_aim_luck):
            if not check_status_str(str_dex_aim_luck):
                raise Warning(
                    colored('status invalid, only valid string: str, dex, aim or luck', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be string', 'yellow'))
        if check_number(new_status):
            ...
            if new_status > 65000:
                raise Warning(
                    colored('New Value must be less than 65k', 'yellow'))
            hero = self.get_hero_by_id(hero_id, hero_order)
            if hero.login == 0:
    ...
    def set_switch_count_by_id(self, hero_id, hero_order, switch_number, new_count):
        if check_number(new_count):
            ...
            if new_count > 65535 or new_count < 1:
                raise Warning(
                    colored(f'Count must be between 1 and 65535', 'yellow'))
        ...
        if check_number(success_count):
            ...
            if format_data == "Invalid string format" or format_data == "Invalid input type":
                ...
                if check:
                    ...
                    raise Warning(
                        colored(f'Switch Already exists', 'yellow'))
        else:
            raise Warning(
                colored('Invalid search, value must be number', 'yellow'))
    ...
    def clean_henchs_by_id(self, hero_id, hero_order):
        if not self.get_hero_login_by_id(hero_id, hero_order):
            ...
            if final_id == 0:
                ...
                raise Warning(
                    colored(f'Invalid hero id', 'yellow'))
        else:
            raise Warning(
                colored(f'Change in hero is only possible when not logged in', 'yellow'))
