...
a_strategy_choice = {
    ...
    'oneOf': [a_strategy_coronagraphy, a_strategy_ifuapphot, a_strategy_ifunodinscene, a_strategy_ifunodoffscene, a_strategy_imagingapphot,
              ...
              a_strategy_soss, a_strategy_specapphot, a_strategy_specscanapphot, a_strategy_specsegmentedphot,
              a_strategy_taspec, a_strategy_taphot, a_strategy_tarectphot],
}
...
a_client_data = {
    'oneOf': [
        {'type': 'null'},
        {'type': 'object'}, # optional and used only by client - maybe define more explicitly later
    ]
}
