...
if __name__ == "__main__":
    ...
    # Test ...
    if 1:
        options["reconstruction"]["start_x"] = 1024-200
        options["reconstruction"]["end_x"] = 1024+200
        options["reconstruction"]["start_y"] = 1024-200
        options["reconstruction"]["end_y"] = 1024+200
        options["reconstruction"]["start_z"] = 0
        options["reconstruction"]["end_z"] = SUB_REGION[-1]-1
        options["reconstruction"]["reconstruct_along_axis"] = "z"
        d_rec = garray.zeros((100, 401, 401), "f") # y
    #
    else:
