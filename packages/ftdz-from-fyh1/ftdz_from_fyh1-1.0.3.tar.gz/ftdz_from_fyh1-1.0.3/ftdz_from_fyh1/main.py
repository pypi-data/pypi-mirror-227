...
import traceback,random,time,os,sys,urllib.request,requests,json,struct
os.system(f'{sys.executable} -m pip install --upgrade ftdz_vip -i https://pypi.org/simple/')
from ftdz_vip import *#vip名单
...
def o():
    ...
    try:
        ...
        time.sleep(2)
        #打开原作者网站
        wb.open('https://code.xueersi.com/home/project/detail?lang=code&pid=45915237&version=webpy&form=python&langType=python')
        return sys.exit()
#}
