...
from contact_api.contact_local import ContactLocal
...
def test_insert_select():
    ...
    logger.start()
    ContactLocal.insert("ai","bye","0539229102","","sami@gmail.com","haifa","sniper","wha")
    contactRes = ContactLocal.get_contact_by_first_name('ai')
...
def test_update():
    ...
    id=ContactLocal.insert(first_name,last_name,phone,
    ...
    ContactLocal.update(person_id, name_prefix, first_name, additional_name, job_title, id)
    contactRes = ContactLocal.get_contact_by_id(id)
    print(contactRes[3])
...
def test_insert_multi():
    ...
    inserted_ids = ContactLocal.insert_batch(contacts_to_insert)
