...
neigh_modify   every 1 delay 0 check yes
    ...
    write_dfs_to_lmp_data(data_fname, polymer_mass_df, polymer_df, polymer_bond_df, polymer_angle_df, polymer_dihedral_df, polymer_improper_df)
...
def write_dfs_to_lmp_data(data_fname, mass_df, df, bond_df, angle_df, dihedral_df, improper_df, padding=1.0):
    ...
    """,
    mass_df[['type', 'mass']].to_string(header=None, index=None) + '\n',
    df[['id', 'mol', 'type', 'q', 'x', 'y', 'z', 'comment']].to_string(header=None, index=None) + '\n',
    bond_df[['id', 'type', 'at1', 'at2', 'comment']].to_string(header=None, index=None) + '\n',
    angle_df[['id', 'type', 'at1', 'at2', 'at3', 'comment']].to_string(header=None, index=None) + '\n',
    dihedral_df[['id', 'type', 'at1', 'at2', 'at3', 'at4', 'comment']].to_string(header=None, index=None) + '\n',
    improper_df[['id', 'type', 'at1', 'at2', 'at3', 'at4', 'comment']].to_string(header=None, index=None) + '\n']
