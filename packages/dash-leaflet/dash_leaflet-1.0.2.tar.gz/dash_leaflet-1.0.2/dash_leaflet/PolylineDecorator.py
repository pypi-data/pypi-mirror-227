...
- positions (list of list of numberss | list of list of list of numbersss; optional):
    ...
    @_explicitize_args
    def __init__(self, children=None, positions=Component.UNDEFINED, patterns=Component.REQUIRED, id=Component.UNDEFINED, loading_state=Component.UNDEFINED, eventHandlers=Component.UNDEFINED, disableDefaultEventHandlers=Component.UNDEFINED, n_clicks=Component.UNDEFINED, n_dblclicks=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'disableDefaultEventHandlers', 'eventHandlers', 'loading_state', 'n_clicks', 'n_dblclicks', 'patterns', 'positions']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'disableDefaultEventHandlers', 'eventHandlers', 'loading_state', 'n_clicks', 'n_dblclicks', 'patterns', 'positions']
