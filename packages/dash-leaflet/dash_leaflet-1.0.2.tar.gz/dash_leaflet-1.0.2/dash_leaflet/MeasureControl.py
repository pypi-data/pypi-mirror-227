...
- secondaryAreaUnit (a value equal to: 'acres', 'hectares', 'sqfeet', 'sqmeters', 'sqmiles'; optional):
    The secondary units used to display area results.

- secondaryLengthUnit (a value equal to: 'feet', 'meters', 'miles', 'kilometers'; optional):
...
- thousandsSep (string; optional):
    ...
    @_explicitize_args
    def __init__(self, position=Component.UNDEFINED, primaryLengthUnit=Component.UNDEFINED, secondaryLengthUnit=Component.UNDEFINED, primaryAreaUnit=Component.UNDEFINED, secondaryAreaUnit=Component.UNDEFINED, activeColor=Component.UNDEFINED, completedColor=Component.UNDEFINED, popupOptions=Component.UNDEFINED, captureZIndex=Component.UNDEFINED, decPoint=Component.UNDEFINED, thousandsSep=Component.UNDEFINED, id=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'activeColor', 'captureZIndex', 'completedColor', 'decPoint', 'loading_state', 'popupOptions', 'position', 'primaryAreaUnit', 'primaryLengthUnit', 'secondaryAreaUnit', 'secondaryLengthUnit', 'thousandsSep']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'activeColor', 'captureZIndex', 'completedColor', 'decPoint', 'loading_state', 'popupOptions', 'position', 'primaryAreaUnit', 'primaryLengthUnit', 'secondaryAreaUnit', 'secondaryLengthUnit', 'thousandsSep']
