...
class AssumeRolePolicy(ServiceResource):
    ...
    def get_available_subresources(self) -> Sequence[str]:
        ...
        """
    def update(self, *, PolicyDocument: DictOrStrTypeDef) -> None:
        """
...
class GroupPolicy(ServiceResource):
    ...
    def load(self) -> None:
        ...
        """
    def put(self, *, PolicyDocument: DictOrStrTypeDef) -> None:
        """
...
class Policy(ServiceResource):
    ...
    def attach_user(self, *, UserName: str) -> None:
        ...
        """
    def create_version(
        self, *, PolicyDocument: DictOrStrTypeDef, SetAsDefault: bool = ...
    ) -> _PolicyVersion:
        """
...
class Group(ServiceResource):
    ...
    def create(self, *, Path: str = ...) -> "_Group":
        ...
        """
    def create_policy(self, *, PolicyName: str, PolicyDocument: DictOrStrTypeDef) -> _GroupPolicy:
        """
        Adds or updates an inline policy document that is embedded in the specified IAM
        group.
...
class LoginProfile(ServiceResource):
    ...
    def User(self) -> "_User":
        ...
        """
    def create(
        self, *, Password: DictOrStrTypeDef, PasswordResetRequired: bool = ...
    ) -> "_LoginProfile":
        """
...
class User(ServiceResource):
    ...
    def create_login_profile(
        ...
        """
    def create_policy(self, *, PolicyName: str, PolicyDocument: DictOrStrTypeDef) -> _UserPolicy:
        """
        Adds or updates an inline policy document that is embedded in the specified IAM
        user.
