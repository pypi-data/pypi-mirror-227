...
class IAMClient(BaseClient):
    ...
    def change_password(
        self, *, OldPassword: DictOrStrTypeDef, NewPassword: DictOrStrTypeDef
    ) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def create_login_profile(
        self, *, UserName: str, Password: DictOrStrTypeDef, PasswordResetRequired: bool = ...
    ) -> CreateLoginProfileResponseTypeDef:
        """
    ...
    def create_policy(
        ...
        *,
        PolicyName: str,
        PolicyDocument: DictOrStrTypeDef,
        Path: str = ...,
        Description: str = ...,
        Tags: Sequence[TagTypeDef] = ...
    ) -> CreatePolicyResponseTypeDef:
    ...
    def create_policy_version(
        self, *, PolicyArn: str, PolicyDocument: DictOrStrTypeDef, SetAsDefault: bool = ...
    ) -> CreatePolicyVersionResponseTypeDef:
        """
    ...
    def create_service_linked_role(
        self, *, AWSServiceName: str, Description: DictOrStrTypeDef = ..., CustomSuffix: str = ...
    ) -> CreateServiceLinkedRoleResponseTypeDef:
        """
    ...
    def get_context_keys_for_custom_policy(
        self, *, PolicyInputList: Sequence[DictOrStrTypeDef]
    ) -> GetContextKeysForPolicyResponseTypeDef:
        """
    ...
    def get_context_keys_for_principal_policy(
        self, *, PolicySourceArn: str, PolicyInputList: Sequence[DictOrStrTypeDef] = ...
    ) -> GetContextKeysForPolicyResponseTypeDef:
        """
    ...
    def put_group_policy(
        self, *, GroupName: str, PolicyName: str, PolicyDocument: DictOrStrTypeDef
    ) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def put_role_policy(
        self, *, RoleName: str, PolicyName: str, PolicyDocument: DictOrStrTypeDef
    ) -> EmptyResponseMetadataTypeDef:
        """
        Adds or updates an inline policy document that is embedded in the specified IAM
        role.
    ...
    def put_user_policy(
        self, *, UserName: str, PolicyName: str, PolicyDocument: DictOrStrTypeDef
    ) -> EmptyResponseMetadataTypeDef:
        """
        Adds or updates an inline policy document that is embedded in the specified IAM
        user.
    ...
    def simulate_custom_policy(
        self,
        *,
        PolicyInputList: Sequence[DictOrStrTypeDef],
        ActionNames: Sequence[str],
        PermissionsBoundaryPolicyInputList: Sequence[DictOrStrTypeDef] = ...,
        ResourceArns: Sequence[str] = ...,
        ResourcePolicy: DictOrStrTypeDef = ...,
        ResourceOwner: str = ...,
        CallerArn: str = ...,
    ...
    def update_assume_role_policy(
        self, *, RoleName: str, PolicyDocument: DictOrStrTypeDef
    ) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def update_role(
        self, *, RoleName: str, Description: DictOrStrTypeDef = ..., MaxSessionDuration: int = ...
    ) -> Dict[str, Any]:
        """
    ...
    def update_role_description(
        self, *, RoleName: str, Description: DictOrStrTypeDef
    ) -> UpdateRoleDescriptionResponseTypeDef:
        """
    ...
    def upload_server_certificate(
        ...
        *,
        ...
        CertificateBody: DictOrStrTypeDef,
        PrivateKey: DictOrStrTypeDef,
        Path: str = ...,
        CertificateChain: DictOrStrTypeDef = ...,
        Tags: Sequence[TagTypeDef] = ...
    ) -> UploadServerCertificateResponseTypeDef:
        """
    ...
    def upload_signing_certificate(
        self, *, CertificateBody: DictOrStrTypeDef, UserName: str = ...
    ) -> UploadSigningCertificateResponseTypeDef:
        """
    ...
    def upload_ssh_public_key(
        self, *, UserName: str, SSHPublicKeyBody: DictOrStrTypeDef
    ) -> UploadSSHPublicKeyResponseTypeDef:
        """
