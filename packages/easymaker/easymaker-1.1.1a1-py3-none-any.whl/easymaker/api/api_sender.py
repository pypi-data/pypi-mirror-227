...
class ApiSender:
    ...
    def run_hyperparameter_tuning(self, hyperparameter_tuning_name, hyperparameter_tuning_description, experiment_id, algorithm_id, image_id,
                                  flavor_id, instance_count, data_storage_size, source_dir_uri, entry_point, hyperparameter_spec_list,
                                  dataset_list, check_point_input_uri, check_point_upload_uri, model_upload_uri, timeout_hours, tag_list, use_log,
