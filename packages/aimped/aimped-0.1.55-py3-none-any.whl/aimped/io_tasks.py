...
class ChatbotInput(BaseModel):
    ...
    data_files: Dict[str, List[str]] = Field(default=None, description="Data files dictionary including text, audio, image, pdf, urls in list", example={"data_txt": ["https://cdn-dev.aimped.ai/temporary/2023-08-28-Global_Economic_Landscape.txt"]})
...
{
  "status": True,
  "data_type": ["data_json", "data_audio"],
  "output": {
    		"data_json":  { "text":"Well…   good luck…" },
		"raw_output": { 'choices': [ { 
'finish_reason': 'stop',
'index': 0,
'message': { 'content': "Well… good luck…",                                      'role': 'assistant'}}],
'created': 1683618639,
'id': 'chatcmpl-7ECPHOawQNqPmqaR4laYWkMtKNVjg',
'model': 'gpt-3.5-turbo-0301',
'object': 'chat.completion',
'usage': { 'completion_tokens': 27,
     'prompt_tokens': 186,
     'total_tokens': 213}},
"extra_fields":document_content,
"data_audio": "//tQxA/7n....VVVV..audio-base64"
