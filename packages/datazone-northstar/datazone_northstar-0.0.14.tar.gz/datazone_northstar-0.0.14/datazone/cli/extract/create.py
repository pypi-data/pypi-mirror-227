...
from datazone.constants import SourceTypes
...
def mysql_source_parameters(payload: Dict):
    ...
    source_table: str = typer.prompt("Source Table")
    payload.update({"source_parameters": {"source_table": source_table}})
...
source_type_parameter_func_mapping = {
    SourceTypes.MYSQL: mysql_source_parameters,
    SourceTypes.AWS_S3_CSV: aws_s3_csv_source_parameters,
}
