...
from features.steps.selenium_utils import get_element_by_dom_id, get_elm_text, click_element_by_dom_id, click_element
...
def then__sentence_is_in_the_context(c, sentence: str):
    sentence = BehaveUtil.clear_string(sentence)
    con = get_element_by_dom_id(c, [A.SentenceAudio, A.Context])
