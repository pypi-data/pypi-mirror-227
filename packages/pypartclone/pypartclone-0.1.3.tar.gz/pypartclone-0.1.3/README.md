...
After the header has been read, the bitmap can be loaded. The bitmap represents
...
read all blocks in sequence. As `blockReader` reads the file sequentially, it
