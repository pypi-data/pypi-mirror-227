...
class readYamlError(baseError):
    def __init__(self, msg='Yaml读取初始化失败', Reason=None):
        super(readYamlError, self).__init__(msg=msg, Reason=Reason)
...
class readFileError(baseError):
    def __init__(self, msg='读取文件失败', Reason=None):
        super(readFileError, self).__init__(msg=msg, Reason=Reason)
...
class excelDataSheetTypeError(baseError):
    def __init__(self, msg='测试数据sheet类型不合法', Reason=None):
        super(excelDataSheetTypeError, self).__init__(msg=msg, Reason=Reason)
