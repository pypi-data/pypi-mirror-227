...
def load_credentials():
    # To authenticate with a service account EBMDATALAB_CREDENTIALS_PATH should be the
    # path of a file containing the service account's private key.  See README.md for
    # requirements of the service account.
    path = os.getenv("EBMDATALAB_CREDENTIALS_PATH")
    if path is None:
        return
