...
from PyQt6.QtWidgets import QDialog, QTableWidget, QTableWidgetItem, QPushButton, QComboBox, QMessageBox, QHBoxLayout, QVBoxLayout
...
class DictInputDialog(QDialog):
    ...
    def _value_type_box_changed(self) -> None:
        ...
        self._dict_input_table.setCellWidget(row, _DictInputTableColumns.ValueContent, self._input_handler.generate_widget_for_type(type_box.currentData()))
    ...
    def _add_row_button_clicked(self) -> None:
        ...
        self._dict_input_table.setCellWidget(row, _DictInputTableColumns.ValueContent, self._input_handler.generate_widget_for_type(value_type_box.currentData()))
...
class EditDictButton(QPushButton):
    def __init__(self) -> None:
        ...
        self._dict_input_dialog = DictInputDialog()

        self.clicked.connect(lambda: self._dict_input_dialog.exec())
