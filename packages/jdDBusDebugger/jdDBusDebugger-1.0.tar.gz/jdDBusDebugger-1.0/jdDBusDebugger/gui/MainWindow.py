...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def _get_current_central_widget(self) -> CentralWidget:
    ...
    def _tab_changed(self) -> None:
        if not isinstance(self._get_current_central_widget(), CentralWidget):
            return
    ...
    def _run_saved_macro(self) -> None:
        ...
        for action in macro.actions:
            self._get_current_central_widget().execute_action(action)

    def _update_macro_menu(self) -> None:
        self.run_saved_macro_menu.clear()

        actions = self.macro_manager.get_macros_for_connection(self._get_current_central_widget().connection)
    ...
    def _save_macro_action_clicked(self) -> None:
        ...
        self.macro_manager.save_current_macro(name, self._get_current_central_widget().connection)
