from PyQt6.QtWidgets import QDialog, QWidget, QPushButton, QHBoxLayout, QVBoxLayout
...
class SingleValueInputDialog(QDialog):
    def __init__(self, parent: QWidget | None, dbus_type: "DBusType") -> None:
        ...
        self._input_widget = self._input_handler.generate_widget_for_type(dbus_type)
