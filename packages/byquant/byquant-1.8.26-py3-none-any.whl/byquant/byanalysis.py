...
class Analysis():
    ...
    def show(self):
        ...
        if 'plotly' == self.out or 'o' == self.out:
            ...
            #import pyfolio as pf
            pf.create_full_tear_sheet(self.timereturn, self.positions, self.transactions)
            ...
            qs.reports.full(self.timereturn, benchmark=self.timereturn, mode='full')
    ...
    def returns(self):
        if self.datadict is None:
            #print('Data is None')
            return
        pf.create_returns_tear_sheet(self.timereturn,benchmark_rets=None)
