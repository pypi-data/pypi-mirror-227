...
class Result:
    ...
    def __init__(self, *args: str, color: str | None = None) -> None:
        self.result = args
...
class ResultScreen(Screen):
    ...
    def build(self) -> None:
        ...
        tree.tag_configure("red", background="red", foreground="black")
        tree.tag_configure("green", background="green", foreground="black")
        tree.tag_configure("yellow", background="yellow", foreground="black")
        tree.tag_configure("purple", background="purple", foreground="black")
