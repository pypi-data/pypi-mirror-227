...
class LambdaExecutor:
    ...
    def __upload_files_threaded(
        ...
        with ThreadPoolExecutor(max_workers=MAX_POOL_CONNECTIONS) as executor:
            futures = [executor.submit(
                ...
                all_file[1],
                self.__output_bucket_access_key,
                self.__output_bucket_secret_access_key
            ) for all_file in all_files]
            for future in as_completed(futures):
                all_uploads.extend(future.result())
        return all_uploads
    ...
    def execute(self, input_message):
        ...
        try:
            ...
            self.__s3.download_file(  # TODO: should pass credentials through here
