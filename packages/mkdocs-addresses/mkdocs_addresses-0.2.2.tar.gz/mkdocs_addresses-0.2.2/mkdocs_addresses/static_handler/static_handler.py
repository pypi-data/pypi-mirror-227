        ...
        """ Decorator to add caching logic to plugin methods.
            ...
            3.a. If the call to the decorated method must be done, this call is surrounded with
                 ...
                 can be applied:
                    ...
                    d. Call the "finally after" callback
            3.b. If the method must not be called, the apply_if_not_called callback is called.

            All callbacks are optional, except the filename extractor and the skip ones.
