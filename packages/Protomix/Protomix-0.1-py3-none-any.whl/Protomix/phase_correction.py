...
def phase_correction(spectra_df, type_zopc='rms'):
    """
    ...
    Args:
        ...
        type_zopc (str, optional): Type of optimization. 'rms' for RMS optimization, 'max' for maximum intensity optimization. Default is 'rms'.
    ...
    def optimize_phase_correction(spectra):
        ...
        for i, spectrum in enumerate(spectra_n):
            res = minimize_scalar(rms, args=(spectrum,), bounds=interval, method='brent')
            angles[i] = res.x
