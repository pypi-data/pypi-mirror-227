...
class HostCatalogStatic(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope_id: The scope ID in which the resource is created. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.9/docs/resources/host_catalog_static#scope_id HostCatalogStatic#scope_id}
        :param description: The host catalog description. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.9/docs/resources/host_catalog_static#description HostCatalogStatic#description}
        :param name: The host catalog name. Defaults to the resource name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.9/docs/resources/host_catalog_static#name HostCatalogStatic#name}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
