...
Destination                 destination.local_hostname          :ref:`string`                 Some sources report an internal hostname within a NAT related to the name configured for a compromised system
Destination                 destination.local_ip                :ref:`ipaddress`              Some sources report an internal (NATed) IP address related a compromised system. N.B. RFC1918 IPs are OK here.
