...
class ExponentialSmoothing(_MultiGrainForecastBase):
    ...
    def _extend_single_series_impl(self, tsds_context: TimeSeriesDataSet, series_id: GrainType) -> Any:
        ...
        Contract.assert_type(self._models[series_id], 'self._models[series_id]', holtwinters.HoltWintersResultsWrapper)
        ...
        model_obj: holtwinters.HoltWintersResultsWrapper = self._models[series_id]
