...
def get_portfolios(portfolio_type: Optional[str] = None) -> DataFrame:
    ...
    Returns:
        DataFrame: A DataFrame object with portfolio details. The DataFrame columns include:
...
def save_portfolio(portfolio_name: str, portfolio_type: PortfolioType, holdings: Optional[DataFrame] = None, overwrite_if_exists: bool = False) -> DataFrame:
    """Save or update a portfolio.
          ...
          Returns:
              DataFrame: A DataFrame object with portfolio id and name.
    ...
    :Examples:
        ...
        holdings_data_frame=pd.DataFrame([["FOUSA00DFS;FO","2020-10-31", 33.33],
        ...
        ::
            ...
            from morningstar_data.direct.user_items.portfolio import PortfolioType
            import pandas as pd
            holdings_data_frame=pd.DataFrame([["FOUSA00DFS;FO","2020-05-31", 50],
