...
def get_search_results(search_criteria_id: str) -> DataFrame:
    ...
    Args:
        search_criteria_id (:obj:`str`): The unique identifier of a saved search criteria from Morningstar Direct. The id string is
            numeric. For example, "9009".

    Returns:
        DataFrame: A DataFrame object with the investments that match the search criteria. The DataFrame columns include:
...
def get_search_criterias() -> DataFrame:
    warnings.warn(
        "The get_search_criterias function will be deprecated in the next version, use get_search_criteria instead",
        FutureWarning,
        stacklevel=2,
    )
...
def get_search_criteria() -> DataFrame:
    ...
    Returns:
        DataFrame: A DataFrame object with all search criterias data. The DataFrame columns include:
...
def get_search_criteria_condition(search_criteria_id: str) -> Any:
    warnings.warn(
        "The get_search_criteria_condition function will be deprecated in the next version, use get_search_criteria_conditions instead",
        FutureWarning,
        stacklevel=2,
    )
