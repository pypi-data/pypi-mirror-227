...
from ._exceptions import EAMSTokenDoesNotExistError, MalformedJWTError
...
class _Config:
    def __init__(self) -> None:
        ...
        self.token = uim_jwt
        if self.token == "":
            raise Exception("Please set up UIM_JWT environment variable to access the morningstar_data package")
