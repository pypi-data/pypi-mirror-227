...
class _CustomDatabase(ABC):
    ...
    def save_historical_values(
        ...
        """Saves historical time series values for data points in the user's or firm's database.
        ...
        Args:
            values (:obj:`DataFrame`): A DataFrame object with the time series values to be saved in the user’s or firm’s database. The DataFrame columns should include:
                ...
                * `SecId` - The column containing investment ID values. If a column named “SecId” is not present, the column name specified in the key_column argument will be used.
                * `DataPointName` - The data point name which will be updated. Multiple data points can be updated in one request.
                * `Date` - The column containing date values. If a column named “Date” is not present, the column name specified in the date_column argument will be used.
            ...
            key_column (:obj:`str`): The column name containing the investment ID values. If not specified, the column "SecId" will be used.

            date_column (:obj:`str`): The column name containing the date values. If not specified, the column "Date" will be used.
            blank (:obj:`Blank`): The argument specifying how blank values in the DataFrame should be handled. Valid enum values for this argument are:
        ...
        if not isinstance(blank, Blank):
            warnings.warn(
                "The use of string values for the 'blank' parameter will be deprecated, use Blank enum values instead",
                FutureWarning,
                stacklevel=2,
            )
