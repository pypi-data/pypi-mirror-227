...
UNAUTHORIZED_DATALAKE_REQUEST_ERROR = "A valid license is required to query Morningstar datalake. For more information, please contact the DataLake support team at Morningstar."
