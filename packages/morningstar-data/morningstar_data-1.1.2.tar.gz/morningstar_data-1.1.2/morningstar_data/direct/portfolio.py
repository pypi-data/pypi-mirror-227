...
def get_data_sets() -> DataFrame:
    ...
    Returns:
        DataFrame: A DataFrame object with data set data. The DataFrame columns include:
...
def get_data_set_data_points(data_set_id: str) -> DataFrame:
    ...
    Args:
        data_set_id (:obj:`str`): The unique identifier of a portfolio data set. For example: '1'.

    Returns:
        DataFrame: A DataFrame object with data set data points data. The DataFrame columns include:
    ...
    :Output:
        ...
        data_point_id   name
        ===========   ===============
        AR002		  Annual Ret 2020
        AR003		  Annual Ret 2019
        ...
        ===========   ===============
...
def get(portfolio_type: Optional[str] = None) -> DataFrame:
    warnings.warn(
        "The portfolio.get function will be deprecated in the next version, use user_items.get_portfolios instead",
        FutureWarning,
        stacklevel=2,
    )
...
def get_holdings(
    ...
    Args:
        portfolio_ids (:obj:`list`): A list of portfolio IDs. The maximum number of portfolio IDs that can be passed in is 5.
        date (:obj:`str`, `optional`): The exact portfolio date. When this value is provided, start_date and end_date parameters are ignored.
        start_date (:obj:`str`, `optional`): The start date of the data range.
        end_date (:obj:`str`, `optional`): The end date of the data range.

    Returns:
        DataFrame: A DataFrame object with portfolio holdings data. The DataFrame columns include:
    ...
    ::
        ...
        df = md.direct.portfolio.get_holdings(portfolio_ids=['de21828b-91b7-4fe1-b66e-760fd5e657bc;BM'], date = "2017-09-30")
        df
    ...
    if portfolio_ids:
        ...
        combined_holdings = combined_holdings.append(holdings_df)
...
def get_holding_dates(portfolio_ids: Optional[Union[List[str], str]] = None) -> DataFrame:
    ...
    Args:
        portfolio_ids (:obj:`list`, `optional`): A portfolio ID or a list of portfolio IDs.

    Returns:
        DataFrame: A DataFrame object with all portfolio holdings dates. The DataFrame columns include:
    ...
    ::
        ...
        df = md.direct.portfolio.get_holding_dates(portfolio_ids=['07c317df-a4a7-4297-afc3-0c18bb79a672;UA'])
        df
...
def get_data(
    ...
    Args:
        portfolio_id (:obj:`str` ): A portfolio ID.
        data_set_id (:obj:`str`, `optional`): The unique identifier of a portfolio data set.
            Available data sets can be retrieved using the portfolio data sets function. For example, '1'.
        currency (:obj:`str`, `optional`): The currency of the data point values, when applicable.
        start_date (:obj:`str`, `optional`): The start date of a data range for retrieving data.
            The format is YYYY-MM-DD. For example, '2020-01-01'.
        end_date (:obj:`str`, `optional`): The end date of data range for retrieving data. If no value is provided for end_date, current date will be used.
            The format is YYYY-MM-DD. For example, '2020-01-01'.
        data_point_settings (:obj:`DataFrame`, `optional`): A DataFrame of data points with all defined settings. Each row represents a data point.
            Each column is a configurable setting. Users can get this DataFrame by retrieving a data set or data point settings for a given data point ID(s).
            ...
            is lower than the priority of the currency/start_date/end_date parameters.
...
def get_benchmark_settings(portfolio_id: str) -> DataFrame:
    ...
    Examples:
        Get portfolio settings for custom model portfolio with portfolio ID "d38b96dd-fbe1-4750-b05d-fa7cf4b6e35a".

    ::
        import morningstar_data as md

        df = md.direct.portfolio.get_settings(portfolio_id="d38b96dd-fbe1-4750-b05d-fa7cf4b6e35a;MD")
        df
