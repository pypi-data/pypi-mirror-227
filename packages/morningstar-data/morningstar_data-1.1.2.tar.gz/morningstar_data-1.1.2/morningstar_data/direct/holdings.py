...
def holdings(
    ...
    warnings.warn(
        "The holdings function will be deprecated in the next version, use get_holdings instead",
        FutureWarning,
        stacklevel=2,
    )
...
def get_holdings(
    ...
    Args:
        investment_ids (:obj:`list`): An array of investment codes. The investment code format is secid;universe or just secid.
            For example: ["F00000YOOK;FO","FOUSA00CFV;FO"] or ["F00000YOOK","FOUSA00CFV"].
        date (:obj:`str`, `optional`): The specific date on which to retrieve data. The format is YYYY-MM-DD.
        ...
        start_date (:obj:`str`, `optional`): The beginning date of a data range for retrieving data. The format is
    ...
    Returns:
        DataFrame: A DataFrame object with holdings data. The DataFrame columns include:
...
def holding_dates(investment_ids: List[str]) -> DataFrame:
    warnings.warn(
        "The holding_dates function will be deprecated in the next version, use get_holding_dates instead",
        FutureWarning,
        stacklevel=2,
    )
...
def get_holding_dates(investment_ids: List[str]) -> DataFrame:
    ...
    Returns:
        DataFrame: A DataFrame object with portfolio date data. The DataFrame columns include:
...
def get_lookthrough_holdings(portfolio_id: str) -> DataFrame:
    """
    Returns look-through holdings for a specified user's Direct portfolio
    Args:
        portfolio_id (:obj:`str`): This is a users Direct portfolio id
    Returns:
        DataFrame: A DataFrame object containing fields for each holding. The DataFrame columns include
    ...
    ::
        ...
        df = md.direct.get_lookthrough_holdings(portfolio_id='7b9cb5db-e3da-414e-8f75-b52b02222b5a')
        df
    :Output:
        =============   === =======================     ======================  ================================
        investment_id   ... morningstar_entity_name     primary_performance_id  morningstar_instrument_type_name
        =============   === =======================     ======================  ================================
        E0USA00462      ... CMS Energy Corp             0P000000YM              Equity
        F00000Q5HQ	    ... Keywords Studios PLC        0P0000Z4DP              Equity
        F00000UMZ1      ... Syneos Health Inc           0P00014J84              Equity
        B10002POBD      ... None                        None                    Bond - Asset Backed
        ...
        =============   === ======================      ======================  ================================
