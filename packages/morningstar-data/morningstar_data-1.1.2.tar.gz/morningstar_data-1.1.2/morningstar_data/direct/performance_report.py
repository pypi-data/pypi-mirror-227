...
def get_reports() -> DataFrame:
    ...
    Returns:
        DataFrame: A DataFrame object with all performance reports data. The DataFrame columns include:
...
def get_report(report_id: str) -> DataFrame:
    ...
    Args:
        report_id (:obj:`str`): The unique identifier of a saved performance report from the Performance Reporting
            module in Morningstar Direct. The report_id is string in numeric format. Example: "7782164".

    Returns:
        DataFrame: A DataFrame object with the special performance report data. The DataFrame columns include all columns
        that user set in the special performance report.
    ...
    ::
        ...
        df = md.direct.performance_report.get_report(report_id="2463866")
        df
...
def calculate_report(report_id: str) -> DataFrame:
    ...
    Args:
        report_id (:obj:`str`): The unique identifier of a saved performance report from the Performance Reporting
            module in Morningstar Direct. The id string is numeric. For example, "7782164".

    Returns:
        DataFrame: A DataFrame object with calculated performance report data. The DataFrame columns include:
    ...
    ::
        ...
        df = md.direct.performance_report.calculate_report(report_id="7128568")
        df
...
def get_report_status(report_id: str) -> DataFrame:
    ...
    * Ready
    ...
    Args:
        report_id (:obj:`str`): The unique identifier of a saved performance report from the Performance Reporting module
            in Morningstar Direct. The id string is numeric. For example, "7782164".

    Returns:
        DataFrame: A DataFrame object with the special performance report status data. The DataFrame columns include:
    ...
    ::
        ...
        df = md.direct.performance_report.get_report_status(report_id="2463866")
        df
...
def export_to_excel(report_id: str, file_name: Optional[str] = None) -> str:
    ...
    Args:
        report_id (:obj:`str`): The unique identifier of a saved performance report from the Performance Reporting module
            in Morningstar Direct. The id string is numeric. For example, "2442678".
        file_name (:obj:`str`, `optional`): The performance report excel file name.

    Returns:
        str: The excel file name of the exported performance report.


    Examples:
        Export the performance report with id "2442678".

    ::

        import morningstar_data as md

        resp = md.direct.performance_report.export_to_excel(report_id="2442678")
        resp
