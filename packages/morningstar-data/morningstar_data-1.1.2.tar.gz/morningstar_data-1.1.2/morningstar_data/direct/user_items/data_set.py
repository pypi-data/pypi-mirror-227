...
def get_data_sets() -> DataFrame:
    ...
    Returns:
        DataFrame: A DataFrame object with all user data sets data. The DataFrame columns include:
...
def get_data_set(data_set_id: str) -> DataFrame:
    warnings.warn(
        "The get_data_set function will be deprecated in the next version, use get_data_set_details instead",
        FutureWarning,
        stacklevel=2,
    )
...
def get_data_set_details(data_set_id: str) -> DataFrame:
    ...
    Args:
        data_set_id (:obj:`str`): The unique identifier of a Morningstar data set or user created data set saved
