...
def bip38decrypt(password,encpriv,outputlotsequence=False):
    ...
    if prefix == '0142':
        ...
        # print(prefix, flagbyte, salt.hex(), msg1.hex(), msg2.hex())
...
# print(ic)
# encryptedkey_str, cfrm38_str, address_str = passphrase_to_key(ic)

# encryptedkey_str, cfrm38_str, address_str = passphrase_to_key(
#     "passphraseaB8feaLQDENqCgr4gKZpmf4VoaT6qdjJNJiv7fsKvjqavcJxvuR1hy25aTu5sX", False
# )
# # encryptedkey_str, cfrm38_str, address_str = passphrase_to_key("passphrasepxFy57B9v8HtUsszJYKReoNDV6VHjUSGt8EVJmux9n1J3Ltf1gRxyDGXqnf9qm")
# print(encryptedkey_str, cfrm38_str, address_str)
# print(confirm38code("MOLON LABE", cfrm38_str))
#
# print("\n")

# e = bip38encrypt("TestingOneTwoThree", "A43A940577F4E97F5C4D39EB14FF083A98187C64EA7C99EF7CE460833959A519")
# print(e)
# print(bip38decrypt("TestingOneTwoThree", e))
# print(bip38decrypt("MOLON LABE", encryptedkey_str, True))
print(bip38decrypt("MOLON LABE", "6PgNBNNzDkKdhkT6uJntUXwwzQV8Rr2tZcbkDcuC9DZRsS6AtHts4Ypo1j", True))
# print(bip38decrypt("TestingOneTwoThree", "6PfQu77ygVyJLZjfvMLyhLMQbYnu5uguoJJ4kMCLqWwPEdfpwANVS76gTX", True))
# print(bip38decrypt("TestingOneTwoThree", "6PfQu77ygVyJLZjfvMLyhLMQbYnu5uguoJJ4kMCLqWwPEdfpwANVS76gTX", True))
# print(bip38decrypt("TestingOneTwoThree", "6PYNKZ1EAgYgmQfmNVamxyXVWHzK5s6DGhwP4J5o44cvXdoY7sRzhtpUeo", True))
# print(bip38decrypt("MOLON LABE", "6PgNBNNzDkKdhkT6uJntUXwwzQV8Rr2tZcbkDcuC9DZRsS6AtHts4Ypo1j", True))
# print(bip38decrypt("ΜΟΛΩΝ ΛΑΒΕ", "6PgGWtx25kUg8QWvwuJAgorN6k9FbE25rv5dMRwu5SKMnfpfVe5mar2ngH", True))
