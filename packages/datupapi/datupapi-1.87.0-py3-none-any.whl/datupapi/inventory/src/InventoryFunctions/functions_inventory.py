...
class FunctionsInventory(InventoryFormat):
    """
        ...
        >>> df_inv = FunctionsInventory(df_inv,committed=True, min_inv=False, div_purfac=False, ref_secstock=False, exhivitions=False).functions_inventory()
    """

    def __init__(self, df_inv, committed, min_inv, ref_secstock, exhivitions) -> None:      
        self.df_inv = df_inv
        self.committed = committed
        self.min_inv = min_inv        
        self.ref_secstock = ref_secstock
        self.exhivitions = exhivitions
    ...
    def purchase_factor(self,df):
        ...
        df['MinReorderQtyBase'] = df['MinReorderQty']
        df['MaxReorderQtyBase'] = df['MaxReorderQty']        
