...
class Logger:
    ...
    def info(self, message: str, module: Optional[str], function: Optional[str], class_name: Optional[str]) -> None:
        """
        ...
        """
        ...
    def debug(self, message: str, module: Optional[str], function: Optional[str], class_name: Optional[str]) -> None:
        """
    ...
    def warning(self, message: str, module: Optional[str], function: Optional[str], class_name: Optional[str]) -> None:
        """
    ...
    def error(self, message: str, module: Optional[str], function: Optional[str], class_name: Optional[str]) -> None:
        """
