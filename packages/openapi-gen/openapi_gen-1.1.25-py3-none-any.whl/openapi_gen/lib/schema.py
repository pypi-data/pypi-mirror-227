...
class SwaggerDefinition:
    ...
    def _create_endpoint_definition(
        ...
        for method in endpoint.methods:
            ...
            if metadata is None:
                # //seems to be a flask issue...  for some reason a set of endopints is called 'inner' instead of the endpoint name
                metadata = get_endpoint_metadata(view_function_name = 'inner')
