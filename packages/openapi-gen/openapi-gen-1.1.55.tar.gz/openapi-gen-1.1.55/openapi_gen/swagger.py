...
from openapi_gen.lib.dependency import DependencyProvider
from openapi_gen.lib.endpoint import SwaggerEndpoint
from openapi_gen.lib.schema import SwaggerDefinition
...
class Swagger:
    ...
    * Route segments as parameters
    ...
    def _bind_schema_endpoint(self, definitions: dict) -> None:
        ...
        def get_schemaV2():
            # convert to openapi 2.0.  Add an option to choose someday
            #if we already ran conversion, just return converted data
            ...
            subprocess.run(["npm", "install", "--save", "api-spec-converter"])
            byteOutput = subprocess.check_output(["npx", "api-spec-converter", "-f", "openapi_3", "-t", "swagger_2", "data.json", ">", "swagger.json"])
        ...
        self._app.add_url_rule(
            ...
            view_func=get_schemaV3,
            methods=['GET'])
        
        self._app.add_url_rule(
            rule='/swagger/v1/swagger.json?v=2',
            view_func=get_schemaV2,
            methods=['GET'])
