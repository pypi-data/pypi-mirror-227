...
def chunk_embedder(worker_id, chunk_queue, embeddings_model_uri, connection_args, embeddings_container, output, logger_queue):
    ...
    with mp.Manager() as manager:
        try:
            ...
            with mp.Pool(processes=num_workers) as pool:
                ...
                embedder_futures = [pool.apply_async(chunk_embedder, (i, chunk_queue, embeddings_model_uri, connection_args, embeddings_container, output, logger_queue)) for i in range(num_workers)]
