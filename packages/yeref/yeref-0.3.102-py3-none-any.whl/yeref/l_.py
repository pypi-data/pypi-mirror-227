...
l_pstmedia = {
    'ru': "👩🏽‍💻 <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> режим просмотра поста: <i>превью-предпросмотр</i>/<i>спойлер-скрытый</i>/<i>галерея</i>/<i>формат</i>\n\n[✅ превью]-режим помещает медиа-контент <i>(jpg/gif/mp4 до 5 Мб)</i> под текстом\n[✅ формат]-режим применяет случайные стили к посту",
    'en': "👋🏽 <b>Press</b> ✅/☑️ to <b>turn on/off</b> auto-reply to text messages using neural network",
    'es': "👋🏽 <b>Presione</b> ✅/☑️ para <b>activar/desactivar</b> la respuesta automática a los mensajes de texto usando la red neuronal",
    'fr': "👋🏽 <b>Appuyez sur</b> ✅/☑️ pour <b>activer/désactiver</b> la réponse automatique aux messages texte à l'aide du réseau neuronal",
    'zh': "👋🏽<b>按</b>✅/☑️ 使用神经网络<b>打开/关闭</b>自动回复短信",
...
l_videochat_handler = {
    'ru': "🎥 Авто-анонс <b>видео-подкаста</b> [/videochat d h] каждый <u>d</u>-день (1-31) на <u>h</u>-часов (1-168). Текущее значение: /videochat {0}\n\n👩🏽‍💻 Например,\n/videochat 1 1 (ежедневный видео-анонс длительностью 1 час)\n/videochat 0 (отключение опции)\n\n⚙️ <b>Команды</b> /cmd",
...
l_add_account_text = {
    'ru': "👇🏽 Жми на ‹➕ Добавить аккаунт›, чтобы добавить дополнительный аккаунт для автоматизации в @{0}\n\n👮🏽‍♀️ Для привязки аккаунта необходимо использовать <b>код</b> подтверждения, который придет вам с верифицированного <i>Telegram</i>-аккаунта",
...
# region function
l_rent_account_handler = {
    'ru': "📲︎ <b>Аренда</b> аккаунта включает в себя стандартную подписку и все платные возможности\n\n👉🏼 Жми [💳 Аренда], чтобы получить уже прогретый аккаунт",
    'en': "📲︎ <b>Account rent</b> include all opportunities\n\n👉🏼 Push the [💳 Account rent], чтобы получить уже прогретый аккаунт",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
}
l_newaccount_handler = {
    'ru': "📲︎ <b>Создай</b>/<code>используй дополнительный</code> <i>Telegram</i>-аккаунт через <b>мобильное</b> приложение, а затем пришли его <u>номер</u> телефона℡\n\n👉🏼 Например, <code>79331114545</code>",
    'en': "📲︎ <b>Create</b>/<code>user extra</code> <i>Telegram</i>-account via <b>mobile</b> app, and then send its phone <u>number</u>℡\n\n👉🏼 For example, <code>79331114545</code>",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_fsm_newaccount = {
    'ru': "📲 Пришли корректный номер телефона℡\n\n👉🏼 Например, <code>79331114545</code>",
...
l_fsm_auth = {
    'ru': "📲 Введи <b>Код-авторизации</b> , присланный в <u>дополнительный</u> аккаунт от <i>верифицированного</i> <b>Telegram</b>-аккаунта\n\n👉🏼 Например, как на рисунке <code>YVTdd9r7brb</code>",
...
l_fsm_auth_fail = {
    'ru': "📲 Попытка авторизации на https://my.telegram.org/auth не удалась! Попробуйте еще раз позже!",
...
l_fsm_auth_cloud = {
    'ru': "📲 Придумай <i>облачный пароль</i> для защиты аккаунта или отправь <b>текущий</b>, чтобы начать <u>запуcк</u> аккаунта\n\n👉🏼 Например, <code>ferey2</code>\n(жми, чтобы скопировать)",
...
l_selenium_time = {
    'ru': "📲 Время ожидания прошло! Попробуйте еще раз позже!",
...
l_fsm_auth_code = {
    'ru': "📲 Теперь введи <b>Код-подтверждения</b> для <u>запуска</u> аккаунта, также присланный от <b>Telegram</b>\n\n👉🏼 Например, как на рисунке <code>20777</code>",
...
l_fsm_cloud_current = {
    'ru': "📲 Укажите текущий облачный пароль",
...
l_fsm_auth_error = {
    'ru': "📲︎ Ошибка Telegram, попробуй еще раз! <b>Создай</b>/<code>используй дополнительный</code> <i>Telegram</i>-аккаунт через <b>мобильное</b> приложение, а затем пришли его <u>номер</u> телефона℡\n\n👉🏼 Например, <code>79331114545</code>",
    'en': "📲︎ Telegram error, try again later! <b>Create</b>/<code>use extra</code> <i>Telegram</i>-account via <b>mobile</b> app and then send its <u>phone</u>℡\n\n👉🏼 For example, <code>79331114545</code>",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_fsm_code_error = {
    'ru': "📲 Пришли корректный числовой код",
...
l_fsm_code_ban = {
    'ru': "📲 Telegram забанил аккаунт на отправку кода\n\n#длительность {0}",
...
l_account_res_parse_csend_correct = {
...
l_account_res_parse_csend_done = {
...
l_account_res_init = {
    'ru': "👩🏽‍💻 Созданы <b>служебные</b> Telegram бот и канал:\n\n@{0}, @{1}\n\n👩🏽‍💻 Для корректной работы не изменяйте их @username",
...
l_account_res_scheduler_client = {
...
l_csend_text = {
    'ru': "📨️ Жми на ✅/☑️ чтобы <b>Вкл/Выкл</b> авто-рассылку нескольким пользователям выбранного поста\n\n👩🏽‍💻 <b>Текущие</b> настройки авто-рассылки: {0}",
...
# region cservice_
l_cservice_text = {
    'ru': "👀 Жми на ✅/☑️ чтобы <b>Вкл/Выкл</b> <i>сервисные <b>статусы</b>/<b>пересылку</b> входящих себе (в том числе оригинальных/<u>удаленных</u> сообщений)/отметку о <b>прочтении</b> входящих</i>\n\n👉🏼 Например, [{0}] означает <code>показ</code> у пользователей <b>статусов</b>: <i>печатает..ищет стикер..</i>",
...
# region creaction_
l_creaction_text = {
    'ru': "👍🏽 Жми на ✅/☑️ чтобы <b>Вкл/Выкл</b> авто-реакцию на <i><b>emoji</b> внутри сообщения/<b>медиа</b>-контент</i>/<b>ответную</b> реакцию",
...
# region ctranslate_
l_ctranslate2_text = {
    'ru': "文 Жми на ✅/☑️ чтобы <b>Вкл/Выкл</b> авто-перевод для <i><b>входящих</b>/<b>исходящих</b> сообщений</i>",
...
# region ctranscribe_
l_ctranscribe_text = {
    'ru': "🗣 Жми на ✅/☑️ чтобы <b>Вкл/Выкл</b> авто-транскрибацию (перевод голоса в текст) для <i><b>входящих</b>/<b>исходящих</b> сообщений</i>",
