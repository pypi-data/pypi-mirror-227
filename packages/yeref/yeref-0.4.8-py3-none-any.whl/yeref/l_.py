...
l_new_userbot_api = {
    'ru': "👩🏽‍💻 <b>2/5. Зарегистрируй</b> свой <u>дополнительный</u> аккаунт на официальном сайта Telegram-приложений: https://my.telegram.org/auth и пришли <a href='https://my.telegram.org/apps'>App api_id</a> и <a href='https://my.telegram.org/apps'>App api_hash</a> (придумай App title и Short name (5 цифр))\n\n👩🏽‍💻 <b>Например:</b> 12252577 2bbd552cc55dd5ccc2eccd22d555ab2d",
    'en': "👩🏽‍💻 <b>Create</b>/<code>user extra</code> <i>Telegram</i>-account via <b>mobile</b> app, and then send its phone <u>number</u>℡\n\n👉🏼 For example, <code>79331114545</code>",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
