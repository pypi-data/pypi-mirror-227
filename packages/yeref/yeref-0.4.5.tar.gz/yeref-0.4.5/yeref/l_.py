...
l_new_userbot_start = {
    'ru': "👩🏽‍💻 <b>Зарегистрируй</b> свой <u>дополнительный</u> аккаунт на официальном сайта Telegram-приложений: https://my.telegram.org/auth и пришли <a href='https://my.telegram.org/apps'>App api_id</a> и <a href='https://my.telegram.org/apps'>App api_hash</a> (придумай App title и Short name (5 цифр))\n\n👩🏽‍💻 <b>Например:</b> 12252577 2bbd552cc55dd5ccc2eccd22d555ab2d",
...
l_new_userbot_handler = {
    'ru': "👩🏽‍💻 <b>Создай</b>/<code>используй дополнительный</code> <i>Telegram</i>-аккаунт через <b>мобильное</b> приложение, а затем пришли его <u>номер</u> телефона℡\n\n👉🏼 Например, <code>79331114545</code>",
    'en': "👩🏽‍💻 <b>Create</b>/<code>user extra</code> <i>Telegram</i>-account via <b>mobile</b> app, and then send its phone <u>number</u>℡\n\n👉🏼 For example, <code>79331114545</code>",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
...
l_fsm_auth_error = {
    'ru': "👩🏽‍💻 Ошибка Telegram, попробуй еще раз! <b>Создай</b>/<code>используй дополнительный</code> <i>Telegram</i>-аккаунт через <b>мобильное</b> приложение, а затем пришли его <u>номер</u> телефона℡\n\n👉🏼 Например, <code>79331114545</code>",
