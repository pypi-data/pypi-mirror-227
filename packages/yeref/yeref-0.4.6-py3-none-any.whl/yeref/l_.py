...
l_new_userbot_start = {
    'ru': "👩🏽‍💻 <b>1/4. Создай</b>/<code>используй дополнительный</code> <i>Telegram</i>-аккаунт через <b>мобильное</b> приложение, а затем пришли его <u>номер</u> телефона℡\n\n👉🏼 Например, <code>34663072680</code>",
...
l_new_userbot_api = {
    'ru': "👩🏽‍💻 <b>2/4. Зарегистрируй</b> свой <u>дополнительный</u> аккаунт на официальном сайта Telegram-приложений: https://my.telegram.org/auth и пришли <a href='https://my.telegram.org/apps'>App api_id</a> и <a href='https://my.telegram.org/apps'>App api_hash</a> (придумай App title и Short name (5 цифр))\n\n👩🏽‍💻 <b>Например:</b> 12252577 2bbd552cc55dd5ccc2eccd22d555ab2d",
    'en': "👩🏽‍💻 <b>Create</b>/<code>user extra</code> <i>Telegram</i>-account via <b>mobile</b> app, and then send its phone <u>number</u>℡\n\n👉🏼 For example, <code>79331114545</code>",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
...
l_fsm_auth = {
    'ru': "👩🏽‍💻 <b>3/4. Введи</b> Код-авторизации, присланный в <u>дополнительный</u> аккаунт от <i>верифицированного</i> <b>Telegram</b>-аккаунта\n\n👉🏼 Например, как на рисунке <code>YVTdd9r7brb</code>",
...
l_fsm_auth_cloud = {
    'ru': "👩🏽‍💻 <b>4/4. Придумай<b> <i>облачный пароль</i> для защиты аккаунта или отправь <b>текущий</b>, чтобы начать <u>запуcк</u> аккаунта\n\n👉🏼 Например, <code>ferey2</code>\n(жми, чтобы скопировать)",
...
l_fsm_auth_code = {
    'ru': "👩🏽‍💻 <b>5/5. Введи</b> код-подтверждения для <u>запуска</u> аккаунта, также присланный от <b>Telegram</b>\n\n👉🏼 Например, как на рисунке <code>20777</code>",
