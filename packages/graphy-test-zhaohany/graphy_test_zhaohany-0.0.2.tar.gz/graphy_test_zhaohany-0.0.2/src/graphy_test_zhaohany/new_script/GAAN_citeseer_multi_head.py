...
if __name__ == "__main__":
    ...
    file_dir = "/home/ygong07/data/test2/citeseer/"
    ifile = file_dir + "graph_structure/"
    feature = pubmed_util.read_feature_info(file_dir + "feature/citeseer_feature.txt")
    train_id = pubmed_util.read_index_info(file_dir + "index/citeseer_train_index.txt")
    test_id = pubmed_util.read_index_info(file_dir + "index/citeseer_test_index.txt")
    test_y_label =  pubmed_util.read_label_info(file_dir + "label/citeseer_test_y_label.txt")
    train_y_label =  pubmed_util.read_label_info(file_dir + "label/citeseer_y_label.txt")
    ...
    net = gaan.GatedGAT(input_feature_dim, 6, map_feats, num_heads, device)
    net.to(device)
    ...
    print("the time of graphpy for GAT3 citeseer is:", difference)
    # check the accuracy for test data
