...
if __name__ == "__main__":
    ...
    net = gnn.GAT(graph, num_layers, input_feature_dim, args.dim, args.category, device,
    ...
    print("the time of graphpy is:", difference.total_seconds(), overhead)
