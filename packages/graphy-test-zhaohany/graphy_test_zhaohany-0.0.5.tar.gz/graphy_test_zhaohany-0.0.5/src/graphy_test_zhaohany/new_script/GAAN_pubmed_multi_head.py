...
if __name__ == "__main__":
    ...
    file_dir = "/home/ygong07/data/test2/pubmed/"
    ...
    train_y_label =  pubmed_util.read_label_info(file_dir + "label/y_label.txt")
    ...
    net = gaan.GatedGAT(input_feature_dim, 3, map_feats, num_heads, device)
    net.to(device)
