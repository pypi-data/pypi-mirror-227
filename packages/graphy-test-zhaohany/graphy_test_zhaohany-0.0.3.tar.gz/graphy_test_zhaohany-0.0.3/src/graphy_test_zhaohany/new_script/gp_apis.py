...
def gp_edge_softmax_forward(g, X, dim0, dim1, inverse, use_cuda):
    ...
    gpk.edge_softmax_forward(g, X_dl, res_dl, inverse)
    return res

def gp_edge_softmax_backward(g, X, Y, dim0, dim1, inverse, use_cuda):
    ...
    gpk.edge_softmax_backward(g, X_dl, Y_dl, res_dl, inverse)
    return res
