...
if __name__ == "__main__":
    ...
    file_dir = "/home/ygong07/data/test2/cora/"
    ifile = file_dir + "graph_structure/"

    feature = pubmed_util.read_feature_info(file_dir + "feature/cora_feature.txt")
    train_id = pubmed_util.read_index_info(file_dir + "index/cora_train_index.txt")
    test_id = pubmed_util.read_index_info(file_dir + "index/cora_test_index.txt")
    test_y_label =  pubmed_util.read_label_info(file_dir + "label/cora_test_y_label.txt")
    train_y_label =  pubmed_util.read_label_info(file_dir + "label/cora_y_label.txt")
    ...
    net = gaan.GatedGAT(input_feature_dim, 7, map_feats, num_heads, device)
    net.to(device)
