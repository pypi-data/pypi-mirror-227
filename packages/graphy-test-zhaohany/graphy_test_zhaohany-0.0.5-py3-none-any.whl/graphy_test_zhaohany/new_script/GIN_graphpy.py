...
if __name__ == "__main__":
    ...
    if args.graph == 'text':
        ...
        graph = kernel.load_graph_noeid(ofile);
    ...
    net = gnn.GIN(graph, input_feature_dim, args.dim, args.category, device)
    net.to(device)
    ...
    print('GIN Epoch %d | Test_accuracy: %.4f' % (epoch, acc_val))
