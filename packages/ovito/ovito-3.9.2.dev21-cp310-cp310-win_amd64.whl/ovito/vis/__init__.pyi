...
overlay can invoke to draw graphics on top of a 3d viewport."""
        ...
        def draw_text(self, text: str, pos: Tuple[float, float], font_size: float=0.05, anchor: Literal['center', 'north west', 'west', 'south west', 'south', 'south east', 'east', 'north east', 'north']='south west', color: Color=(0.0, 0.0, 0.0), alpha: float=1.0, outline_color: Color=(1.0, 1.0, 1.0), outline_width: float=0.0, tight_layout: bool=False, rotation: float=0.0) -> None:
            """Docs..."""
            ...
