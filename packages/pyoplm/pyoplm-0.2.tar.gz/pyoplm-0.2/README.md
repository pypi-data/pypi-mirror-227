# Pyoplm - Python OPL-Manager
This Repository containes the code for pyoplm. pyoplm is a simple Python implementation
...
```bash
git clone https://github.com/edisnord/pyoplm.git;
cd pyoplm;
