from uniTbrow.units.units import metre, second, newton, kelvin, joule, mole, ampere, kilogram, hertz, coulomb
...
G = Constant(6.6743015*10**-11 * metre**3 * (kilogram)**-1 * second**-2, "G")
...
m_e = Constant(9.109383701528*10**-31 * kilogram, "m_e")
"""Electron mass"""

m_p = Constant(1.6726219236951*10**-27 * kilogram, "m_p")
"""Proton mass"""

m_n = Constant(1.6749274980495*10**-27 * kilogram, "m_n")
"""Neutron mass"""
