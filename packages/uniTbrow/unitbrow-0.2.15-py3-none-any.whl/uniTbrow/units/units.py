...
class Unit:
    ...
    def generate_metric_prefixes(self):
        ...
        for abbr, alts, factor in _metric_prefixes:
            ...
            if new_unit.symbol.name != "kg": # kg is a special case that needs to be handled separately.
...
# Astronomical Units
mass_earth = Unit(dimensions.mass, "M_⊕", ["M_E", "earth_mass", "M_{E}", "earths"], metric=False, base=(5.9722 * 10 ** 24 * kilogram.symbol))
...
electrical_horsepower = Unit(dimensions.power, "hp_E", ["electrical_horsepower"], metric=False, base=(746 * watt.base))
...
_units = [
    ...
    # Astronomical Units
    mass_earth, mass_sun, parsec, astronomical_unit, lightyear, solar_luminosity,
    ...
    # Additional power units
    metric_horsepower, mechanical_horsepower, electrical_horsepower, boiler_horsepower,
