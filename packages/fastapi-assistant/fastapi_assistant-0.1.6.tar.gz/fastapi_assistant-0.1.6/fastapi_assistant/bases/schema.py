...
class ListArgsSchema(BaseModel):
    ...
    filters: List[ListFilterSchema] = Field(default=None, description='过滤条件')
    orders: List[ListOrderSchema] = Field(default=None, description='排序条件')  # 排序条件
    keys: List[ListKeySchema] = Field(default=None, description='重定义字段')
