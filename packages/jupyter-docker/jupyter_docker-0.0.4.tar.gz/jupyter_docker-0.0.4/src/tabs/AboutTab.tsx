...
const AboutTab = (props: Props): JSX.Element => {
  ...
  return (
    <>
      <Pagehead as="h3">Jupyter Docker<Label sx={{marginLeft: 1}}>{version}</Label></Pagehead>
      <Box>
        <Text>🪐 🐳 Manage Docker from Jupyter.</Text>
      </Box>
      <Box mt={3}>
        {!pirate ?
      ...
      <Box>
        <Link href="https://github.com/datalayer/jupyter-docker" target="_blank">
