...
def describe_env_variables(args):
    print('GOOGLEDRIVE: ', os.environ['GOOGLEDRIVE'])
    print('SHAREDRIVE: ', os.environ['SHAREDRIVE'])
    print('ONEDRIVE: ', os.environ['ONEDRIVE'])
    print('GOOGLEROOT: ', os.environ['GOOGLEROOT'])
...
def main():
    ...
    sync_drive_parser = subparsers.add_parser(
        'show', help='Print environment variables.')
