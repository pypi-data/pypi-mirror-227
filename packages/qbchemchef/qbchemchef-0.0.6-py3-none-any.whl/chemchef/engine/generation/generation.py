...
class OpenAIDocumentGenerator(AbstractDocumentGenerator):
    ...
    def _parse_response(response: AssistantMessage, subject: str) -> Optional[str]:
        ...
        if document is not None:
            logging.info("Generated document on subject %s: %s", subject, document)
        else:
            logging.info("Failed to generate document on subject %s - subject deemed incompatible with format.")
