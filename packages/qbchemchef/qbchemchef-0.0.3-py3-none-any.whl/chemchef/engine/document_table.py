...
class DocumentTable:
    ...
    def __init__(self,
        ...
        self._documents: dict[int, StoredDocument] = dict()  # {document id: document}
    ...
    def insert(self, document: str) -> StoredDocument:
        """
        ...
        stored_doc = StoredDocument(document_id=document_id, original_text=document, parsed_data=parsed_doc)
    ...
    def auto_insert(self, subject: str) -> Optional[StoredDocument]:
        """
        ...
        if len(ids_of_existing_documents_for_subject) == 0:
            ...
            if generated_document is not None:  # succeeded
                return self.insert(generated_document)
    ...
    def query(self, query_expression: AbstractQueryExpression) -> list[StoredDocument]:
        """
