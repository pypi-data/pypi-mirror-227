...
@pytest.mark.asyncio
@vcr.use_cassette
async def test_git_list_repos(authed_client: SrhtClient):
...
@pytest.mark.asyncio
@vcr.use_cassette
async def test_git_create_repo(authed_client: SrhtClient):
    async with authed_client:
        client = git.GitSrhtClient(authed_client)
...
@pytest.mark.asyncio
@vcr.use_cassette
async def test_git_upload(authed_client: SrhtClient):
    async with authed_client:
        client = git.GitSrhtClient(authed_client)
