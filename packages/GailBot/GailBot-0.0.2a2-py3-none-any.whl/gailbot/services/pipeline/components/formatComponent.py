...
class FormatComponent(Component):
    def __call__(self, dependency_outputs: Dict[str, Any]) -> ComponentState:
        """
        ...
        try:
            ...
            for payload in payloads:
                ...
                payload.save()  # Move payload.save() before payload.failed check to save whatever data available even if something has failed
