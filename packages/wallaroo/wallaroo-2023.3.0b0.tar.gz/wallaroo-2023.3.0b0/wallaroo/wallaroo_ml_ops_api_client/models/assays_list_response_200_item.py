...
if TYPE_CHECKING:
  ...
  from ..models.assays_list_response_200_item_baseline_type_3 import \
      AssaysListResponse200ItemBaselineType3
...
class AssaysListResponse200Item:
    """  Assay definition.
        ...
        Attributes:
            ...
            baseline (Union['AssaysListResponse200ItemBaselineType0', 'AssaysListResponse200ItemBaselineType1',
                'AssaysListResponse200ItemBaselineType2', 'AssaysListResponse200ItemBaselineType3', None, Unset]):  Options
                describing the range of inference data used as a baseline by the assay
    ...
    baseline: Union['AssaysListResponse200ItemBaselineType0', 'AssaysListResponse200ItemBaselineType1', 'AssaysListResponse200ItemBaselineType2', 'AssaysListResponse200ItemBaselineType3', None, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.baseline, AssaysListResponse200ItemBaselineType2):
            baseline = UNSET
            if not isinstance(self.baseline, Unset):
                baseline = self.baseline.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_baseline(data: object) -> Union['AssaysListResponse200ItemBaselineType0', 'AssaysListResponse200ItemBaselineType1', 'AssaysListResponse200ItemBaselineType2', 'AssaysListResponse200ItemBaselineType3', None, Unset]:
            if data is None:
                return data
            ...
            if not isinstance(data, dict):
                raise TypeError()
            _baseline_type_3 = data
            baseline_type_3: Union[Unset, AssaysListResponse200ItemBaselineType3]
            if isinstance(_baseline_type_3,  Unset):
                baseline_type_3 = UNSET
            else:
                baseline_type_3 = AssaysListResponse200ItemBaselineType3.from_dict(_baseline_type_3)
