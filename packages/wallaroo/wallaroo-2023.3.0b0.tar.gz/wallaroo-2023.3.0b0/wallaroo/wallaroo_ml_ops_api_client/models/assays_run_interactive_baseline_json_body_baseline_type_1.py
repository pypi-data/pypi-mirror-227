...
if TYPE_CHECKING:
  from ..models.assays_run_interactive_baseline_json_body_baseline_type_1_user_provided import \
      AssaysRunInteractiveBaselineJsonBodyBaselineType1UserProvided
...
class AssaysRunInteractiveBaselineJsonBodyBaselineType1:
    """ 
        Attributes:
            user_provided (AssaysRunInteractiveBaselineJsonBodyBaselineType1UserProvided):
     """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.assays_run_interactive_baseline_json_body_baseline_type_1_user_provided import \
            AssaysRunInteractiveBaselineJsonBodyBaselineType1UserProvided
        d = src_dict.copy()
        user_provided = AssaysRunInteractiveBaselineJsonBodyBaselineType1UserProvided.from_dict(d.pop("UserProvided"))
