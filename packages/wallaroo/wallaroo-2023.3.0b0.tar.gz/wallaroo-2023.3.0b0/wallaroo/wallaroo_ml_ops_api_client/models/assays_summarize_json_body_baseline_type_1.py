...
if TYPE_CHECKING:
  from ..models.assays_summarize_json_body_baseline_type_1_user_provided import \
      AssaysSummarizeJsonBodyBaselineType1UserProvided
...
class AssaysSummarizeJsonBodyBaselineType1:
    """ 
        Attributes:
            user_provided (AssaysSummarizeJsonBodyBaselineType1UserProvided):
     """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.assays_summarize_json_body_baseline_type_1_user_provided import \
            AssaysSummarizeJsonBodyBaselineType1UserProvided
        d = src_dict.copy()
        user_provided = AssaysSummarizeJsonBodyBaselineType1UserProvided.from_dict(d.pop("UserProvided"))
