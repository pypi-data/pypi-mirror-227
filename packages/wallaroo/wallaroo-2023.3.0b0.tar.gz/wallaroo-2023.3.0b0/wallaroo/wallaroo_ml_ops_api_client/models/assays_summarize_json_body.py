...
if TYPE_CHECKING:
  ...
  from ..models.assays_summarize_json_body_baseline_type_3 import \
      AssaysSummarizeJsonBodyBaselineType3
...
class AssaysSummarizeJsonBody:
    """ 
        Attributes:
            ...
            baseline (Union['AssaysSummarizeJsonBodyBaselineType0', 'AssaysSummarizeJsonBodyBaselineType1',
                'AssaysSummarizeJsonBodyBaselineType2', 'AssaysSummarizeJsonBodyBaselineType3']):
     """

    summarizer: Union['AssaysSummarizeJsonBodySummarizerType0', 'AssaysSummarizeJsonBodySummarizerType1']
    baseline: Union['AssaysSummarizeJsonBodyBaselineType0', 'AssaysSummarizeJsonBodyBaselineType1', 'AssaysSummarizeJsonBodyBaselineType2', 'AssaysSummarizeJsonBodyBaselineType3']
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.baseline, AssaysSummarizeJsonBodyBaselineType2):
            baseline = self.baseline.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_baseline(data: object) -> Union['AssaysSummarizeJsonBodyBaselineType0', 'AssaysSummarizeJsonBodyBaselineType1', 'AssaysSummarizeJsonBodyBaselineType2', 'AssaysSummarizeJsonBodyBaselineType3']:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
            ...
            if not isinstance(data, dict):
                raise TypeError()
            baseline_type_3 = AssaysSummarizeJsonBodyBaselineType3.from_dict(data)
