...
if TYPE_CHECKING:
  ...
  from ..models.assays_run_interactive_json_body_baseline_type_3 import \
      AssaysRunInteractiveJsonBodyBaselineType3
...
class AssaysRunInteractiveJsonBody:
    """  Request to run an assay interactively.
        ...
        Attributes:
            ...
            baseline (Union['AssaysRunInteractiveJsonBodyBaselineType0', 'AssaysRunInteractiveJsonBodyBaselineType1',
                'AssaysRunInteractiveJsonBodyBaselineType2', 'AssaysRunInteractiveJsonBodyBaselineType3']):
    ...
    status: str
    iopath: str
    baseline: Union['AssaysRunInteractiveJsonBodyBaselineType0', 'AssaysRunInteractiveJsonBodyBaselineType1', 'AssaysRunInteractiveJsonBodyBaselineType2', 'AssaysRunInteractiveJsonBodyBaselineType3']
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.baseline, AssaysRunInteractiveJsonBodyBaselineType2):
            baseline = self.baseline.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_baseline(data: object) -> Union['AssaysRunInteractiveJsonBodyBaselineType0', 'AssaysRunInteractiveJsonBodyBaselineType1', 'AssaysRunInteractiveJsonBodyBaselineType2', 'AssaysRunInteractiveJsonBodyBaselineType3']:
            try:
            ...
            if not isinstance(data, dict):
                raise TypeError()
            baseline_type_3 = AssaysRunInteractiveJsonBodyBaselineType3.from_dict(data)
