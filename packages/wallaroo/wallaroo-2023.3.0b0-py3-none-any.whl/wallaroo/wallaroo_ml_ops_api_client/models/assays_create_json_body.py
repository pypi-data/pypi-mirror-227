...
if TYPE_CHECKING:
  ...
  from ..models.assays_create_json_body_baseline_type_3 import \
      AssaysCreateJsonBodyBaselineType3
...
class AssaysCreateJsonBody:
    """  Request to create an assay.
        ...
        Attributes:
            ...
            baseline (Union['AssaysCreateJsonBodyBaselineType0', 'AssaysCreateJsonBodyBaselineType1',
                'AssaysCreateJsonBodyBaselineType2', 'AssaysCreateJsonBodyBaselineType3']):
    ...
    status: str
    iopath: str
    baseline: Union['AssaysCreateJsonBodyBaselineType0', 'AssaysCreateJsonBodyBaselineType1', 'AssaysCreateJsonBodyBaselineType2', 'AssaysCreateJsonBodyBaselineType3']
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.baseline, AssaysCreateJsonBodyBaselineType2):
            baseline = self.baseline.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_baseline(data: object) -> Union['AssaysCreateJsonBodyBaselineType0', 'AssaysCreateJsonBodyBaselineType1', 'AssaysCreateJsonBodyBaselineType2', 'AssaysCreateJsonBodyBaselineType3']:
            try:
            ...
            if not isinstance(data, dict):
                raise TypeError()
            baseline_type_3 = AssaysCreateJsonBodyBaselineType3.from_dict(data)
