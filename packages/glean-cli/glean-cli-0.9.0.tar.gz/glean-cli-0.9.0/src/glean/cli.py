...
from glean.api.analytics.cli_with_tracking import CommandWithTracking, GroupWithTracking
...
def main():
    ...
    # full_command = " ".join([root_command, *rest])
    # print('fullcommand = ' + full_command)
...
def cli(ctx: click.Context, credentials_filepath: str):
    ...
    ctx.obj[
        "raw_command"
    ] = raw_command  # Used in `cli_with_tracking.py` for analytics.
