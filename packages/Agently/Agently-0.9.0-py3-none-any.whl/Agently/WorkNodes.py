...
class WorkNodeManagement(object):
    ...
    def register(self):
        ...
        if self.work_nodes.get_work_node(self.work_node_name) != None:
    ...
    def update(self):
        work_node = self.work_nodes.get_work_node(self.work_node_name)
...
class WorkNodes(object):
    ...
    def set_work_node(self, work_node_name, work_node):
        self.runtime_ctx.set(work_node_name, work_node, domain = "work_nodes")
        return

    def update_work_node(self, work_node_name, update_work_node_dict):
        self.runtime_ctx.update(work_node_name, update_work_node_dict, domain = "work_nodes")
        return

    def get_work_node(self, work_node_name):
