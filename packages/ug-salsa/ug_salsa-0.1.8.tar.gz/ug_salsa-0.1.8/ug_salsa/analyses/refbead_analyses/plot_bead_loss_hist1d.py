...
class PlotBeadLossHist1D(RefBeadAnalysis):
    ...
    def plot_data(self):
        ...
        df = pd.DataFrame(data, columns = ["tileID",'radius','theta','% lost','log % lost'])
        fig = new_plt.WaferPlot(df, r="radius", theta="theta", color="log % lost",
