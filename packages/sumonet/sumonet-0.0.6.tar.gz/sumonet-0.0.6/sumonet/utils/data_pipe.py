...
class Data:
        ...
        def get_train_data_path():
                ...
                posTrainDataPath = "../data/train/Sumoylation_pos_Train.fasta" 
                negTrainDataPath = "../data/train/Sumoylation_neg_Train.fasta"
        ...
        def get_test_data_path():
                ...
                posTestDataPath = "../data/train/Sumoylation_pos_Test.fasta" 
                negTestDataPath = "../data/train/Sumoylation_neg_Test.fasta" 
