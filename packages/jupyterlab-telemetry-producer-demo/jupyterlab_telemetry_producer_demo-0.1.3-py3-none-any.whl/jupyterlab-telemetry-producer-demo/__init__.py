try:
    ...
    import warnings
    warnings.warn("Importing 'jupyterlab-telemetry-producer-demo' outside a proper installation.")
    __version__ = "dev"
...
def _jupyter_labextension_paths():
    return [{
        "src": "labextension",
        "dest": "jupyterlab-telemetry-producer-demo"
    }]

def _jupyter_server_extension_points():
    return [{
        "module": "jupyterlab-telemetry-producer-demo",
