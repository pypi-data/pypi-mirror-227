...
class RailConnectionInfo:
    ...
    _projection: Optional[str] = field(init=False, default="Not Implemented")
...
class RailConnectionInfoLine(RailConnectionInfo):
    ...
    to_measure: float
    direction: str
    from_measure_3d: Optional[float] = field(init=False, default=None)
    to_measure_3d: Optional[float] = field(init=False, default=None)

    # todo: create geometry property, set line and calculate 3d_measures
