...
# upgraded = Change("key", DiffStatusEnum.UPGRADED, "a", "a_extra")
# not_applicable = Change("key", DiffStatusEnum.NOT_APPLICABLE, None, None)
# deleted = Change("key", DiffStatusEnum.DELETED, "a", None)
# created = Change("key", DiffStatusEnum.CREATED, None, "b")
# no_change = Change("key", DiffStatusEnum.NO_CHANGE, "a", "a")
# updated = Change("key", DiffStatusEnum.UPDATED, "a", "b")
#
# assert no_change.__repr__
