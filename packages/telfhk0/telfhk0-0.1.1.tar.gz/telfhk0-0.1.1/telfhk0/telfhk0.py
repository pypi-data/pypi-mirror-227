"""
Module TelFHk v 0.1.1 ! Modern Bot For hackers or Programer :)
update 2
Import Modules
"""
...
class Telegram:
    ...
    def SendPhoto(self,address,caption=None):
