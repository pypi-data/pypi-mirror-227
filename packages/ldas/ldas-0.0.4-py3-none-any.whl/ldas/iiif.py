...
# %% auto 0
__all__ = ['IIIF_CONTEXT', 'JPEG_FORMAT', 'ORIGIN', 'IIIF', 'Svg']
...
class IIIF:
    ...
    @staticmethod
    def create_iiif_manifest_from_local_dir(root_path: str, target_path: str, output_path: str, item_id: str) -> None:
        """
        ...
        canvases = IIIF._generate_canvases(image_files, root_path, item_id, prefix_url)
    ...
    @staticmethod
    def _generate_canvases(image_files: List[str], root_path: str, item_id: str, prefix_url: str) -> List[Dict[str, any]]:
        """
    ...
    def ndl_ocr_post_process(root_path: str, target_path: str, output_iiif_v3_path: str, item_id: str, xml_path: str, 
                             output_anno_path: str, output_canvases_dir: str, opt_json_path: str, output_manifest_alto_path: str) -> None:
        """
        ...
        """
        IIIF.create_iiif_manifest_from_local_dir(root_path, target_path, output_iiif_v3_path, item_id)
    ...
    @staticmethod
    def ndl_ocr_post_process_simple(root_path: str, output_dir: str, task_id: str) -> None:
        """
        ...
        IIIF.ndl_ocr_post_process(root_path, target_path, base_manifest_path, task_id, xml_path, output_manifest_path, output_canvases_dir, opt_json_path, output_manifest_alto_path)
