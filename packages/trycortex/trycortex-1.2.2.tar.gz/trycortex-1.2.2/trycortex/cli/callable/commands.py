...
block = blocks.Block(type=\"""" + type +  """",name=\"""" + name.upper() + """", indent=0, spec=spec, config={})
"""
...
block = blocks.Block(type=\"""" + type + """", name=\""""+ name.upper() +  """", indent=0, spec=spec, config=config)
"""
        script_name = name.lower() + ".py"
        script_path = os.path.join(block_path, script_name)
        with open(script_path, "w") as file:
...
block = blocks.Block(type="search", name=\"""" + name.upper() + """", indent=0, spec=spec, config=config)
"""
        script_name = name.lower() + ".py"
        script_path = os.path.join(block_path, script_name)
        with open(script_path, "w") as file:
...
block = blocks.Block(type="map", name=\"""" + name.upper() + """", indent=0, spec=spec, config={})
"""
        script_name = name.lower() + ".py"
        script_path = os.path.join(block_path, script_name)
        with open(script_path, "w") as file:
...
block = blocks.Block(type="reduce", name=\"""" + name.upper() + """", indent=0, spec={}, config={})
"""
...
block = blocks.Block(type="knowledge", name=\"""" + name.upper() + """", indent=0, spec=spec, config=config)
"""
        script_name = name.lower() + ".py"
        script_path = os.path.join(block_path, script_name)
        with open(script_path, "w") as file:
    ...
    spec = dict()
    config = dict()
    block = blocks.Block(type="data", name=\"""" + name.upper() + """", indent=0, spec=spec, config=config)
    """
        script_name = name.lower() + ".py"
        script_path = os.path.join(block_path, script_name)
        with open(script_path, "w") as file:
...
block = blocks.Block(type="browser", name=\"""" + name.upper() + """", indent=0, spec=spec, config=config)
"""
        script_name = name.lower() + ".py"
        script_path = os.path.join(block_path, script_name)
        with open(script_path, "w") as file:
...
block = blocks.Block(type="curl", name=\"""" + name.upper() + """", indent=0, spec=spec, config=config)
"""
        script_name = name.lower() + ".py"
        script_path = os.path.join(block_path, script_name)
        with open(script_path, "w") as file:
