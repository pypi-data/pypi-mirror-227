...
# For docs/conf.py
project = "make-language-server"
author = """Wu Zhenyu <wuzhenyu@ustc.edu> """
copyright = "2023"

# For help2man
DESCRIPTION = "make language server"
EPILOG = "Report bugs to https://github.com/Freed-Wu/make-language-server/issues"
# format __version__ by yourself
VERSION = """make-language-server {__version__}
Copyright (C) 2023
