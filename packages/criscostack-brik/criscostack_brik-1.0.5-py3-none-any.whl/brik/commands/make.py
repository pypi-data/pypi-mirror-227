...
@click.command("new-app", help="Create a new Criscoerp application under apps folder")
@click.option(
	"--no-git",
	is_flag=True,
	flag_value="--no-git",
	help="Do not initialize git repository for the app (available in Criscoerp v14+)",
)
