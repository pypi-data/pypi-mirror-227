...
@click.group(help="Setup command group for enabling setting up a Criscoerp environment")
def setup():
	pass
...
@click.command("fonts", help="Add Criscoerp fonts to system")
def setup_fonts():
...
@click.command(
	"production", help="Setup Criscoerp production environment for specific user"
)
@click.argument("user")
