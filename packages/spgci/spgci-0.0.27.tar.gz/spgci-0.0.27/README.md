...
af.get_arbitrage(margin_id=[220,330], base_margin_id =330, frequency_id=1)
# DataFrame of crude arbitrage data.

af.get_reference_data(type=arbflow.RefTypes.Locations)
