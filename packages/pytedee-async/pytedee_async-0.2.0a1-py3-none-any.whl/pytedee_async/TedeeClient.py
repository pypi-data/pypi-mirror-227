...
class TedeeClient(object):
        ...
        if self._use_local_api:
            try:
                ...
                if self._personalToken is None:
                    ...
                    _LOGGER.warn(f"Error while calling local API endpoint {path}, retrying with cloud call.")
    ...
    async def register_webhook(self, webhook_url: str) -> None:
        ...
        await self._local_api_call("/callback", "PUT", self._api_header, self._timeout, data)
