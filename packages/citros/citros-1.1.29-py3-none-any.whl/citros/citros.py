...
class Citros:
    ...
    def upload_ssh_key(self, pub_key, title):
        ...
        self.log.debug(f"upload_ssh_key. query result:\n{result}")
    ...
    def single_simulation_run(self, batch_id, run_id, timeout):   
        ...
        launch_description = generate_launch_description(self, timeout)
    ...
    def run_simulation(self, sim_name, completions, timeout, remote):      
        ...
        if remote:
            batch_id = self.batch.create_batch(batch_id, self.repo_id, sim_name, gpu, cpu, mem, 
                                               ...
                                               citros_commit, citros_branch, name=self._batch_name, 
