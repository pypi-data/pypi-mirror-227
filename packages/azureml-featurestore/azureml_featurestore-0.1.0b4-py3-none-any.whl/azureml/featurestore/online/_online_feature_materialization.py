...
from ._utils import _get_lookup_key_pattern, _get_redis_function_key_format, _get_redis_function_value_column_name_format, _get_serializable_column_datatype
...
def materialize_online(feature_set, dataframe_to_store, upsert):
    ...
    prefix, _ = _get_lookup_key_pattern(feature_set)
    ...
    dataframe_to_store.rdd.foreachPartition(
        lambda x: saveIntoRedisViaRedisScript(x)
    )
