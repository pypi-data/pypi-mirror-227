...
def crack(wordlist):
    charlist = [wordlist]
    abv = 0
    password = ["abc", "def", "ghk", "ahhahaha",    "1234567", "214892148127", "123456", "qwerty", "blabla123", "anonymus123456", "anonymus123456", "abcdefghjijklmnop", "smth", "smth", "me123456", "password", "password123456", "password123"]
    for i in charlist:
