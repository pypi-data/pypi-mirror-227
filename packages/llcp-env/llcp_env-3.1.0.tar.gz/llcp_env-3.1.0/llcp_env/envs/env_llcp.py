...
class CPEnv(Env):
    ...
    dic_clfs1 = np.load('/content/drive/MyDrive/Colab Notebooks/dic_clf_0828.npy', allow_pickle=True).item()
    ...
    def __init__(self):
        ...
        self.X_train = np.load('/content/drive/MyDrive/Colab Notebooks/dic_clf_0828.npy', allow_pickle=True).item()['xl2']
        self.y_train = np.load('/content/drive/MyDrive/Colab Notebooks/dic_clf_0828.npy', allow_pickle=True).item()['yl2']
