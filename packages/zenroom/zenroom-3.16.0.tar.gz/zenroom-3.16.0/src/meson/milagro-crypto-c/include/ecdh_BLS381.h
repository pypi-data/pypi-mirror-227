...
extern int ECP_BLS381_SP_DSA_DET(int sha,octet *S,octet *F,octet *C,octet *D, octet *octU);
/**	@brief ECDSA Signature Verification
 *
...
extern int ECP_BLS381_SP_DSA_DET_NOHASH(int sha, octet *S,octet *H,octet *C,octet *D, int *y_parity);
