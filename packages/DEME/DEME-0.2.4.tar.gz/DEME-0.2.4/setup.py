...
class CMakeExtension(Extension):
    def __init__(self, name: str, sourcedir: str = "") -> None:
        ...
        super().__init__(name, sources=[], extra_link_args=['-Wl,-rpath,' + conda_prefix + '/lib/python3.10/site-packages/lib', '-Wl,-rpath,$ORIGIN/lib'], runtime_library_dirs=[conda_prefix + "/lib/python3.10/site-packages/lib/"], libraries=["libDEMERuntimeDataHelper"], include_dirs=["./src/DEM/", "./src/DEM/VariableTypes"], extra_objects=["./build"])
