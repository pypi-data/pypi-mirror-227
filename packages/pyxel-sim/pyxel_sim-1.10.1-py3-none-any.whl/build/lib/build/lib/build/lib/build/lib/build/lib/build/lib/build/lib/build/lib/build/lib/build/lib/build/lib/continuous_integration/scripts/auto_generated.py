...
#
# Model: Charge Generation / Dark Current Induced
#
@schema(title='Parameters')
@dataclass
class ModelChargeGenerationDarkCurrentInducedArguments(Mapping[str, Any]):
...
@schema(
    title="Model 'dark_current_induced'"
    ,description='Model to add dark current induced by radiation to the detector charge.'
)
@dataclass
class ModelChargeGenerationDarkCurrentInduced:
    name: str
    arguments: ModelChargeGenerationDarkCurrentInducedArguments
    func: Literal['pyxel.models.charge_generation.dark_current_induced'] = 'pyxel.models.charge_generation.dark_current_induced'
    enabled: bool = True
...
class DetailedDetectionPipeline(DetectionPipeline):
    ...
    charge_generation: Optional[
        Sequence[Union[ModelChargeGenerationApdGain, ModelChargeGenerationChargeBlocks, ModelChargeGenerationChargeDeposition, ModelChargeGenerationChargeDepositionInMct, ModelChargeGenerationConversionWithQeMap, ModelChargeGenerationCosmix, ModelChargeGenerationDarkCurrent, ModelChargeGenerationDarkCurrentInduced, ModelChargeGenerationDarkCurrentRule07, ModelChargeGenerationDarkCurrentSaphira, ModelChargeGenerationLoadCharge, ModelChargeGenerationSimpleConversion, ModelChargeGenerationSimpleDarkCurrent, ModelLoadDetector, ModelSaveDetector, ModelFunction]]
