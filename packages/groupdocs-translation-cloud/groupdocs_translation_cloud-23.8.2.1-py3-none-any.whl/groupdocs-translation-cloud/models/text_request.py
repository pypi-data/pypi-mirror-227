...
class TextRequest(BaseModel):
    ...
    TextRequest
    """
    source_language: Optional[StrictStr] = Field(None, alias="sourceLanguage")
    target_languages: Optional[conlist(StrictStr)] = Field(None, alias="targetLanguages")
    texts: Optional[conlist(StrictStr)] = None
    origin: Optional[StrictStr] = None
    contains_markdown: Optional[StrictBool] = Field(None, alias="containsMarkdown")
