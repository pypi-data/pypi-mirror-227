...
class PresentationFileRequest(BaseModel):
    ...
    """
    source_language: Optional[constr(strict=True, min_length=1)] = Field('en', alias="sourceLanguage")
    ...
    format: Optional[StrictStr] = 'Pptx'
    output_format: Optional[constr(strict=True, min_length=1)] = Field(None, alias="outputFormat")
    masters: Optional[StrictBool] = False
    slides: Optional[conlist(StrictInt)] = None
