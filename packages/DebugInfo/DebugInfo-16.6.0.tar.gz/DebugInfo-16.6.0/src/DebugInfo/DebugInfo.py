...
class 分隔线模板:
    ...
    def lstrip(self) -> str:
        """
        返回 self.__str__().lstrip()
        :return: str
        """
        return self.__str__().lstrip()

    def strip(self) -> str:
        """
        返回 self.__str__().strip()
        :return: str
        """
...
class 调试模板:
    ...
    def 分隔线(self) -> 分隔线模板:
        ...
        def 打印方法(消息: str) -> None:
            if callable(self.__打印方法):
                self.__打印方法('{}{}{}'.format(self.__缩进字符, self.__打印头, 消息.rstrip()))
            else:
                print('{}{}{}'.format(self.__缩进字符, self.__打印头, 消息.rstrip()))
    ...
    def __修饰指定行(self, 行号: int, 方法: _Callable[[str], str] or list[_Callable[[str], str]] = None) -> None:
        ...
        if not isinstance(self.__表格[有效行号], list or tuple):
