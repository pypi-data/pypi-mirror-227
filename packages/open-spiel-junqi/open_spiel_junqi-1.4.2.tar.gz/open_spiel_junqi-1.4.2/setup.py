...
setuptools.setup(
    name="open_spiel_junqi",
    version="1.4.2",
    license="Apache 2.0",
    author="The OpenSpiel authors and Jim Zhou",
    author_email="csd_189@163.com",
    description="A Framework for Reinforcement Learning in Games including Jun Qi",
