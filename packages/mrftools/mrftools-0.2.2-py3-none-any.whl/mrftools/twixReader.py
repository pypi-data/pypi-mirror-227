...
import scipy.io
from .reconstructionConfiguration import LegacySettings
...
class mrftoolsDataset:
    ...
    def InitializeFromLegacyTwix(filename, multi_twix, legacy_settings: LegacySettings, trajectoryReadoutLength):
        dataset = mrftoolsDataset()
        dataset.sourceFilename = filename
        dataset.trajectoryReadoutLength = trajectoryReadoutLength
        dataset.faMode = FAMode.RequestedFlipAngle
    ...
    def Initialize(filename, trajectoryReadoutLength=-1, fa_mode='requested', legacy_settings:LegacySettings = None):
