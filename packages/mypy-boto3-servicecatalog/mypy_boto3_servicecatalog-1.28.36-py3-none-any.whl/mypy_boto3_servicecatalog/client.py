...
class ServiceCatalogClient(BaseClient):
    ...
    def list_portfolios(
        self, *, AcceptLanguage: str = ..., PageToken: DictOrStrTypeDef = ..., PageSize: int = ...
    ) -> ListPortfoliosOutputTypeDef:
        """
    ...
    def list_service_actions(
        self, *, AcceptLanguage: str = ..., PageSize: int = ..., PageToken: DictOrStrTypeDef = ...
    ) -> ListServiceActionsOutputTypeDef:
        """
    ...
    def notify_provision_product_engine_workflow_result(
        ...
        *,
        ...
        IdempotencyToken: str,
        FailureReason: DictOrStrTypeDef = ...,
