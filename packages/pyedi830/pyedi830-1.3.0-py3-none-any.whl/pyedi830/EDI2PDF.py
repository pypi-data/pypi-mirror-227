...
class EDI2PDF(EDI2CSV):
    ...
    def to_pdf(self, edi_file_path, pdf_file_path, temp_html_file_path='output/edi_830.html'):
        ...
        HTML(temp_html_file_path).write_pdf(pdf_file_path)
        
        Debug.log_message(f"Done to render pdf in {pdf_file_path}")
