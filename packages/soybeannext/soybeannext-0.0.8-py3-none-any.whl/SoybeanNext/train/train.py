import warnings
import torch
from src.SoybeanNext.remodel.weight_map import weight_decoder
from src.SoybeanNext.remodel.remodel import remodel
from src.SoybeanNext.utils import outpath
...
class Train:
    ...
    def train_n(self, percentage=0.05, epoch=5, weight_decay=1e-5, draw=True):
        ...
        net, decoder = remodel("../data/model.yaml", 1)
        net.to(self.device)
        # initialize weights
    ...
    def train_p(self, percentage=0.05, epoch=5, weight_decay=1e-5, draw=True):
        ...
        for trait in self.p_trait_list:
            ...
            net, decoder = remodel("../data/model.yaml", num_classes)
            net.to(self.device)
            # initialize weights
            net.apply(init_weights)
...
# an example
# t = Train("../data/test.vcf", "../data/final_trait.csv")
# t.train_p()
