...
class Task:
    ...
    def __init__(self, params, data):
        ...
        try:
            self.driving_path_flag = params['driving_path_flag']
        except:
            pass
    ...
    def get_tsv_dict(self):
        tsv = {
            ...
            'phys_complete_pct': self.phys_complete_pct,
            'rev_fdbk_flag': self.rev_fdbk_flag,
            'est_wt': self.est_wt,
            'lock_plan_flag': self.lock_plan_flag,
            'auto_compute_act_flag': self.auto_compute_act_flag,
            'complete_pct_type': self.complete_pct_type,
            ...
            'total_float_hr_cnt': self.total_float_hr_cnt,
            'free_float_hr_cnt': self.free_float_hr_cnt,
            'remain_drtn_hr_cnt': self.remain_drtn_hr_cnt,
            'act_work_qty': self.act_work_qty,
            'remain_work_qty': self.remain_work_qty,
            'target_work_qty': self.target_work_qty,
            'target_drtn_hr_cnt': self.target_drtn_hr_cnt,
            'target_equip_qty': self.target_equip_qty,
            'act_equip_qty': self.act_equip_qty,
            'remain_equip_qty': self.remain_equip_qty,
            'cstr_date': self.cstr_date.strftime('%Y-%m-%d %H:%M') if self.cstr_date else None,
            'act_start_date': self.act_start_date.strftime('%Y-%m-%d %H:%M') if self.act_start_date else None,
            'act_end_date': self.act_end_date.strftime('%Y-%m-%d %H:%M') if self.act_end_date else None,
            'late_start_date': self.late_start_date.strftime('%Y-%m-%d %H:%M') if self.late_start_date else None,
            'late_end_date': self.late_end_date.strftime('%Y-%m-%d %H:%M') if self.late_end_date else None,
            'expect_end_date': self.expect_end_date.strftime('%Y-%m-%d %H:%M') if self.expect_end_date else None,
            'early_start_date': self.early_start_date.strftime('%Y-%m-%d %H:%M') if self.early_start_date else None,
            'early_end_date': self.early_end_date.strftime('%Y-%m-%d %H:%M') if self.early_end_date else None,
            'restart_date': self.restart_date.strftime('%Y-%m-%d %H:%M') if self.restart_date else None,
            'reend_date': self.reend_date.strftime('%Y-%m-%d %H:%M') if self.reend_date else None,
            'target_start_date': self.target_start_date.strftime('%Y-%m-%d %H:%M') if self.target_start_date else None,
            'target_end_date': self.target_end_date.strftime('%Y-%m-%d %H:%M') if self.target_end_date else None,
            'rem_late_start_date': self.rem_late_start_date.strftime('%Y-%m-%d %H:%M') if self.rem_late_start_date else None,
            'rem_late_end_date': self.rem_late_end_date.strftime('%Y-%m-%d %H:%M') if self.rem_late_end_date else None,
            'cstr_type': self.cstr_type, 
            'priority_type': self.priority_type,
            'suspend_date': self.suspend_date.strftime('%Y-%m-%d %H:%M') if self.suspend_date else None,
            'resume_date': self.resume_date.strftime('%Y-%m-%d %H:%M') if self.resume_date else None,
            'int_path': self.int_path, 
            'int_path_order': self.int_path_order, 
            'guid': self.guid, 
            'tmpl_guid': self.tmpl_guid,
            'cstr_date2': self.cstr_date2.strftime('%Y-%m-%d %H:%M') if self.cstr_date2 else None,
            'cstr_type2': self.cstr_type2, 
            'driving_path_flag': self.driving_path_flag,
            'act_this_per_work_qty': self.act_this_per_work_qty, 
            'act_this_per_equip_qty': self.act_this_per_equip_qty,
            'external_early_start_date': self.external_early_start_date.strftime('%Y-%m-%d %H:%M') if self.external_early_start_date else None,
            'external_late_end_date': self.external_late_end_date.strftime('%Y-%m-%d %H:%M') if self.external_late_end_date else None,
            'create_date': self.create_date.strftime('%Y-%m-%d %H:%M') if self.create_date else None,
            'update_date': self.update_date.strftime('%Y-%m-%d %H:%M') if self.update_date else None,
