...
class EagleEye(object):
    ...
    def update_session_auth_key(self):
        ...
        """
        # _LOGGER.debug() # Commenting out incomplete logging statement
    ...
    def authenticated_query(self, url, method='get', params=None,
        ...
        if response.status_code == 401 and retry_auth > 0:
            # _LOGGER.info() # Commenting out incomplete logging statement
    ...
    def update(self):
        ...
        """
        # _LOGGER.debug() # Commenting out incomplete logging statement'Updating Eagle Eye API and associated entities')
