...
def upload(python_path: str, username: str, passwd: str, passwd_test: str):
...
def upload_pypi_project(project_dir: str, upload_to_pypi_test: bool, username: str = '__token__', passwd: str = None, passwd_test: str = None):
