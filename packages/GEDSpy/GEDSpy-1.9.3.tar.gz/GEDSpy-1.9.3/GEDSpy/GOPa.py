...
def jbio_GOPa_prepare(path_in_use):
    ...
    name_mapping = dict(zip(go2['GO_id'], go2['name']))
...
def specificity_prepare(path_in_use):
    ...
    RNA_tissue[['name', 'standarized_TPM']] = RNA_tissue['nTPM'].str.split(':', n=1, expand=True)
    RNA_tissue['name'] = RNA_tissue['name'].str.replace(r' \d+$', '', regex=True)
    
    RNA_tissue['standarized_TPM'] = [float(x) for x in RNA_tissue['standarized_TPM']]
    RNA_tissue['standarized_TPM'] = (RNA_tissue['standarized_TPM'] - RNA_tissue['standarized_TPM'].min()) / (RNA_tissue['standarized_TPM'].max() - RNA_tissue['standarized_TPM'].min())
    
    RNA_tissue['standarized_specificity_score'] = [float(x) for x in RNA_tissue['standarized_specificity_score']]
    RNA_tissue['standarized_specificity_score'] = (RNA_tissue['standarized_specificity_score'] - RNA_tissue['standarized_specificity_score'].min()) / (RNA_tissue['standarized_specificity_score'].max() - RNA_tissue['standarized_specificity_score'].min())
    ...
    RNA_single_cell[['name', 'standarized_TPM']] = RNA_single_cell['nTPM'].str.split(':', n=1, expand=True)
    RNA_single_cell['name'] = RNA_single_cell['name'].str.replace(r' \d+$', '', regex=True)
    
    
    RNA_single_cell['standarized_TPM'] = [float(x) for x in RNA_single_cell['standarized_TPM']]
    RNA_single_cell['standarized_TPM'] = (RNA_single_cell['standarized_TPM'] - RNA_single_cell['standarized_TPM'].min()) / (RNA_single_cell['standarized_TPM'].max() - RNA_single_cell['standarized_TPM'].min())
    
    RNA_single_cell['standarized_specificity_score'] = [float(x) for x in RNA_single_cell['standarized_specificity_score']]
    RNA_single_cell['standarized_specificity_score'] = (RNA_single_cell['standarized_specificity_score'] - RNA_single_cell['standarized_specificity_score'].min()) / (RNA_single_cell['standarized_specificity_score'].max() - RNA_single_cell['standarized_specificity_score'].min())
    ...
    RNA_cancer[['name', 'standarized_TPM']] = RNA_cancer['nTPM'].str.split(':', n=1, expand=True)
    RNA_cancer['name'] = RNA_cancer['name'].str.replace(r' \d+$', '', regex=True)
    
    
    RNA_cancer['standarized_TPM'] = [float(x) for x in RNA_cancer['standarized_TPM']]
    RNA_cancer['standarized_TPM'] = (RNA_cancer['standarized_TPM'] - RNA_cancer['standarized_TPM'].min()) / (RNA_cancer['standarized_TPM'].max() - RNA_cancer['standarized_TPM'].min())
    
    RNA_cancer['standarized_specificity_score'] = [float(x) for x in RNA_cancer['standarized_specificity_score']]
    RNA_cancer['standarized_specificity_score'] = (RNA_cancer['standarized_specificity_score'] - RNA_cancer['standarized_specificity_score'].min()) / (RNA_cancer['standarized_specificity_score'].max() - RNA_cancer['standarized_specificity_score'].min())
    ...
    RNA_brain[['name', 'standarized_TPM']] = RNA_brain['nTPM'].str.split(':', n=1, expand=True)
    RNA_brain['name'] = RNA_brain['name'].str.replace(r' \d+$', '', regex=True)
    
    RNA_brain['standarized_TPM'] = [float(x) for x in RNA_brain['standarized_TPM']]
    RNA_brain['standarized_TPM'] = (RNA_brain['standarized_TPM'] - RNA_brain['standarized_TPM'].min()) / (RNA_brain['standarized_TPM'].max() - RNA_brain['standarized_TPM'].min())
    
    RNA_brain['standarized_specificity_score'] = [float(x) for x in RNA_brain['standarized_specificity_score']]
    RNA_brain['standarized_specificity_score'] = (RNA_brain['standarized_specificity_score'] - RNA_brain['standarized_specificity_score'].min()) / (RNA_brain['standarized_specificity_score'].max() - RNA_brain['standarized_specificity_score'].min())
    ...
    RNA_blood[['name', 'standarized_TPM']] = RNA_blood['nTPM'].str.split(':', n=1, expand=True)
    RNA_blood['name'] = RNA_blood['name'].str.replace(r' \d+$', '', regex=True)
    
    
    RNA_blood['standarized_TPM'] = [float(x) for x in RNA_blood['standarized_TPM']]
    RNA_blood['standarized_TPM'] = (RNA_blood['standarized_TPM'] - RNA_blood['standarized_TPM'].min()) / (RNA_blood['standarized_TPM'].max() - RNA_blood['standarized_TPM'].min())
    
    RNA_blood['standarized_specificity_score'] = [float(x) for x in RNA_blood['standarized_specificity_score']]
    RNA_blood['standarized_specificity_score'] = (RNA_blood['standarized_specificity_score'] - RNA_blood['standarized_specificity_score'].min()) / (RNA_blood['standarized_specificity_score'].max() - RNA_blood['standarized_specificity_score'].min())
    ...
    RNA_blood_lineage[['name', 'standarized_TPM']] = RNA_blood_lineage['nTPM'].str.split(':', n=1, expand=True)
    RNA_blood_lineage['name'] = RNA_blood_lineage['name'].str.replace(r' \d+$', '', regex=True)
    
    
    RNA_blood_lineage['standarized_TPM'] = [float(x) for x in RNA_blood_lineage['standarized_TPM']]
    RNA_blood_lineage['standarized_TPM'] = (RNA_blood_lineage['standarized_TPM'] - RNA_blood_lineage['standarized_TPM'].min()) / (RNA_blood_lineage['standarized_TPM'].max() - RNA_blood_lineage['standarized_TPM'].min())
    
    RNA_blood_lineage['standarized_specificity_score'] = [float(x) for x in RNA_blood_lineage['standarized_specificity_score']]
    RNA_blood_lineage['standarized_specificity_score'] = (RNA_blood_lineage['standarized_specificity_score'] - RNA_blood_lineage['standarized_specificity_score'].min()) / (RNA_blood_lineage['standarized_specificity_score'].max() - RNA_blood_lineage['standarized_specificity_score'].min())
    ...
    RNA_cell_line[['name', 'standarized_TPM']] = RNA_cell_line['nTPM'].str.split(':', n=1, expand=True)
    RNA_cell_line['name'] = RNA_cell_line['name'].str.replace(r' \d+$', '', regex=True)
    
    
    RNA_cell_line['standarized_TPM'] = [float(x) for x in RNA_cell_line['standarized_TPM']]
    RNA_cell_line['standarized_TPM'] = (RNA_cell_line['standarized_TPM'] - RNA_cell_line['standarized_TPM'].min()) / (RNA_cell_line['standarized_TPM'].max() - RNA_cell_line['standarized_TPM'].min())
    
    RNA_cell_line['standarized_specificity_score'] = [float(x) for x in RNA_cell_line['standarized_specificity_score']]
    RNA_cell_line['standarized_specificity_score'] = (RNA_cell_line['standarized_specificity_score'] - RNA_cell_line['standarized_specificity_score'].min()) / (RNA_cell_line['standarized_specificity_score'].max() - RNA_cell_line['standarized_specificity_score'].min())
    ...
    RNA_mouse_brain_region[['name', 'standarized_TPM']] = RNA_mouse_brain_region['nTPM'].str.split(':', n=1, expand=True)
    RNA_mouse_brain_region['name'] = RNA_mouse_brain_region['name'].str.replace(r' \d+$', '', regex=True)
    
    
    RNA_mouse_brain_region['standarized_TPM'] = [float(x) for x in RNA_mouse_brain_region['standarized_TPM']]
    RNA_mouse_brain_region['standarized_TPM'] = (RNA_mouse_brain_region['standarized_TPM'] - RNA_mouse_brain_region['standarized_TPM'].min()) / (RNA_mouse_brain_region['standarized_TPM'].max() - RNA_mouse_brain_region['standarized_TPM'].min())
    ...
    RNA_mouse_brain_region['standarized_specificity_score'] = (RNA_mouse_brain_region['standarized_specificity_score'] - RNA_mouse_brain_region['standarized_specificity_score'].min()) / (RNA_mouse_brain_region['standarized_specificity_score'].max() - RNA_mouse_brain_region['standarized_specificity_score'].min())
...
def gopa_specificity_analysis(GOPa_data, GOPa_metadata):
   ...
   """
    ...
    try:
        ...
        SEQ = SEQ.groupby('name').agg({'gene_name': list, 'dictionary_id': list, 'distribution':list, 'standarized_specificity_score': list,  'standarized_TPM': list, 'source':list}).reset_index()
...
def GOPa_bar_plot(GOPa_data, p_val = 0.05, test = 'FISH', adj = 'FDR', n = 20, side = 'right', color = 'blue', width = 10, bar_width = 0.5, count_type = 'perc', omit = None):
...
def GOPa_network_vis(GOPa_data, p_val = 0.05, test = 'FISH', adj = 'FDR', n_max = 10, list_of_terms = None, omit = None, path = _path_tmp):
    ...
    Args:
       ...
       list of terms (list) - list of terms to visualization their interactions ['term1', 'term2'] or None for highly occurrence interactions in GOPa_data
       omit (list) - type of terms to omit in the graph eg. ['GO-TERM', 'KEGG', 'REACTOME', 'DISEASES', 'VIRAL'] or None
    ...
    try:
        ...
        if list_of_terms != None:
            ...
            GOPa_interactions = GOPa_interactions[GOPa_interactions['A'].isin(list_of_terms + list(GOPa_interactions['B'][GOPa_interactions['A'].isin(list_of_terms)]))]
            itter = list_of_terms
        else:
            ...
            if len(A['n']) > n_max:
                itter = list(A['GOPa'][A['n'] >= int(A['n'][n_max])])
            else:
                itter = list(A['GOPa'])
        ...
        if len(GOPa_interactions) > 0:
            
            
            list_of_B_term = []
            for a_term in set(itter):
               
                gopa_list = Counter(list(GOPa_interactions['B'][GOPa_interactions['A'] == a_term]))
                ...
                if len(gopa_list['n']) > n_max:
                    list_of_B_term = list_of_B_term + list(gopa_list['GOPa'][gopa_list['n'] >= int(gopa_list['n'][n_max])])
                else:
                    list_of_B_term = list_of_B_term + list(gopa_list['GOPa'])
                
        
           
            if list_of_terms != None:
                GOPa_interactions = GOPa_interactions[GOPa_interactions['A'].isin(list_of_terms) & GOPa_interactions['B'].isin(list_of_B_term)]
            else:
                GOPa_interactions = GOPa_interactions[GOPa_interactions['A'].isin(itter) & GOPa_interactions['B'].isin(list_of_B_term)]
...
def create_netowrk_static(network, width = 16, height = 10, font_size = 5):
...
def create_netowrk_html(network, options = None):
    ...
    try:
        ...
        # Calculate desired height and width based on screen size
        desired_height = int(screen_height * 0.6)  
        desired_width = int(screen_width * 0.6)  
        
        #
        
        net = Network(notebook=False, height=f"{desired_height}px", width=f"{desired_width}px")
...
def show_go_term(GOPa_metadata, GO_id = None, GO_name = None, n_max = 50, path = _path_tmp):
    ...
    try:
        ...
        try:
            ...
            if len(GOPa_network) > 0:  
                ...
                list_of_B_term = []
                for a_term in set(GOPa_network['A']):
...
def gene_type_bar_plot(GOPa_data, color = 'gold', side = 'right', width = 10, bar_width = 0.5, count_type = 'perc'):
...
def location_specificity_bar_plot(GOPa_data, p_val = 0.05, test = 'FISH', adj = 'FDR', n_max = 20, side = 'right', color = 'sandybrown', width = 10, bar_width = 0.5):
...
def get_gopa_cellular_location_specificity(GOPa_data):
